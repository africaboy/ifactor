...
public class AssignStuffPaerIntroHandler extends AbstractSimpleBean implements
		WPlugHandler {
	...
	public boolean participate(Connection conn, SimpleBean bean)
		...
		return "Required".equals(opinionInfo.get("OPINION"))
				|| "UnConfirmed".equals(opinionInfo.get("OPINION"));
	}
