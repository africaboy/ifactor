...
/**
 * end-step intro handler
 * 
 * @author mido
 * 
 */
public class EndApplyHandler extends AbstractSimpleBean implements WPlugHandler {

	public boolean participate(Connection conn, SimpleBean bean)
			throws WorkflowException {
		// TODO Auto-generated method stub
		WStep theStep = (WStep) bean.getResource().get("theStep");

		boolean rnt = true;

		if (theStep.ikey().equals("cPjfdskOtZ")) {
			// current step is 'double check and verify'
			...
			rnt = "Confirmed".equals(opinionInfo.get("OPINION"));
		}
