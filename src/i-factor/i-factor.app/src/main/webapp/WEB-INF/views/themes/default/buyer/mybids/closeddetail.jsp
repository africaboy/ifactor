		                        ...
		                        <div class="col-sm-12">
		                            ...
		                            <div class="col-sm-10" id="invoice_details" style="display: none;">
		                              ...
		                              <div>
		                                ...
		                                <div class="col-sm-4">
		                                  <input type="text" class="form-control input-sm disabled"   readonly="true"  id="discount" name="discount" placeholder=""  value="${auction.discount}">
		                                </div>
		                              </div>
		                              <div>
		                                <div class="col-sm-6">
		                                ...
		                                <div class="col-sm-4">
		                                  <input type="text" class="form-control input-sm disabled"   readonly="true"  id="interest"  name="interest"  placeholder=""  value="${auction.interest}">
		                                </div>
		                              </div>
		                            ...
		                            <div class="col-sm-10" id="invoice_status">
		                              ...
		                              <div class="col-sm-2">
		                                <label class="label label-success">${auction.status}</label>
		                              </div>
