...
<div class="page-bar">
  <ul class="page-breadcrumb">
    <li>
      <a href="#"><fmt:message key='invoice.list.tbody.queryForm.field.mybids' /></a>
...
<h5 class="page-title">
  <small><b><fmt:message key='seller.history.delisted.both.page.auctionStatus' />:  <span style="color: #d64635"> <fmt:message key='seller.history.delisted.both.page.closed' /> <i class="icon-lock"></i> </span>&nbsp;&nbsp; <fmt:message key='seller.history.delisted.expried.page.reason' /></b></small>
</h5>
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
