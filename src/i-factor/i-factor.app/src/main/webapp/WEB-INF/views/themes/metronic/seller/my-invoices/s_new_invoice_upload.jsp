   ...
   <%--  <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div id="stickerIddiv" class="alert alert-danger display-none" style="display:none">
			      <img src="${base}/static/themes/metronic/img/home/warning.png" height="30px">&nbsp;&nbsp;<fmt:message key="seller.invoice.upload.message.finStickerId"/>
			    </div>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active" id="tab1">
                                                  <form action="#" class="form-horizontal" id="form-seller-info" method="POST" enctype="multipart/form-data"> 
                                                  	...
                                                  	<input type="hidden" class="form-control" id="sellerRepresentedByTitle" name="sellerRepresentedByTitle" value="${user.title}" readonly /> 
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" type="text"  id="sellerCompanyName"
						                              		name="sellerCompanyName" value="${sellerCompanyName}" readonly="readonly" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group if-form-group-sm">
                                                        <div class="control-label col-md-offset-2 col-md-2 if-control-label-md">
                                                        ...
                                                        <div class="col-md-4">
                                                          <input type="text" class="form-control if-input-sm if-div-input-md" type="text"  id="sellerRepresentedByName1"
						                              		name="sellerRepresentedByName1" value="${user.title}&nbsp;${user.firstName}&nbsp;${user.lastName}" readonly="readonly" />
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                  ...
                                                  <div class="form-group if-form-group-sm">
                                                    ...
                                                    <div class="col-md-3">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md" id="debtorAddress" 	name="debtorAddress" maxlength="255" data-rule-required="true" 	data-msg-required="<fmt:message key='invoice.submit.form.field.debtorAddress.required'/>" />
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md" id="district"  name="district" maxlength="255" data-rule-required="true"
                                                  ...
                                                  <div class="form-group if-form-group-sm">
                                                    ...
                                                    <div class="col-md-3">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md" id="city" name="city" 	maxlength="255" data-rule-required="true"
                                                    ...
                                                    <div class="col-md-3">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md" id="region" name="region" maxlength="255">
                                                    </div>
                                                  </div>
                                                  <!-- row 4 -->
                                                  <div class="form-group if-form-group-sm">
                                                    ...
                                                    <div class="col-md-3">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md" id="postCode" name="postCode" data-rule-required="false"
                                                  ...
                                                  <div class="form-group if-form-group-sm">
                                                    ...
                                                    <div class="col-md-3">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md" id="debtorBizRegNo" name="debtorBizRegNo" data-rule-required="true"
                                                    ...
                                                    <div class="col-md-3">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md" id="debtorTaxCode"  name="debtorTaxCode" data-rule-required="true"
                                                ...
                                                <div class="tab-pane" id="tab3">
                                                 <form action="#" class="form-horizontal" id="form-financing-info" method="POST" enctype="multipart/form-data">  
                                                  ...
                                                  <div class="form-group if-form-group-sm">
                                                    ...
                                                    <div class="col-md-3">
                                                     <input type="text" class="form-control if-input-sm if-div-input-md" id="finStickerId" 	name="finStickerId" data-rule-required="true" maxlength="6"
                                                    ...
                                                    <div class="col-md-3">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md" id="serialNumInvoice" name="serialNumInvoice" data-rule-required="true" minlength="3"
                                                  ...
                                                  <div class="form-group if-form-group-sm">
                                                    ...
                                                    <div class="col-md-3">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md" id="finVatInvNo" name="finVatInvNo" data-rule-required="true"
                                                    ...
                                                    <div class="col-md-3 if-input-md">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md date-picker" id="finInvIssDate"
                                                  ...
                                                  <div class="form-group if-form-group-sm">
                                                    ...
                                                    <div class="col-md-2">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md numberFormat" id="finInvAmountRead" name="finInvAmountRead" data-rule-required="true"
                                                      ...
                                                      <input type="hidden" class="form-control if-input-sm if-div-input-md" id="finInvAmount" name="finInvAmount" data-rule-required="true"
														data-msg-required="<fmt:message key='invoice.submit.form.field.finInvAmount.required'/>"
                                                    ...
                                                    <div class="control-label col-md-3 if-control-label-md">
                                                     <fmt:message key='invoice.submit.form.field.finObjOfInv' /><span class="required">*</span>
                                                    </div>
                                                    <div class="col-md-3">
                                                  ...
                                                  <div class="form-group if-form-group-sm">
                                                    ...
                                                    <div class="col-md-3 if-input-md">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md date-picker" id="finExpPmtDate"
                                                  ...
                                                  <div class="form-group if-form-group-sm">
                                                    ...
                                                    <div class="col-md-3">
                                                      <input type="text" class="form-control if-input-sm if-div-input-md" id="finRmngMatTerm" name="finRmngMatTerm" data-rule-required="true"
                                                 ...
                                                 <form action="#" class="form-horizontal" id="form-readytosell-info" method="POST" enctype="multipart/form-data">
                                                  <div class="form-group if-form-group-sm">
                                                    ...
                                                    <div class="col-sm-2 col-xs-12">
                                                      ...
                                                      <select  class="form-control if-input-sm if-div-input-md" id="readyToSellAdv" name="readyToSellAdv"	data-rule-required="true"
														...
														<div class="col-sm-3">
														   <span class="file-extend">
														     <span class="fileinput-button" style="display:block;width:72px;height:20px;">
	                                                            ...
	                                                            <input type="file" class="if-input-sm if-div-input-md" id="docScanOfInv" name="file" multiple> 
	                                                            <input type="hidden" id="file-type-docScanOfInv" name="fileType"
																	value="${self.docBiztypePrefix}invoice_firstInvoice" />
														     </span>
														   </span>
														   	<!-- 已经上传的文件 -->
														   <div id="file-link-docScanOfInv" class="filename"><fmt:message key='buyer.apply.form.button.uploadFileTip'/></div>
													...
													<div class="form-group" style="margin-right:50px;">
													    ...
													    <div class="col-sm-3 filediv">
														  <span class="file-extend">
														    <span class="fileinput-button" style="display:block;width:72px;height:20px;">
															  <span class="file-uploadBtn"><fmt:message key='buyer.apply.form.button.addFile'/></span>
                                                              <input type="file" class="if-input-sm if-div-input-md" id="docScanOfCont" name="file" multiple> 
                                                              <input type="hidden" id="file-type-docScanOfCont" name="fileType"
																value="${self.docBiztypePrefix}invoice_secondInvoice" />
														    </span>
														   </span>
														   <!-- 已经上传的文件 -->
														   <div id="file-link-docScanOfCont" class="filename"><fmt:message key='buyer.apply.form.button.uploadFileTip'/></div>
													...
													<div class="form-group">
													    ...
													    <div class="col-sm-3 filediv">
														  <span class="file-extend">
														    <span class="fileinput-button" style="display:block;width:72px;height:20px;">
															  <span class="file-uploadBtn"><fmt:message key='buyer.apply.form.button.addFile'/></span>
                                                              <input type="file" class="if-input-sm if-div-input-md" id="docDlvryCnfm" name="file" multiple> 
                                                              <input type="hidden" id="file-type-docDlvryCnfm" name="fileType"
																value="${self.docBiztypePrefix}invoice_thirdInvoice" />
														    </span>
														   </span>
														   <!-- 已经上传的文件 -->
														   <div id="file-link-docDlvryCnfm" class="filename"><fmt:message key='buyer.apply.form.button.uploadFileTip'/></div>
													...
													<div class="form-group" style="margin-right:50px;">
													    ...
													    <div class="col-sm-3 filediv">
														  <span class="file-extend">
														    <span class="fileinput-button" style="display:block;width:72px;height:20px;">
															  <span class="file-uploadBtn"><fmt:message key='buyer.apply.form.button.addFile'/></span>
                                                              <input type="file" class="if-input-sm if-div-input-md" id="docDebtorAckmt" name="file" multiple> 
                                                              <input type="hidden" id="file-type-docDebtorAckmt" name="fileType"
																value="${self.docBiztypePrefix}taxcode_deliveryConfirm" />
														    </span>
														   </span>
														   <div id="file-link-docDebtorAckmt" class="filename"><fmt:message key='buyer.apply.form.button.uploadFileTip'/></div>
    ...
    <script src="${base}/static/themes/metronic/js/seller/my-invoices/apply-application.js"></script>
    <script src="${base}/static/themes/metronic/js/seller/my-invoices/invoice-submit.js"></script>
    <script src="${base}/static/themes/metronic/js/ifactorupload.js"></script>
    ...
    /* 
        jQuery(document).ready(function () {
            ...
            Layout.init(); // init current layout
            ComponentsPickers.init();
            var titles = ['Seller information', 'Debtor information', 'Financing information', 'Ready-to-sell','Documentation', 'Terms and conditions'];
            FormWizard.init(titles);
            //FormFileUpload.init();
        }); */
