...
<!-- BEGIN PAGE HEADER-->
  <div class="page-bar">
    <ul class="page-breadcrumb">
      ...
      <li>
        <a href="javascript:;"><fmt:message key='s.debtor.profile.page.breadcrumb' /></a>
      </li>
    </ul>
  </div>
<h5 class="page-title">
  <b><fmt:message key='s.debtor.profile.page.breadcrumb' /></b>
</h5>
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
...
<div class="clearfix">
  <div class="if-panel-head if-panel-blue">
    <fmt:message key='s.debtor.profile.debtor.information' />
  </div>
  <div class="panel panel-success">
    <div class="panel-body">
      <div class="row">
        <!-- Row 1 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.debtor.profile.debtor.information1' /></a></div>
        <div class="col-sm-6 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtLastFiscal" value="${invoice.debtorName}">
        </div>
        <!-- Row 2 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.debtor.profile.debtor.information2' /></a></div>
        ...
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.debtor.profile.debtor.information3' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtTaxCode" value="${invoice.debtorTaxCode}">
        </div>
        <!-- Row 3 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.debtor.profile.debtor.information4' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtUploadInvTotal" value="13">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.debtor.profile.debtor.information5' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtSoldInvTotal" value="23">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.debtor.profile.debtor.information6' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtSettleInvTotal" value="10">
        </div>
        <!-- Row 4 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.debtor.profile.debtor.information7' /></a></div>
        <div class="col-sm-2 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtOutstandingInvTotal" value="22">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.debtor.profile.debtor.information8' /></a></div>
        <div class="col-sm-2 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtOverdueAvg" value="11days">
        </div>
      </div>
    </div>
  </div>
...
<h5 class="page-title">
  <b><fmt:message key='s.debtor.profile.behaviour.history' /></b>
</h5>
<div class="row">
  <div class="col-md-12">
    <div class="tabbable tabbable-custom boxless tabbable-reversed">
      <ul class="nav nav-tabs if-profile-tab">
        <li class="active">
          <a href="#tab_0" data-toggle="tab">
            <fmt:message key='s.debtor.profile.outstanding.invoices' />
          </a>
        </li>
        <li>
          <a href="#tab_1" data-toggle="tab">
            <fmt:message key='s.debtor.profile.settled.invoice' />
          </a>
        </li>
      </ul>
      <div class="tab-content">
        ...
        <tr>
          <th style="width:20px">
            <fmt:message key='s.debtor.profile.table1.thead' />
          </th>
          <th style="width:120px">
            <fmt:message key='s.debtor.profile.table1.thead1' />
          </th>
          <th style="width:80px">
            <fmt:message key='s.debtor.profile.table1.thead2' />
          </th>
          <th style="width:120px">
            <fmt:message key='s.debtor.profile.table1.thead3' />
          </th>
          <th style="width:240px">
            <fmt:message key='s.debtor.profile.table1.thead4' />
          </th>
          ...
          <th style="width:80px">
            <fmt:message key='s.debtor.profile.table1.thead5' />
          </th>
          <th style="width:80px" class="if-tooltip">
          ...
          <th style="width:80px">
            <fmt:message key='s.debtor.profile.table1.thead6' />
          </th>
          <th style="width:100px">
            <fmt:message key='s.debtor.profile.table1.thead7' />
          </th>
          <th style="width:80px">
            <fmt:message key='s.debtor.profile.table1.thead8' />
          </th>
        </tr>
        </thead>
        <tbody>
        ...
        <tr class="success ifactive">
          ...
          <td class="if-tooltip">
            <a data-toggle="tooltip" href="javascrip:;" data-original-title="My invoice">${item.finStickerId}&nbsp;<i class="icon-tag"></i></a>
          </td>
          <td>
            ${item.finInvAmount}
          </td>
          <td>
            <a href="#">${item.sellerId}</a>
          </td>
          <td>
            ${item.readyToSellAdv}%
          </td>
        ...
        <div class="tab-pane" id="tab_1">
          <div>
            ...
            <table class="table table-striped table-bordered table-hover" id="content_table_2">
              ...
              <tr>
                <th style="width:20px">
                  <fmt:message key='s.debtor.profile.table2.thead' />
                </th>
                <th style="width:120px">
                  <fmt:message key='s.debtor.profile.table2.thead1' />
                </th>
                <th style="width:80px">
                  <fmt:message key='s.debtor.profile.table2.thead2' />
                </th>
                <th style="width:120px">
                  <fmt:message key='s.debtor.profile.table2.thead3' />
                </th>
                <th style="width:240px">
                  <fmt:message key='s.debtor.profile.table2.thead4' />
                </th>
                <th style="width:80px" class="if-tooltip">
                  <a data-toggle="tooltip white" data-original-title="Ready to sell advance" style="color:white"><fmt:message key='s.trading.profile.table1.thead5' />&nbsp;<i class="icon-question"></i></a>
                </th>
                <th style="width:80px">
                  <fmt:message key='s.debtor.profile.table2.thead5' />
                </th>
                <th style="width:80px" class="if-tooltip">
                  <a data-toggle="tooltip white" data-original-title="Ready to sell interest" style="color:white"><fmt:message key='s.trading.profile.table1.thead7' />&nbsp;<i class="icon-question"></i></a>
                </th>
                <th style="width:80px">
                  <fmt:message key='s.debtor.profile.table2.thead6' />
                </th>
                <th style="width:100px">
                  <fmt:message key='s.debtor.profile.table2.thead7' />
                </th>
                <th style="width:80px">
                  <fmt:message key='s.debtor.profile.table2.thead8' />
                </th>
              </tr>
              </thead>
              <tbody>
