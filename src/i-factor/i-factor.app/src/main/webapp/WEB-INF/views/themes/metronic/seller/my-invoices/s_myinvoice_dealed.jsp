            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"><fmt:message key='seller.myinvoice.list.page.header.dealed' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='seller.myinvoice.dealed.page.title' />&nbsp;&nbsp;&nbsp;<span id="invoiceNum"></span></b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.market.list.page.auctionStatus' />:&nbsp;<span style="color:#ff0000"><fmt:message key='seller.myinvoice.dealed.page.status' />&nbsp;<i class="icon-lock"></i></span></b></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm date-picker" value="From" readonly="" />
                                </div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm date-picker" value="To" readonly="" />
                                </div>
                                <!-- End Accepted Date -->
                                <!-- End hidden fields -->
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:80px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Expected net advance amount to be received" style="color:white"><fmt:message key='seller.myinvoice.dealed.page.table.th.enaatbr' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:20px">
                                    ...
                                    <tbody>
				                       ...
				                       <c:forEach var="item" items="${page.content}" varStatus="status">
				                        <tr>
				                          ...
				                          <td class="if-tooltip sorting_1">
					                          <a data-toggle="tooltip white" data-original-title="<fmt:message key="${item.flowStatus}_V1"/>:&nbsp;<fmt:formatDate value='${item.updateTime}' pattern='MM/dd/yyyy'/>" style="color:white">
					                          	<span class="badge badge-round" style="background-color:#00ff21"> 
					                          		<b style="color:#000000">25%</b>
					                          	</span>
					                          </a>
                                          </td>
				                          <td>
			                          	    <a href="javascript:;" target="main-iframe">
			                          	      <button type="button" class="btn-small btn-info btn-circle" onclick="window.open('${base}/seller/invoice/dealed/biddhistory/${item.id}');"><i class="fa fa-list"></i></button>
			                          	    </a>
				                          </td>
				                          <td><fmt:formatDate value='${item.finInvIssDate}' pattern='MM/dd/yyyy'/></td>
				                          <td>
				                           <a href="${base}/seller/invoice/dealed/detail/${item.id}">
			                          	      ${item.finStickerId}
			                           	   </a>
				                          </td>
