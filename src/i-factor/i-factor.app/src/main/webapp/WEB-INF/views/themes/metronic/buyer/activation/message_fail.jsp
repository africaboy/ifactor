...
<div class="error_block_noborder">
  <div style="float: left"><img src="${base}/static/themes/metronic/img/home/warning2.png" width="60px"></div>
  <div style="float: left; width: 580px; height: 60px; display: table; padding-left: 10px ">
    <p style="display: table-cell; vertical-align: middle; width: 100%">${message}</p>
  </div>
</div>
