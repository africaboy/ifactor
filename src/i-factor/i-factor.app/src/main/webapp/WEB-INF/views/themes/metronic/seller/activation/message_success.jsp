...
<div class="success_block_noborder">
  <div style="float: left"><img src="${base}/static/themes/metronic/img/home/success.png" width="60px"></div>
  <div style="float: left; width: 580px; height: 60px; display: table; padding-left: 10px ">
    <p style="display: table-cell; vertical-align: middle; width: 100%">
      ${message}<br /><br />
      <span style="font-size: 14px; font-weight: normal" class="driving"><fmt:message key="message.activate.success.login"/></span>
    </p>
  </div>
</div>
...
<div id="footer">
	<div id="footer-content">
       <p><fmt:message key="common.copyright"/></p>
    </div>
</div>
<!--[if lt IE 9]>
...
<script>
  ...
  $(window).ready(function(){
    ...
    var interval = setInterval(function() {
      counter--;
      $(".driving").text('System is driving you back to "Login" page in ' + counter + ' seconds');
      if (counter == 0) {
