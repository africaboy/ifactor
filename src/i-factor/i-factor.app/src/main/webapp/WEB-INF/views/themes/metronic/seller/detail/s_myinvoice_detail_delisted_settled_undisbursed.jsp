            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <a href="#"><fmt:message key='seller.myinvoice.detail.delisted.both.page.header.myInvoices' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <a href="#"> <fmt:message key='seller.myinvoice.detail.delisted.both.page.header.delistedInvoices' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                ...
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.history.delisted.both.page.auctionStatus' />:  <span style="color: #d64635"><fmt:message key='seller.history.delisted.both.page.closed' />  <i class="icon-lock"></i></span></b><span style="font-weight: bold"> <fmt:message key='seller.history.delisted.undisbursed.page.reason' /></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue">
                        <fmt:message key='seller.market.list.page.panel.body.financing' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtclosedDate" value="<fmt:formatDate value='${invoice.endDate}' pattern='MM/dd/yyyy'/>">
                                </div>
                                ...
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtduration" value="${invoice.finRmngMatTerm}&nbsp;<fmt:message key='b.make.new.offer.page.tab1.days' />">
                                </div>
                                <!-- Row 5 -->
                                ...
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtReleaseDate" value="<fmt:formatNumber  value='${invoice.finInvAmount}' type='number' />&nbsp;VND">
                                </div>
                ...
                <div class="clearfix">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-body">
                             <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='seller.apply.form.field.companyName' /></a></div>
                            ...
                            <div class="row">
                                <!-- Row 2 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='invoice.submit.form.field.sellerRepresentedBy' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="${base}/seller/profile/debtor">&gt;&gt;&gt; <fmt:message key='seller.myinvoice.detail.delisted.both.page.viewMore' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                ...
                <div class="clearfix">
                   ...
                   <span class="if-panel-next_to"> <a href="${base}/seller/invoice/delistedundisbursed/biddhistory">&gt;&gt;&gt; <fmt:message key='seller.myinvoice.detail.delisted.both.page.viewBiddingHistory' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue">
                        <fmt:message key='seller.myinvoice.detail.delisted.both.page.panel.title.documentation' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
