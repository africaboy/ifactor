        ...
        <div class="page-content-wrapper">
            <div class="page-content if-detail-auction-content">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDelistingDate" value="<fmt:formatDate value='${invoice.endDate}' pattern='MM/dd/yyyy'/>">
                                </div>
                                <!-- Row 5 -->
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="${base}/buyer/profile/seller">&gt;&gt;&gt; <fmt:message key='b.mybid.detail.partially.settled.auction.seller.information1' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="${base}/buyer/profile/debtor">&gt;&gt;&gt; <fmt:message key='b.mybid.detail.partially.settled.auction.debtor.information1' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="${base}/buyer/auction/dealed/biddhistory">&gt;&gt;&gt; <fmt:message key='b.mybid.detail.partially.settled.auction.your.offer1' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
