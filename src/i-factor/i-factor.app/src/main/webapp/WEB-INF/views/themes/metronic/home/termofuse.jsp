...
<div class="slider-containter">
     <div class="slider-wrapper theme-default">
       <img src="${base}/static/themes/metronic/img/home/tou_background.png" alt="">
     </div>
...
<div class="policyheader">
  <c:if test="${self.locale=='en_US'}">
    <span style="font-weight: lighter"><fmt:message key="termofuse.content.header.term"/></span>&nbsp;<span style="font-weight: bold"><fmt:message key="termofuse.content.header.of"/></span>
  </c:if>
  <c:if test="${self.locale=='vi_VN'}">
    <span style="font-weight: bold"><fmt:message key="termofuse.content.header.term"/></span>&nbsp;<span style="font-weight: bold"><fmt:message key="termofuse.content.header.of"/></span>
  </c:if>
</div>
<div class="policy_block_container">
  <div class="tou_heading">
    <fmt:message key="termofuse.content.block1.heading"/>
  </div>
  <div class="tou_content tou_line">
   <fmt:message key="termofuse.content.block1.line"/><br />
  </div>
  <div class="tou_content">
   <fmt:message key="termofuse.content.block1.content"/>&nbsp;<a href="" style="color:#1150af"><u><i><fmt:message key="termofuse.content.block1.content.email"/></i></u></a>&nbsp;<fmt:message key="termofuse.content.block1.content.for"/>
  </div>
  <div class="tou_heading">
   <fmt:message key="termofuse.content.block2.heading"/>
  </div>
  <div class="tou_content tou_line">
    <fmt:message key="termofuse.content.block2.line"/>&nbsp;<a href="" style="color:#1150af"><u><i><fmt:message key="termofuse.content.block1.content.email"/></i></u></a>&nbsp;<fmt:message key="termofuse.content.block1.content.for"/>
  </div>
  <div class="tou_content">
    <fmt:message key="termofuse.content.block2.content"/>
  </div>
  <div class="tou_heading">
    <fmt:message key="termofuse.content.block3.heading"/>
  </div>
  <div class="tou_content">
    <fmt:message key="termofuse.content.block3.content"/>
  </div>
  <div class="tou_heading">
    <fmt:message key="termofuse.content.block4.heading"/>
  </div>
  <div class="tou_content tou_line">
    <fmt:message key="termofuse.content.block4.line"/>
  </div>
  <div class="tou_content tou_end">
    <fmt:message key="termofuse.content.block4.content"/>
  </div>
</div>
