                                                ...
                                                <div class="tab-pane active" id="tab1">
                                                	<form class="form-horizontal" id="form-personal-info" method="post" enctype="multipart/form-data">
	                                                    ...
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
	                                                            <select name="gender" class="form-control if-input-sm if-div-input-md" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.gender.required'/>">
																	<option value=""></option>
	                                                    ...
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
	                                                            ...
	                                                            <input type="text" class="form-control if-input-sm if-div-input-md" style="display: inline-block; max-width: 79%;float: right" id="mobilePhone" name="mobilePhone"  data-rule-required="true" readonly value="${buyerApply.mobilePhone}">
						  									</div>
	                                                    </div>
                                                    </form>
                                                </div>
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                    ...
                                                    <form class="form-horizontal" id="form-further-details"
	                                                    ...
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
	                                                            <input type="text" class="form-control if-input-sm if-div-input-md" id="companyName" name="companyName"    data-rule-required="true"  value="${buyerApply.companyName}" data-msg-required="<fmt:message key='buyer.apply.form.field.companyName.required'/>">
						 									</div>
	                                                        <div class="control-label col-md-3">
	                                                            <fmt:message key='buyer.apply.form.field.isComVietnam' /><span class="required">*</span>
	                                                        </div>
	                                                        <div class="col-md-3">
	                                                        	<select class="form-control if-input-sm if-div-input-md" id="isComVietnam" name="isComVietnam" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.isComVietnam.required'/>">
											                        <option value=""></option>
	                                                    ...
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
		                                                        ...
		                                                        <select  class="form-control if-input-sm if-div-input-md" id="comRegisteredCountry" name="comRegisteredCountry" 	data-rule-required="true" data-msg-required="<fmt:message key='seller.apply.form.field.comRegisteredCountry.required'/>"  <c:if test="${buyerApply.isComVietnam == 'Yes' }">disabled</c:if>>
																	<option value="">  </option>
																	<c:forEach var="item" items="${countryList}" varStatus="status">
																    <option value="${item.code}"<c:if test="${item.code==buyerApply.comRegisteredCountry}"> selected</c:if>>${item[self.i18n.catalog_name]}</option>
																	</c:forEach>
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="comRegistrationNumber" name="comRegistrationNumber"    data-rule-required="true"  value="${buyerApply.comRegistrationNumber}" data-msg-required="<fmt:message key='buyer.apply.form.field.comRegistrationNumber.required'/>" data-rule-pattern="^[0-9a-zA-Z]{8,12}$" data-msg-pattern="<fmt:message key='buyer.apply.form.field.comRegistrationNumber.pattern'/>">
					    									</div>
	                                                    </div>
	                                                    <!-- row 3 -->
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="comTaxCode" name="comTaxCode"   data-rule-required="true"  value="${buyerApply.comTaxCode}" data-msg-required="<fmt:message key='buyer.apply.form.field.comTaxCode.required'/>" data-rule-pattern="^[0-9a-zA-Z]{8,12}$" data-msg-pattern="<fmt:message key='buyer.apply.form.field.comTaxCode.pattern'/>">
					    									</div>
	                                                        <div class="control-label col-md-3">
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<input type="text" class="form-control if-input-sm if-div-input-md date-picker" id="comEstablishmentDate" name="comEstablishmentDate" 
																	autocomplete="off" data-rule-required="true" value="<fmt:formatDate value='${buyerApply.comEstablishmentDate}' pattern='MM/dd/yyyy'/>"
	                                                    ...
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<select class="form-control if-input-sm if-div-input-md" id="comDurationInVt" name="comDurationInVt" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.comDurationInVt.required'/>">
										                        <option value=""></option>
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="comAddress" name="comAddress"  data-rule-required="true" value="${buyerApply.comAddress}" data-msg-required="<fmt:message key='buyer.apply.form.field.comAddress.required'/>">
					    									</div>
	                                                    </div>
	                                                    <!-- row 5 -->
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="comDistrict" name="comDistrict"   data-rule-required="true"  value="${buyerApply.comDistrict}" data-msg-required="<fmt:message key='buyer.apply.form.field.comDistrict.required'/>">
					    									</div>
	                                                        <div class="control-label col-md-3">
	                                                            <fmt:message key='buyer.apply.form.field.comCity' />  <span class="required">*</span>
	                                                        </div>
	                                                        <div class="col-md-3">
	                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="comCity" name="comCity"   data-rule-required="true"  value="${buyerApply.comCity}" data-msg-required="<fmt:message key='buyer.apply.form.field.comCity.required'/>">
															</div>
	                                                    </div>
	                                                    <!-- row 6 -->
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="comRegion" name="comRegion"  value="${buyerApply.comRegion}">
															</div>
	                                                        <div class="control-label col-md-3">
	                                                            <fmt:message key='buyer.apply.form.field.comPostcode' />
	                                                        </div>
	                                                        <div class="col-md-3">
	                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="comPostcode" name="comPostcode"  value="${buyerApply.comPostcode}" data-rule-pattern="^.{4,8}$" data-msg-pattern="<fmt:message key='buyer.apply.form.field.comPostcode.pattern'/>">
					    									</div>
	                                                    </div>
	                                                    <!-- row 7 -->
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<select class="form-control if-input-sm if-div-input-md" id="comCountry" name="comCountry" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.comCountry.required'/>">
										                        <option value=""></option>
										                        <c:forEach var="item" items = "${countryList}" varStatus = "status">
	                                                    ...
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<input type="checkbox" class="form-control if-input-sm if-div-input-md" id="isComAddress2" name="isComAddress2"<c:if test="${not empty buyerApply.address2}"> checked</c:if> />
	                                                    ...
	                                                    <div id="different" 
		                                                    ...
		                                                    <div class="form-group if-form-group-sm">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="address" name="address"   data-rule-required="false"   value="${buyerApply.address}" data-msg-required="<fmt:message key='buyer.apply.form.field.address.required'/>">
						    									</div>
		                                                        <div class="control-label col-md-3">
		                                                            <fmt:message key='buyer.apply.form.field.district2' /> <span class="required">*</span>
		                                                        </div>
		                                                        <div class="col-md-3">
		                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="district2" name="district2"    data-rule-required="false"  value="${buyerApply.district2}" data-msg-required="<fmt:message key='buyer.apply.form.field.district2.required'/>">
						    									</div>
		                                                    </div>
		                                                    <!-- row 10 -->
		                                                    <div class="form-group if-form-group-sm">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="city2" name="city2" data-rule-required="false" value="${buyerApply.city2}" data-msg-required="<fmt:message key='buyer.apply.form.field.city2.required'/>">
						    									</div>
		                                                        <div class="control-label col-md-3" style="display: inline-block">
		                                                            <fmt:message key='buyer.apply.form.field.region2' />
		                                                        </div>
		                                                        <div class="col-md-3">
		                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="region2" name="region2" value="${buyerApply.region2}" >
						    									</div>
		                                                    </div>
		                                                    <!-- row 11 -->
		                                                    <div class="form-group if-form-group-sm">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<select class="form-control if-input-sm if-div-input-md" id="country2" name="country2" data-rule-required="false" data-msg-required="<fmt:message key='buyer.apply.form.field.country2.required'/>">
											                        <option value=""></option>
											                        <c:forEach var="item" items = "${countryList}" varStatus = "status">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="postcode" name="postcode" data-rule-required="false"   value="${buyerApply.postcode}" data-msg-required="<fmt:message key='buyer.apply.form.field.postcode.required'/>">
						    									</div>
		                                                    </div>
	                                                    </div>
	                                                    <!-- row 12 -->
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<select class="form-control if-input-sm if-div-input-md" id="comType" name="comType" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.comType.required'/>">
										                        <option value=""></option>
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<select class="form-control if-input-sm if-div-input-md" id="comIndustry" name="comIndustry" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.comIndustry.required'/>">
										                        <option value=""></option>
	                                                    ...
	                                                    <div class="form-group if-form-group-sm">
	                                                        ...
	                                                        <div class="col-md-3">
										                     <select class="form-control if-input-sm if-div-input-md" id="position" name="position" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.position.required'/>">
										                        <option value=""></option>
	                                                        ...
	                                                        <div class="col-md-3">
	                                                        	<select class="form-control if-input-sm if-div-input-md" id="areAuthorizedPerson" name="areAuthorizedPerson" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.areAuthorizedPerson.required'/>">
											                      <option value=""></option>
	                                                    ...
	                                                    <div id="rowtoend" 
		                                                    ...
		                                                    <div class="form-group if-form-group-sm">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<select class="form-control if-input-sm if-div-input-md" id="authzTitle" name="authzTitle" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.authzTitle.required'/>">
											                        <option value=""></option>
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="authzFirstName" name="authzFirstName"  data-rule-required="true" value="${buyerApply.authzFirstName}"  data-msg-required="<fmt:message key='buyer.apply.form.field.authzFirstName.required'/>">
							  									</div>
		                                                    </div>                                                    
		                                                    <!-- row 19 -->
		                                                    <div class="form-group if-form-group-sm">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="authzLastName" name="authzLastName"  data-rule-required="true" value="${buyerApply.authzLastName}" data-msg-required="<fmt:message key='buyer.apply.form.field.authzLastName.required'/>">
							  									</div>
		                                                        <div class="control-label col-md-3" style="display: inline-block">
		                                                            <fmt:message key='buyer.apply.form.field.authzEmail' /><span class="required">*</span>
		                                                        </div>
		                                                        <div class="col-md-3">
		                                                        	<input type="email" class="form-control if-input-sm if-div-input-md" id="authzEmail" name="authzEmail" data-rule-required="true" value="${buyerApply.authzEmail}" data-rule-email="true"  data-msg-required="<fmt:message key='buyer.apply.form.field.authzEmail.required'/>">
							  									</div>
		                                                    </div>                                                    
		                                                    <!-- row 20 -->
		                                                    <div class="form-group if-form-group-sm">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="authzPositon" name="authzPositon"   data-rule-required="true"  value="${buyerApply.authzPositon}" data-msg-required="<fmt:message key='buyer.apply.form.field.authzPositon.required'/>">
							  									</div>
		                                                        <div class="control-label col-md-3" style="display: inline-block">
		                                                            <fmt:message key='buyer.apply.form.field.authzGender' /> <span class="required">*</span>
		                                                        </div>
		                                                        <div class="col-md-3">
		                                                        	<select class="form-control if-input-sm if-div-input-md" id="authzGender" name="authzGender" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.authzGender.required'/>">
											                          <option value=""></option>
											                          <c:forEach var="item" items = "${genderList}" varStatus = "status">
		                                                    ...
		                                                    <div class="form-group if-form-group-sm">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<select class="form-control if-input-sm if-div-input-md" id="authzNationality" name="authzNationality" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.authzNationality.required'/>">
											                          <option value=""></option>
											                          <c:forEach var="item" items = "${countryList}" varStatus = "status">
		                                                    ...
		                                                    <div class="form-group if-form-group-sm">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<select class="form-control if-input-sm if-div-input-md" id="authzResidenceCountry" name="authzResidenceCountry" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.authzResidenceCountry.required'/>"> 
											                          <option value=""></option>
											                          <c:forEach var="item" items = "${countryList}" varStatus = "status">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<select class="form-control if-input-sm if-div-input-md" id="authzIdType" name="authzIdType" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.authzIdType.required'/>">
											                          <option value=""></option>
											                          <c:forEach var="item" items = "${idTypeList}" varStatus = "status">
		                                                    ...
		                                                    <div class="form-group if-form-group-sm">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                        	<input type="text" class="form-control if-input-sm if-div-input-md" id="authzIdNumber" name="authzIdNumber"   data-rule-required="true" value="${buyerApply.authzIdNumber}" data-msg-required="<fmt:message key='buyer.apply.form.field.authzIdNumber.required'/>">
							  									</div>
		                                                        <div class="control-label col-md-3" style="display: inline-block">
		                                                            <fmt:message key='buyer.apply.form.field.authzPhone' />
		                                                        </div>
		                                                        <div class="col-md-3">
		                                                          <input type="text" class="form-control if-input-sm if-div-input-md" value="${buyerApply.auPhCountryCode}" style="display: inline-block; max-width: 20%;float: left" id="auPhCountryCode"
		                                                          ...
		                                                          <input type="text" class="form-control if-input-sm if-div-input-md" value="${buyerApply.authzPhone}" style="display: inline-block; max-width: 79%;float: right" id="authzPhone" name="authzPhone"
																	placeholder=""
		                                                    ...
		                                                    <div class="form-group if-form-group-sm">
		                                                        ...
		                                                        <div class="col-md-3">
		                                                          ...
		                                                          <input type="text" class="form-control if-input-sm if-div-input-md" value="${buyerApply.authzMobilePhone}" style="display: inline-block; max-width: 79%;float: right" id="authzMobilePhone"
