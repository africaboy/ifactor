        ...
        <div class="page-content-wrapper">
            <div class="page-content if-detail-auction-content">
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="${base}/buyer/profile/seller">&gt;&gt;&gt; <fmt:message key='b.mybid.detail.overdue.auction.seller.information1' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="${base}/buyer/profile/debtor">&gt;&gt;&gt; <fmt:message key='b.mybid.detail.overdue.auction.debtor.information1' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="${base}/buyer/auction/dealed/biddhistory">&gt;&gt;&gt; <fmt:message key='b.mybid.detail.overdue.auction.your.offer1' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
