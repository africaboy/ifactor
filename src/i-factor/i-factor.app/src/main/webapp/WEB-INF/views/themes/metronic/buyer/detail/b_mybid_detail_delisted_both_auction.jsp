    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content if-detail-auction-content">
                ...
                <h5 class="page-title">
                    <small><b>Auction status:  </b><span style="color: #d64635"><b>CLOSED - Delisted</b> <i class="icon-lock"></i>&nbsp;&nbsp;Reason: Unsuccesful disbursement & Expired</span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-12 if-div-input-sm">
                                    <input type="text" class="form-control if-input-sm" readonly value="Industry">
                                </div>
                                <!-- Row 2 -->
                            </div>
                        </div>
