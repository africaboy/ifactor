            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"><fmt:message key='buyer.view.page.title' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='buyer.view.page.title' /></b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='buyer.view.page.date' />: </b> <span><fmt:formatDate value='${buyerApply.submissionDate}' pattern='MM/dd/yyyy'/>  </span></small>                    
                </h5>
                <c:choose>
			        <c:when test="${buyerApply.flowStatus=='yjoUTSRriH_ANAzqfzpXu'}">
	                <h5 class="page-title">
	                    <small><b><fmt:message key='buyer.view.page.status' />: </b> <span style="color: red;font-weight: bold"><fmt:message key='seller.myinvoice.detail.modification.page.status' /></span></small>                    
	                </h5>
	                <h5 class="page-title">
	                ...
	                <c:otherwise>
	                <h5 class="page-title">
	                    <small><b><fmt:message key='buyer.view.page.status' />: </b> <span style="color: green;font-weight: bold"><fmt:message key='buyer.view.page.Status' /></span></small>                    
	                </h5>
	                </c:otherwise>
	            </c:choose>
                <!-- END PAGE HEADER-->
                                        ...
                                        <div class="form-body">
                                                ...
                                                <li>
                                                    <a href="#tab2" data-toggle="tab" class="step">
                                                      <a href="javascript:void(0)" class="step" id="table2">
                                                        ...
                                                        <div class="desc">
                                                            <i class="fa fa-check"></i> <fmt:message key='buyer.apply.tab.further' />
                                                        </div>
                                                      </a>
                                                    </a>
                                                </li>
                                            ...
                                            <div class="tab-content">
                                                <div class="step-title">
                                                    <fmt:message key='buyer.apply.form.field.step-title' />
                                                </div>
                                                ...
                                                <div class="tab-pane active" id="tab1">
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" name="Title" id="Title" disabled="disabled"  value="${buyerApply.title}" />
                                                        </div>
                                                        <div class="control-label col-md-2">
                                                            <fmt:message key='buyer.apply.form.field.firstname'/><span class="required">*</span>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" name="FirstName" id="FirstName" disabled="disabled" value="${buyerApply.firstName}" />
                                                        </div>
                                                    ...
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" name="LastName" id="LastName" disabled="disabled" value="${buyerApply.lastName}" />
                                                        </div>
                                                        <div class="control-label col-md-2">
                                                            <fmt:message key='buyer.apply.form.field.email'/><span class="required">*</span>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" name="email" disabled="disabled" value="${buyerApply.email}" />
                                                        </div>
                                                        <div class="col-md-offset-1"></div>
                                                    </div>
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" disabled="disabled" value="${buyerApply.investAs}">
                                                        </div>
                                                        <div class="control-label col-md-2">
                                                            <fmt:message key='buyer.apply.form.field.gender'/> <span class="required">*</span>
                                                        </div>
                                                        <div class="col-md-3" style="width:257px; overflow: hidden;">
                                                        	<select style="width: 300px;" class="form-control if-input-sm if-div-input-md" disabled="disabled" id="gender" name="gender" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.gender.required'/>" >
                                                            <option value=""></option>
                                                    ...
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3 if-input-md">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" disabled="disabled" id="dateOfBirth" name="dateOfBirth"   data-rule-required="true"  value="<fmt:formatDate value='${buyerApply.dob}' pattern='MM/dd/yyyy'/>" data-msg-required="Please enter DOB">
                                                        </div>
                                                        <div class="control-label col-md-2">
                                                            <fmt:message key='buyer.apply.form.field.nationality'/> <span class="required">*</span>
                                                        </div>
                                                        <div class="col-md-3" style="width: 257px; overflow: hidden;">
                                                        	<select style="width: 300px;" class="form-control if-input-sm if-div-input-md" disabled="disabled" id="nationality" name="nationality" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.nationality.required'/>">
                          									<option value=""></option>
                                                    ...
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3" style="width: 257px; overflow: hidden;">
                                                        	<select style="width: 300px;" class="form-control if-input-sm if-div-input-md" disabled="disabled" id="residenceCountry" name="residenceCountry" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.residenceCountry.required'/>">
									                          <option value=""></option>
									                          <c:forEach var="item" items = "${countryList}" varStatus = "status">
                                                        ...
                                                        <div class="control-label col-md-2" style="margin-left: 5px;">
                                                            <fmt:message key='buyer.apply.form.field.idType'/><span class="required">*</span>
                                                        </div>
                                                        <div class="col-md-3" style="width: 257px; overflow: hidden;">
                                                        	<select style="width: 300px;" class="form-control if-input-sm if-div-input-md" disabled="disabled" id="idType" name="idType" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.idType.required'/>">
									                          <option value=""></option>
                                                    ...
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" disabled="disabled" id="idNumber" name="idNumber"   data-rule-required="true"  value="${buyerApply.idNumber}" data-msg-required="<fmt:message key='buyer.apply.form.field.idNumber.required'/>">
                                                        </div>
                                                        <div class="control-label col-md-2">
                                                            <fmt:message key='buyer.apply.form.field.workPhone'/>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" style="display: inline-block; max-width: 20%;float: left" disabled="disabled" id="workCountryCode" name="workCountryCode"  value="${buyerApply.workCountryCode}" >
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" style="display: inline-block; max-width: 79%;float: right" disabled="disabled" id="phone" name="phone" data-rule-required="true"  value="${buyerApply.phone}">
                                                        </div>
                                                        <div class="col-md-offset-1"></div>
                                                    </div>
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" style="display: inline-block; max-width: 20%;float: left" disabled="disabled" id="mobileCountryCode" name="mobileCountryCode" value="${buyerApply.mobileCountryCode}">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" style="display: inline-block; max-width: 79%;float: right" disabled="disabled" id="mobilePhone" name="mobilePhone"  data-rule-required="true"  value="${buyerApply.mobilePhone}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                    ...
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" disabled="disabled" id="residenceAddress" name="residenceAddress"   data-rule-required="true"  value="${buyerApply.residenceAddress}" data-msg-required="<fmt:message key='buyer.apply.form.field.residenceAddress.required'/>">
                                                        </div>
                                                        <div class="control-label col-md-3">
                                                            <fmt:message key='buyer.apply.form.field.district'/><span class="required">*</span>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" name="district" id="district" disabled="disabled" data-rule-required="true"  value="${buyerApply.district}" data-msg-required="<fmt:message key='buyer.apply.form.field.district.required'/>">
                                                        </div>
                                                    </div>
                                                    <!-- row 2 -->
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" name="city" id="city" disabled="disabled" data-rule-required="true"  value="${buyerApply.city}" data-msg-required="<fmt:message key='buyer.apply.form.field.required'/>">
                                                        </div>
                                                        <div class="control-label col-md-3">
                                                            <fmt:message key='buyer.apply.form.field.region'/>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" name="region" id="region" disabled="disabled" data-rule-required="true"    value="${buyerApply.region}">
                                                        </div>
                                                    </div>
                                                    <!-- row 3 -->
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3" style="width: 255px; overflow: hidden;">
                                                        	<select style="width: 300px;" class="form-control if-input-sm if-div-input-md" id="country" name="country" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.country.required'/>" disabled="disabled">
									                          <option value=""></option>
									                          <c:forEach var="item" items = "${countryList}" varStatus = "status">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" name="occupation" id="occupation" disabled="disabled" data-rule-required="true"    value="${buyerApply.employer}" data-msg-required="<fmt:message key='buyer.apply.form.field.employer.required'/>">
                                                        </div>
                                                    </div>
                                                    <!-- row 4 -->
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3" style="margin-top:7px;">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" name="employerName" id="employerName"  disabled="disabled" data-rule-required="true"   value="${buyerApply.employerName}" data-msg-required="<fmt:message key='buyer.apply.form.field.employerName.placeholder'/>">
                                                        </div>
                                                        <div class="control-label col-md-3">
                                                            <fmt:message key='buyer.apply.form.field.comIndustry' />  <span class="required">*</span>
                                                        </div>
                                                        <div class="col-md-3" style="margin-top:7px;width: 257px; overflow: hidden;">
						                                   <select style="width: 300px;" class="form-control if-input-sm if-div-input-md" id="priIndustry" name="priIndustry" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.comIndustry.required'/>" disabled="disabled">
															<option value=""></option>
                                                    ...
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3" style="margin-top: 9px;width: 257px; overflow: hidden;">
                                                        	<select style="width: 300px;" class="form-control if-input-sm if-div-input-md" id="haveEverTradingOther" name="haveEverTradingOther" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.haveEverTradingOther.required'/>" disabled="disabled">
																<option value=""></option>
                                                        ...
                                                        <div class="control-label col-md-3 if-control-label-md" style="margin-left: 4px;margin-top: 7px;">
                                                            <fmt:message key='buyer.apply.form.field.whatIsAsset' />  <span class="required">*</span>
                                                        </div>
                                                        <div class="col-md-3" style="margin-top: 9px;width: 257px; overflow: hidden;">
                                                        	<select style="width: 300px;" class="form-control if-input-sm if-div-input-md" id="whatIsAsset" name="whatIsAsset" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.whatIsAsset.required'/>" disabled="disabled">
																<option value=""></option>
                                                    ...
                                                    <c:forEach var="question" items="${questions}" varStatus="status">
														...
														<c:if test="${idx%2 == 0}">
														  <div class="form-group if-form-group-sm">
															...
															<c:if test="${question.atype == 'text' }">
																<div class="col-md-3">
																	<input type="text" value="${buyerApply.questions[idx][self.i18n.question_atext]}" class="form-control if-input-sm if-div-input-md" name="questions[${idx}].atext" data-rule-required="true" disabled="disabled">
																</div>
															</c:if>
															<c:if test="${question.atype == 'select' }">
																<div class="col-md-3" style="margin-top: 1px;width: 257px; overflow: hidden;">
																	<select style="width: 300px;" name="questions[${idx}].atext" class="form-control if-input-sm if-div-input-md" id="question${idx}" disabled="disabled">
																		<option value=""></option>
														...
														<c:if test="${idx%2 != 0}">
															...
															<c:if test="${question.atype == 'select' }">
																<div class="col-md-3" style="margin-top: 5px;width: 257px; overflow: hidden;">
																	<select style="width: 300px;" name="questions[${idx}].atext" class="form-control if-input-sm if-div-input-md" id="question${idx}" disabled="disabled">
																		<option value=""></option>
																		<c:forEach var="questionOption" items="${question.options}">
																			<option value="${questionOption[self.i18n.question_atext]}"
											        ...
											        <c:if test="${user.fromChannels == 'Introduced from BANK/ENTITY staff' }">
														...
														<div class="col-md-3" style="margin-top: 5px;">
															<select id="whichBusFrom" name="whichBusFrom" class="form-control if-input-sm if-div-input-md" 
																...
																data-msg-required="<fmt:message key='buyer.apply.form.field.whichBusFrom.required'/>" disabled="disabled">
																<option value=""></option>
                                                ...
                                                <div class="tab-pane" id="tab3">
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3 filediv">
	                                                        <div id="file-link-authorizedFile" class="filename;" style="margin-top: 7px;">
                                                ...
                                                <div class="tab-pane" id="tab4">
                                                    ...
                                                    <div class="form-group" style="margin-top: 10px">
											          	<input type="checkbox" readonly  id="checkbox-accept" class="form-control if-input-sm if-div-input-md">&nbsp;&nbsp;&nbsp;<span class="bold"><fmt:message key='buyer.apply.form.field.content.agree' /></span>
											        </div>
                                                </div>
                                            </div>
                                        </div>
