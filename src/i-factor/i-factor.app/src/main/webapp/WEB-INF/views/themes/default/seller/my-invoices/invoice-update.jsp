...
<c:set target="${self.js}" property="main">
    ...
    <script type="text/javascript" src="${base}/static/themes/default/js/seller/my-invoices/invoice-update.js"></script>
</c:set>
                     ...
                     <div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="finInvAmount"
								...
								data-rule-pattern="^[0-9]{0,10}$" data-msg-pattern="<fmt:message key='invoice.submit.form.field.finInvAmount.pattern'/>" <c:if test="${not fn:contains(modifyFields,'finInvAmount') && isModifyStatus}">readonly</c:if>>
					    </div>
								...
								<c:otherwise>
		                          <div class="input-group">
		                            <input type="text" class="form-control" id="finDueDateAccToCont" name="finDueDateAccToCont" value="<fmt:formatDate value='${invoice.finDueDateAccToCont}' pattern='yyyy-MM-dd'/>"  autocomplete="off" data-rule-required="true" data-msg-required="<fmt:message key='invoice.submit.form.field.finDueDateAccToCont.required'/>" data-rule-pattern="^(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)-02-29)$" data-msg-pattern="<fmt:message key='invoice.submit.form.field.finDueDateAccToCont.pattern'/>" 
		                             data-rule-isAfterToday="true" 	data-msg-isAfterToday="<fmt:message key='invoice.submit.form.field.finDueDateAccToCont.isAfterToday'/>"  />
		                            <span class="input-group-addon">
									  <i class="icon-calendar"></i>
									</span>
								  </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                         <c:choose>
								...
								<c:otherwise>
		                          <div class="input-group">
		                            <input type="text" class="form-control" id="finExpPmtDate" name="finExpPmtDate"  value="<fmt:formatDate value='${invoice.finExpPmtDate}' pattern='yyyy-MM-dd'/>"   autocomplete="off" data-rule-required="true" data-msg-required="<fmt:message key='invoice.submit.form.field.finExpPmtDate.required'/>" data-rule-pattern="^(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)-02-29)$" data-msg-pattern="<fmt:message key='invoice.submit.form.field.finExpPmtDate.pattern'/>"  data-rule-isAfterDueDate="true"
