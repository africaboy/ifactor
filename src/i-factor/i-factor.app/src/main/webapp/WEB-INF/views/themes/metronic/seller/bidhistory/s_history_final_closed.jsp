            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                  <ul class="page-breadcrumb">
                    <li>
                      <a href="#"><fmt:message key='s.history.final.closed.page.breadcrumb' /></a>
                      <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                      <a href="#"><fmt:message key='s.history.final.closed.page.breadcrumb1' /></a>
                      <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                      <a href="#"> <fmt:message key='s.history.final.closed.page.breadcrumb2' /> </a>
                    </li>
                  </ul>
                </div>
                <h5 class="page-title">
                  <b> <fmt:message key='s.history.final.closed.page.breadcrumb3' /> </b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='s.history.final.closed.page.breadcrumb4' />  <span style="color: #d64635"> <fmt:message key='s.history.final.closed.page.breadcrumb5' />  </span><i style="color: #d64635" class="fa fa-power-off"></i></b></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-light-grey">
                        <fmt:message key='s.history.final.closed.invoice.summary' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary1' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <span class="if-icon-addon"><a href="javascript:;"><i style="color: #d64635" class="fa fa-power-off"></i></a></span>
                                    </div>
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary2' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <div class="input-group">
                                ...
                                <!-- Row 2 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary3' /></a></div>
                                <div class="col-sm-6 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDetorID" value="${invoice.debtorName}">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary4' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtObject" value="${invoice.finObjOfInv}">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary5' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                ...
                                <!-- Row 3 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary6' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary7' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDueDate" value="1 day">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary8' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDisbursementdate" value="12/24/2014">
                                </div>
                                <!-- Row 4 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary9' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                  <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDelistDate" value="02/24/2015">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary10' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                  <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDueDate" value="02/22/2015">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary11' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                  <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDisbursementdate" value="-2 days">
                                </div>
                                <!-- Row 4 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary12' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                  <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDelistDate" value="100,000,000 VND">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.invoice.summary13' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                  <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDueDate" value="100,000,000 VND">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue">
                        <fmt:message key='s.history.final.closed.readytosell.information' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.readytosell.information1' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtAdvance" value="${invoice.readyToSellAdv}">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.final.closed.readytosell.information2' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-green">
                      <fmt:message key='s.history.final.closed.accepted.offer' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                ...
                <!-- End Accepted offer -->
                <h5 class="page-title">
                  <small><b> <fmt:message key='s.history.final.closed.bidding.history' /></b></small>
                </h5>
                <div class="row">
                  <div class="col-md-12">
                    <div class="portlet box">
                      <div class="">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="content_table">
                          ...
                          <tr>
                            <th style="width:20px">
                              <fmt:message key='s.history.final.closed.bidding.history1' />
                            </th>
                            <th>
                              <fmt:message key='s.history.final.closed.bidding.history2' />
                            </th>
                            <th style="width:120px">
                              <fmt:message key='s.history.final.closed.bidding.history3' />
                            </th>
                            <th style="width:120px">
                              <fmt:message key='s.history.final.closed.bidding.history4' />
                            </th>
                            <th>
                              <fmt:message key='s.history.final.closed.bidding.history5' />
                            </th>
                            <th>
                              <fmt:message key='s.history.final.closed.bidding.history6' />
                            </th>
                          </tr>
                          </thead>
                          <tbody>
