...
<c:set target="${self.js}" property="main">
    ...
    <script type="text/javascript" src="${base}/static/themes/default/js/buyer/mybids/openbids.js"></script>
...
<c:set target="${self.content}" property="main">
                ...
                <div id="form-main">
		          <div>
		             <form class="form-inline" action="${base}/buyer/bid/openList"  id="formQuery" name="formQuery"  method="post" role="form">
                          ...
                          <table class="table table-bordered">
                            ...
                            <c:if test="${not empty page.content}">
                              <c:forEach var="item" items="${page.content}" varStatus="status">  
                               <tr>
	                            <td>
	                              <a href="/buyer/bid/open/${item.id}" class="btn btn-default" target="main-iframe">Detail</a>
