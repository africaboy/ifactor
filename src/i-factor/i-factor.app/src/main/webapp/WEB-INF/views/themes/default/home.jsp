...
<!--<![endif]-->
  <head>
    ...
    <link rel="stylesheet" href="${base}/static/themes/default/css/home.css?ver=${version.app}">
  ...
  <body style="margin: 0; padding: 0;background:#515151">
    ...
    <div class="container" style="width:1200px;padding:0;margin-top:0;">
      ...
      <div class="home-container" id="home-container">
         <a href="${base}/buyer/register<c:if test='${not empty self.locale}'>?locale=${self.locale}</c:if>" id="buyerRegEntry" /><fmt:message key="home.entry.buyer"/></a>
         <a href="${base}/seller/register<c:if test='${not empty self.locale}'>?locale=${self.locale}</c:if>" id="sellerRegEntry" /><fmt:message key="home.entry.seller"/></a>
      </div>
