            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended last">
                        <a href="${base}/seller/invoice/under-approval" class="dropdown-toggle if-logout">
            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <a href="#"><fmt:message key='s.myinvoice.detail.closed.page.breadcrumb' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <a href="#"><fmt:message key='s.myinvoice.detail.closed.page.breadcrumb1' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <a href="#"><fmt:message key='s.myinvoice.detail.closed.page.breadcrumb2' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='s.myinvoice.detail.closed.page.breadcrumb3' />&nbsp;${invoice.id }</b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='s.myinvoice.detail.closed.page.breadcrumb4' /></b><span style="color: #808080"><b>&nbsp;${invoice.flowStatus }</b></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue">
                        <fmt:message key='s.myinvoice.detail.closed.financing.information' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.financing.information1' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <span class="if-icon-addon"><a href="javascript:;"><i class="fa fa-power-off" style="color: #808080;"></i></a></span>
                                    </div>
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.financing.information2' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <div class="input-group">
                                ...
                                <!-- Row 2 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.financing.information3' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.financing.information4' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDetorID" value="${invoice.finVatInvNo}">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.financing.information5' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtSellerID" value="${invoice.finObjOfInv}">
                                </div>
                                <!-- Row 3 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.financing.information6' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.financing.information7' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.financing.information8' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                ...
                                <!-- Row 4 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.financing.information9' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.financing.information10' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue">
                        <fmt:message key='s.myinvoice.detail.closed.seller.information' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.seller.information1' /></a></div>
                            ...
                            <div class="row">
                                <!-- Row 2 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.seller.information2' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue">
                        <fmt:message key='s.myinvoice.detail.closed.debtor.information' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.debtor.information1' /></a></div>
                                <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.debtor.information2' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtInterest" value="${invoice.debtorBizRegNo}"></span>
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.closed.debtor.information3' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue">
                        <fmt:message key='s.myinvoice.detail.closed.documentation' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                 ...
                                 <div class="col-sm-2 col-xs-12" style="margin-top: 0.45%;">
