            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"> Final closed  Auctions</a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                ...
                <h5 class="page-title">
                    <b>Invoice details - Invoice ID 12323</b>
                </h5>
                <h5 class="page-title">
                    <small><b>Auction status:  </b><span style="color: #d64635"><b>Final closed on the platform</b> <i class="fa fa-power-off"></i></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                <!-- Begin invoice summary information -->
                <div class="clearfix">
                     <div class="if-panel-head if-panel-blue">Financing information</div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Invoice sticker ID</a></div>
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Invoice amount</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <div class="input-group">
                                ...
                                <!-- Row 2 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Invoice serial number</a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtserialnumber" value="1234556">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">VAT invoice number</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDetorID" value="121221121">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Invoice object</a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtSellerID" value="1234556">
                                </div>
                                <!-- Row 3 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Invoice issuance date</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtObject" value="12/14/2015">
                                </div>                               
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Contract due date</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtVATNo" value="12/13/2014">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Released date</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtReleasedDate" value="12/23/2014">
                                </div>
                               
                                <!-- Row 4 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Auction close date</a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtAuctionclosedate" value="12/14/2015">
                                </div>
                               
                            
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Auction duration</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtAuctionduration" value="10 days">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Disbursement date</a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDelistingDate" value="12/14/2013">
                                </div>
                                <!-- Row 5 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Expected settlement date</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtIssuanceDate" value="01/12/2015">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Settlement date</a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtSettlementDate" value="12/14/2013">
                                </div>

                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Remaining term on disbursement</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtTMT" value="80 days">
                                </div>
                                <!-- Row 6 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Number of overdue days</a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txt overduedays" value="&gt;30 days">
                                </div>
                              
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Settled amount</a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtSettledamount" value="5,000,000">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Net outstanding amount</a></div>
                                <div class="col-sm-2 col-xs-12">
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="seller_profile.html">&gt;&gt;&gt; View more&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Seller ID</a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtAdvance" value="123232">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Company industry</a></div>
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="b_debtor_profile.html">&gt;&gt;&gt; View more&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Debtor name</a></div>
                                <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Company registration number</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtInterest" value="818181881"></span>
                                </div>
                                <!-- Row 2 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Tax code</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue">
                        Ready-to-sell information
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Advance (%)</a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtAdvance" value="90%">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Interest (%)</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="b_history_dealed_auction.html">&gt;&gt;&gt; View bidding history&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Number of bids</a></div>
                                <div class="col-sm-2 col-xs-12 ">
