...
<!--<![endif]-->
  ...
  <body style="margin: 0; padding: 0;background:#515151">
      ...
      <div class="msg-container" id="msg-container">
        <div class="msg-main-container">
          <div class="msg-main-div"> 
            ...
            <c:if test="${succeed}">
            <fmt:message key='seller.register.message.congratulation' />
            </c:if>
            <c:if test="${not succeed}">
            <fmt:message key='seller.register.message.sorry' />
            </c:if>
            </div>
	...
	$(function() {
		...
		var msgTpl = '<fmt:message key="seller.register.message.redirectMsg"/>';
