...
<c:set target="${self.js}" property="main">
    ...
    <script type="text/javascript" src="${base}/static/themes/default/js/seller/my-invoices/after-auction-list.js"></script>
                    ...
                    <div class="col-sm-12">
                      <table class="table table-bordered">
                        ...
                        <c:if test="${not empty page.content}">
                          ...
                          <tr>
                            <td>
                              <a href="${base}/seller/invoice/after-auction/detail/${item.id }" class="btn btn-default" target="main-iframe">Detail</a>
                            </td>
