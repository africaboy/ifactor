            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"> <fmt:message key='buyer.mybid.detail.dealed.page.header.dealedAuction' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                ...
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.history.delisted.both.page.auctionStatus' />:  </b><span style="color: #d64635"><b><fmt:message key='s.history.dealed.invoice.page.breadcrumb5' /></b> <i class="icon-lock"></i>&nbsp;&nbsp;<fmt:message key='buyer.mybid.dealed.page.statusExplain' />.</span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                    ...
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtAuctionduration" value=" &nbsp;<fmt:message key='b.make.new.offer.page.tab1.days' />">
                                </div>
                            </div>
                        </div>
                    </div>
