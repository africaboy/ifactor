    ...
    <div class="container" style="width:1200px;padding:0;margin-top:0;">
      ...
      <div class="registration-container" id="registration-container">
        <div class="form-div" id="reg-form-div">
          <form class="form-horizontal"  action="${base}/seller/register" id="form-main-info"  method="post" role="form"> 
            <div class="panel panel-default">
              <div class="panel-heading"><fmt:message key="seller.register.panel.head"/></div>
              <div class="panel-body">
  		
  		      <div class="reg-form-column"> 		    
  		         <div class="form-group">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.title"/>: *</label></div>
  		         ...
  		         <div class="form-group">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.firstName"/>: *</label></div>
  		           <div class="reg-form-control">
  		             <input type="text" class="form-control" id="firstName" name="firstName"  maxlength="50" placeholder="<fmt:message key='seller.register.form.field.firstName.placeholder'/>" data-rule-required="true" data-msg-required="<fmt:message key='seller.register.form.field.firstName.required'/>">
  		           </div>
  		         </div>
  		    
  		         <div class="form-group">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.lastName"/>: *</label></div>
  		           <div class="reg-form-control">
  		             <input type="text" class="form-control" id="lastName" name="lastName"   maxlength="50"  placeholder="<fmt:message key='seller.register.form.field.lastName.placeholder'/>" data-rule-required="true"  data-msg-required="<fmt:message key='seller.register.form.field.lastName.required'/>">
  		           </div>
  		         </div>	
  		    		      
  		         <div class="form-group">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.workPhone"/>: *</label></div>
  		           <div class="reg-form-control">
  		             <input type="text" style="width:25%" id="workCountryCode" name="workCountryCode" value="+84"   data-rule-pattern="^\+?[0-9]{2,4}$"   data-msg-pattern="<fmt:message key='seller.register.form.field.workCountryCode.pattern'/>">
  		             <input type="tel"  style="width:73%" id="workPhone" name="workPhone"  placeholder="<fmt:message key='seller.register.form.field.workPhone.placeholder'/>" data-rule-required="true"  data-msg-required="<fmt:message key='seller.register.form.field.workPhone.required'/>"  data-rule-pattern="^[0-9]{5,15}$" data-msg-pattern="<fmt:message key='seller.register.form.field.workPhone.pattern'/>">
  		         ...
  		         <div class="form-group">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.mobilePhone"/>: *</label></div>
  		           <div class="reg-form-control">
  		             <input type="text"  style="width:25%"  id="mobileCountryCode" name="mobileCountryCode" value="+84"  data-rule-pattern="^\+?[0-9]{2,4}$" data-msg-pattern="<fmt:message key='seller.register.form.field.mobileCountryCode.pattern'/>">
  		         ...
  		         <div class="form-group">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.position"/>: *</label></div>
  		           <div class="reg-form-control">
  		             <!-- <input type="text" class="form-control" id="position" name="position"  placeholder="position" data-rule-required="true"  data-msg-required="Please enter position" > -->
  		             <input type="text" class="form-control"  id="position" name="position"  maxlength="255"  data-rule-required="true" data-msg-required="<fmt:message key='seller.register.form.field.position.required'/>">
  		           </div>
  		         </div>
  	    	   ...
  	    	   <div class="reg-form-column">
  		         <div class="form-group">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.email"/>: *</label></div>
  		             <div class="reg-form-control">
  		             <input type="email" class="form-control" id="email" name="email"  maxlength="255"  placeholder="<fmt:message key='seller.register.form.field.email.placeholder'/>" data-rule-required="true"  data-rule-email="true"  data-msg-required="<fmt:message key='seller.register.form.field.email.required'/>">
  		           </div>
  		         </div>
  		      
  		         <div class="form-group">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.confirmEmail"/>: *</label></div>
  		           <div class="reg-form-control">
  		             <input type="email" class="form-control" id="confirmEmail" name="confirmEmail"   maxlength="255" placeholder="<fmt:message key='seller.register.form.field.confirmEmail.placeholder'/>" data-rule-required="true"  data-rule-email="true"  data-msg-required="<fmt:message key='seller.register.form.field.confirmEmail.required'/>" data-rule-equalTo="#email" data-msg-equalTo="<fmt:message key='seller.register.form.field.confirmEmail.equalTo'/>">
  		           </div>
  		         </div>
  		      
  		         <div class="form-group">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.password"/>: *</label></div>
  		           <div class="reg-form-control">
  		             <input type="password" class="form-control" id="password" name="password"   placeholder="<fmt:message key='seller.register.form.field.password.placeholder'/>"  data-rule-required="true"  data-msg-required="<fmt:message key='seller.register.form.field.password.required'/>" data-rule-pattern="^(?![0-9]+$)(?![a-zA-Z]+$)[0-9a-zA-Z!$#%@\-_.]{8,}$" data-msg-pattern="<fmt:message key='seller.register.form.field.password.pattern'/>">
  		           </div>
  		         </div>
  		     
  		         <div class="form-group">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.confirmPassword"/>: *</label></div>
  		           <div class="reg-form-control">
  		             <input type="password" class="form-control" id="confirmPassword" name="confirmPassword" placeholder=<fmt:message key='seller.register.form.field.confirmPassword.placeholder'/> data-rule-required="true"  data-msg-required="<fmt:message key='seller.register.form.field.confirmPassword.required'/>" data-rule-equalTo="#password" data-msg-equalTo="<fmt:message key='seller.register.form.field.confirmPassword.equalTo'/>">
  		           </div>
  		         </div>
  		    
  		         <div class="form-group">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.fromChannels"/>: *</label></div>
  		           <div class="reg-form-control">
  		             <select  id="fromChannels" name="fromChannels" data-rule-required="true"   data-msg-required="<fmt:message key='seller.register.form.field.fromChannels.required'/>">
  		               <option value="">Please select...</option>
  		         ...
  		         <div id="otherFromChannelsDiv" class="form-group"  style="display:none;">
  		           <div class="reg-form-label"><label><fmt:message key="seller.register.form.field.otherFromChannels"/>: *</label></div>
  		           <div class="reg-form-control">
  		             <input type="text" class="form-control" id="otherFromChannels" name="otherFromChannels"  maxlength="255"  data-rule-required="true"  data-msg-required="<fmt:message key='seller.register.form.field.otherFromChannels.required'/>">
  		           </div>
  		         </div>
