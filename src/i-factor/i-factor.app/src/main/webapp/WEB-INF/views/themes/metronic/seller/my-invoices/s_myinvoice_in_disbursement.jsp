...
<body class="page-header-fixed page-quick-sidebar-over-content">
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
          <form class="form-inline" action="${base}/seller/invoice/disbursed"  id="formQuery" name="formQuery"  method="post" role="form">
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"><fmt:message key='seller.myinvoice.disbursement.page.header.invoices' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='seller.myinvoice.disbursement.page.title' />&nbsp;&nbsp;&nbsp;<span id="invoiceNum"></span></b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.market.list.page.auctionStatus' />:&nbsp;<span style="color:#ff0000"><fmt:message key='seller.myinvoice.disbursement.page.status' />&nbsp;<i class="icon-lock"></i></span></b></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                <div class="clearfix">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-6 text-right"><a href="#" id="toggle_link" class="if_toggle if_show" onclick="toggle('More&nbsp;&nbsp;', 'Less&nbsp;&nbsp;','col-sm-offset-5 col-sm-1 col-xs-12 text-right','col-sm-offset-11 col-sm-1 col-xs-12 text-right');"><fmt:message key='invoice.list.tbody.queryForm.button.more' />&nbsp;&nbsp;<i class="icon-arrow-down"></i></a></div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='seller.myinvoice.disbursement.page.panel.body.disbursementDate' /></a></div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                   <input type="text" class="form-control if-input-sm if-div-input-sm date-picker" id="disbursementDateFrom" name="disbursementDateFrom"  value="From date" readonly=""/>
                                </div><div class="col-sm-2 col-xs-12 if_filter_hidden">
                                   <input type="text" class="form-control if-input-sm if-div-input-sm date-picker" id="disbursementDateTo" name="disbursementDateTo" value="To date" readonly=""/>
                                </div>
                                <!-- End Disbursement date -->
                                <!-- Begin Expected settlement date-->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='seller.myinvoice.disbursement.page.panel.body.expected' /></a></div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:100px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Net advance amount received" style="color:white"><fmt:message key='seller.myinvoice.disbursement.page.naar' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='seller.myinvoice.dealed.page.table.th.expectedSettlement' />    
                                            </th>
                                            <th style="width:100px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Expected receivable amount after settlement" style="color:white"><fmt:message key='seller.myinvoice.dealed.page.table.th.eraas' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
				                        ...
				                        <tr>
				                          ...
				                          <td>
				                            <a href="javascript:;" target="main-iframe">
				                          	  <button type="button" class="btn-small btn-info btn-circle" onclick="window.open('${base}/seller/invoice/indisbursement/biddhistory/${item.id}');"><i class="fa fa-list"></i></button>
				                            </a>
				                          </td>
				                          <td><fmt:formatDate value='${item.finInvIssDate}' pattern='MM/dd/yyyy'/></td>
				                          <td>
                                            <a href="${base}/seller/invoice/indisbursement/detail/${item.id}">
	 	                          	          ${item.finStickerId}
		                           	        </a> 				                          
				                          </td>
				                          ...
				                          <c:set var="saccanoffrtsienaatbr" value="${item.finInvAmount*item.bestBuyerAdv/100-saccanoffrtsienaatbrtf}" />
				                          <td><fmt:formatNumber  value="${saccanoffrtsienaatbr}" type="number" />&nbsp;VND</td>
				                          ...
				                          <c:set var="saccanoffrtsieraas" value="${item.finInvAmount-item.finInvAmount*item.bestBuyerAdv/100-saccanoffrtsieraasif}" />
				                          <td><fmt:formatNumber  value="${saccanoffrtsieraas}" type="number" />&nbsp;VND</td>
				                        </tr>
				                       </c:forEach>
				                       </c:if>
                                    </tbody>
