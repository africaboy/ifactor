            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <a href="#"><fmt:message key='s.history.indisbursement.invoice.page.breadcrumb' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <a href="#"><fmt:message key='s.history.indisbursement.invoice.page.breadcrumb1' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <a href="#"><fmt:message key='s.history.indisbursement.invoice.page.breadcrumb2' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='s.history.indisbursement.invoice.page.breadcrumb3' /></b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='s.history.indisbursement.invoice.page.breadcrumb4' />  <span style="color: #d64635"><fmt:message key='s.history.indisbursement.invoice.page.breadcrumb5' /> <i class="icon-lock"></i></span></b></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-light-grey">
                        <fmt:message key='s.history.indisbursement.invoice.invoice.summary' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.indisbursement.invoice.invoice.summary1' /></a></div>
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.indisbursement.invoice.invoice.summary2' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <div class="input-group">
                                ...
                                <!-- Row 2 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.indisbursement.invoice.invoice.summary3' /></a></div>
                                <div class="col-sm-6 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDetorID" value="${invoice.debtorName}">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.indisbursement.invoice.invoice.summary4' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtObject" value="${invoice.finObjOfInv}">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.indisbursement.invoice.invoice.summary5' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                ...
                                <!-- Row 3 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.indisbursement.invoice.invoice.summary6' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.indisbursement.invoice.invoice.summary7' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDueDate" value="10 days">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.indisbursement.invoice.invoice.summary8' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                ...
                <!-- End Accepted offer -->
                <h5 class="page-title">
                  <small><b> <fmt:message key='s.history.indisbursement.invoice.bidding.history' /></b></small>
                </h5>
                <div class="row">
                  <div class="col-md-12">
                    <div class="portlet box">
                      <div class="">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="content_table">
                          ...
                          <tr>
                            <th style="width:20px">
                              <fmt:message key='s.history.indisbursement.invoice.bidding.history1' />
                            </th>
                            <th>
                              <fmt:message key='s.history.indisbursement.invoice.bidding.history2' />
                            </th>
                            <th style="width:120px">
                              <fmt:message key='s.history.indisbursement.invoice.bidding.history3' />
                            </th>
                            <th style="width:120px">
                              <fmt:message key='s.history.indisbursement.invoice.bidding.history4' />
                            </th>
                            <th>
                              <fmt:message key='s.history.indisbursement.invoice.bidding.history5' />
                            </th>
                            <th>
                              <fmt:message key='s.history.indisbursement.invoice.bidding.history6' />
                            </th>
                          </tr>
                          </thead>
                          <tbody>
