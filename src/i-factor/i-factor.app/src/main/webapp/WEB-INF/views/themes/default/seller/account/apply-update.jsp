                                                   ...
                                                   <form action="#" class="form-horizontal" id="form-modification-request" method="POST" enctype="multipart/form-data"> 
                                                    <div class="form-group if-form-group-sm">
                                                      ...
                                                      <ol>
                                                        ...
                                                        <li>
                                                          Choose a valid file of Company license
                                                        </li>
                                                      </ol>
                                                    </div>
                                                  </form>
                                                  ...
                                                  <form action="#" class="form-horizontal" id="form-personal-info" method="POST" enctype="multipart/form-data"> 
                                                    <div class="form-group if-form-group-sm">
                                                     ...
                                                     <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md"  id="title" name="title" value="${sellerApply.title}"  readonly
                                                            <c:if test="${not fn:contains(modifyFields,'title') && isModifyStatus}">readonly</c:if> />
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" id="firstName" name="firstName" value="${sellerApply.firstName}"  readonly
                                                            <c:if test="${not fn:contains(modifyFields,'firstName') && isModifyStatus}">readonly</c:if> />
                                                        </div>
                                                        <div class="col-md-offset-1"></div>
                                                    </div>
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md"  id="lastName" name="lastName" value="${sellerApply.lastName}" readonly
                                                            <c:if test="${not fn:contains(modifyFields,'lastName') && isModifyStatus}">readonly</c:if> />
                                                        </div>
                                                        <div class="control-label col-md-2 col-md-offset-1 if-control-label-md">
                                                            <fmt:message key='seller.register.form.field.email'/><span class="required">*</span>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control if-input-sm if-div-input-md" id="email" name="email" value="${sellerApply.email}"  readonly
                                                        ...
                                                        <div class="col-md-3 if-input-md">
                                                            <c:choose>
															  <c:when test="${not fn:contains(modifyFields,'dob') && isModifyStatus}">
																<input type="text" class="form-control if-input-sm if-div-input-md date-picker" id="dobRead" name="dobRead"     value="<fmt:formatDate value='${sellerApply.dob}' pattern='MM/dd/yyyy'/>"   readonly>
															  </c:when>
															  <c:otherwise>
                                                        ...
                                                        <div class="col-md-3 if-input-md">
                                                          <c:choose>
															<c:when test="${not fn:contains(modifyFields,'comEstablishmentDate') && isModifyStatus}">
																<input type="text" class="form-control if-input-sm if-div-input-md date-picker" id="comEstablishmentDateRead" name="comEstablishmentDateRead"     value="<fmt:formatDate value='${sellerApply.comEstablishmentDate}' pattern='MM/dd/yyyy'/>"   readonly>
															</c:when>
															<c:otherwise>
                                                  ...
                                                  <form class="form-horizontal" id="form-further-details" method="POST" enctype="multipart/form-data">  
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
								                          ...
								                          <input type="text" class="form-control" id="debtorA1Name" name="debtorA1Name" value="${sellerApply.debtorA1Name}" data-rule-required="false" data-msg-required="<fmt:message key='seller.apply.form.field.mainDebtor.required'/>"  <c:if test="${not fn:contains(modifyFields,'debtorA1Name') && isModifyStatus}">readonly</c:if>/>
								                          <input type="hidden" id="debtorA2Id" name="debtorA2Id" value="${sellerApply.debtorA2Id}" />
								                          <input type="text" class="form-control" id="debtorA2Name" name="debtorA2Name" value="${sellerApply.debtorA2Name}" data-rule-required="false" data-msg-required="<fmt:message key='seller.apply.form.field.mainDebtor.required'/>"  <c:if test="${not fn:contains(modifyFields,'debtorA2Name') && isModifyStatus}">readonly</c:if>/>
								                          <input type="hidden" id="debtorA3Id" name="debtorA3Id" value="${sellerApply.debtorA3Id}" />
								                          <input type="text" class="form-control" id="debtorA3Name" name="debtorA3Name" value="${sellerApply.debtorA3Name}" data-rule-required="false" data-msg-required="<fmt:message key='seller.apply.form.field.mainDebtor.required'/>"  <c:if test="${not fn:contains(modifyFields,'debtorA3Name') && isModifyStatus}">readonly</c:if>/>
								                          <input type="hidden" id="debtorA4Id" name="debtorA4Id" value="${sellerApply.debtorA4Id}" />
								                          <input type="text" class="form-control" id="debtorA4Name" name="debtorA4Name" value="${sellerApply.debtorA4Name}" data-rule-required="false" data-msg-required="<fmt:message key='seller.apply.form.field.mainDebtor.required'/>"  <c:if test="${not fn:contains(modifyFields,'debtorA4Name') && isModifyStatus}">readonly</c:if>/>
								                          <input type="hidden" id="debtorA5Id" name="debtorA5Id" value="${sellerApply.debtorA5Id}" />
								                          <input type="text" class="form-control" id="debtorA5Name" name="debtorA5Name" value="${sellerApply.debtorA5Name}" data-rule-required="false" data-msg-required="<fmt:message key='seller.apply.form.field.mainDebtor.required'/>"  <c:if test="${not fn:contains(modifyFields,'debtorA5Name') && isModifyStatus}">readonly</c:if>/>
                                                    ...
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control"  id="esignatureSN" name="esignatureSN"    maxlength="255"  value="${sellerApply.esignatureSN}"  <c:if test="${not fn:contains(modifyFields,'esignatureSN') && isModifyStatus}">readonly</c:if>/>
                                                        </div>
                                                    </div>
                                                   </form>
                                                </div>
                                                ...
                                                <div class="tab-pane" id="tab-documents">
                                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                      ...
                                                      <%--  <div class="col-sm-3" id="div-IdentificationFile">
							                           <span>
							                             <input type="file"  class="if-input-sm if-div-input-md" id="identificationFile" name="file">
							                             <input type="hidden" id="file-type-identificationFile" name="fileType" value="${self.docBiztypePrefix}idcard_authorizedPerson" />
							                           </span>
							                          <!-- 进度条 -->
							                           <div id="progress-identificationFile" class="progress progress-success progress-striped">
							                           <div class="bar"></div>
							                           </div>
							                          <!-- 已经上传的文件 -->
							                          <div id="file-link-identificationFile"></div>
							                          <div id="error-identificationFileId"></div>
							                         </div> --%>
							                         ...
							                         <div class="col-sm-3" id="div-IdentificationFile">
								                        <c:if test="${fn:contains(modifyFields,'idcard_authorizedPerson') || not isModifyStatus}">
								                          <span class="btn btn-success fileinput-button">
								                            ...
								                            <span><fmt:message key='seller.apply.form.button.addFile'/></span>                            
								                            <input type="file" id="identificationFile" name="file" multiple>
								                            <input type="hidden" id="file-type-identificationFile" name="fileType" value="${self.docBiztypePrefix}idcard_authorizedPerson" />
								                          </span>
								                          <!-- 进度条 -->
								                          <div id="progress-identificationFile" class="progress progress-success progress-striped">
                                                          ...
                                                          <div class="col-sm-3" id="div-signedFile">   
									                        <c:if test="${fn:contains(modifyFields,'idcard_authorizedRep') || not isModifyStatus}">
									                          <span class="btn btn-success fileinput-button">
									                            <i class="icon-plus icon-white"></i>
									                            <span><fmt:message key='seller.apply.form.button.addFile'/></span>                            
									                            <input type="file" id="signedFile" name="file" multiple>
									                            <input type="hidden" id="file-type-signedFile" name="fileType" value="${self.docBiztypePrefix}idcard_authorizedRep" />
									                          </span>
									                          <!-- 进度条 -->
									                          <div id="progress-signedFile" class="progress progress-success progress-striped">
									                            <div class="bar"></div>
									                          </div>
									                          </c:if>
									                          <!-- 已经上传的文件 -->
								                        ...
								                        <div class="col-sm-3">   
								                         <c:if test="${fn:contains(modifyFields,'license_companyLicense') || not isModifyStatus}">    
								                          <span class="btn btn-success fileinput-button">
								                            <i class="icon-plus icon-white"></i>
								                            <span><fmt:message key='seller.apply.form.button.addFile'/></span>                            
								                            <input type="file" id="licenseFile" name="file" multiple>
								                            <input type="hidden" id="file-type-licenseFile" name="fileType" value="${self.docBiztypePrefix}license_companyLicense" />
								                          </span>
								                          <!-- 进度条 -->
								                          <div id="progress-licenseFile" class="progress progress-success progress-striped">
								                            <div class="bar"></div>
								                          </div>
								                          </c:if>
								                          <!-- 已经上传的文件 -->
								                          ...
								                          <div id="error-licenseFileId"></div>
								                        </div>
                                                    </div>
                                                  </form> 
                                                    ...
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-sm-3">
								                         <c:if test="${fn:contains(modifyFields,'taxcode_companyTaxCode') || not isModifyStatus}"> 
								                          ...
								                          <!-- 进度条 -->
								                          <div id="progress-taxCodeFile" class="progress progress-success progress-striped">
								                            <div class="bar"></div>
								                          </div>
								                          </c:if>
								                          <!-- 已经上传的文件 -->
                                                       ...
                                                       <div class="col-sm-3"> 
								                        <c:if test="${fn:contains(modifyFields,'fs_fsLastFiscalYear') || not isModifyStatus}">
								                          <span class="btn btn-success fileinput-button">
								                            <i class="icon-plus icon-white"></i>
								                            <span><fmt:message key='seller.apply.form.button.addFile'/></span>                            
								                            <input type="file" id="fsFileLastYear" name="file" multiple>
								                            <input type="hidden" id="file-type-fsFileLastYear" name="fileType" value="${self.docBiztypePrefix}fs_fsLastFiscalYear" />
								                          </span>
								                          <!-- 进度条 -->
								                          <div id="progress-fsFileLastYear" class="progress progress-success progress-striped">
								                            <div class="bar"></div>
								                          </div>
								                          </c:if>
								                          <!-- 已经上传的文件 -->
								                          ...
								                          <div id="error-fsFileLastYearId"></div>
								                        </div>
                                                    </div>
                                                  </form>  
                                                       ...
                                                       <div class="col-sm-3">
								                        <c:if test="${fn:contains(modifyFields,'fs_fsLast2FiscalYear') || not isModifyStatus}">
								                          <span class="btn btn-success fileinput-button">
								                            <i class="icon-plus icon-white"></i>
								                            <span><fmt:message key='seller.apply.form.button.addFile'/></span>                            
								                            <input type="file" id="fsFileLast2Year" name="file" multiple>
								                            <input type="hidden" id="file-type-fsFileLast2Year" name="fileType" value="${self.docBiztypePrefix}fs_fsLast2FiscalYear" />
								                          </span>
								                          <!-- 进度条 -->
								                          <div id="progress-fsFileLast2Year" class="progress progress-success progress-striped">
								                            <div class="bar"></div>
								                          </div>
								                          </c:if>
								                          <!-- 已经上传的文件 -->
								                          ...
								                          <div id="error-fsFileLast2YearId"></div>
								                        </div>
	                                                    </form>
								                       ...
								                       <div class="col-sm-3">
								                        <c:if test="${fn:contains(modifyFields,'invoice_firstPaidInvoice') || not isModifyStatus}">
								                          <span class="btn btn-success fileinput-button">
								                            <i class="icon-plus icon-white"></i>
								                            <span><fmt:message key='seller.apply.form.button.addFile'/></span>                            
								                            <input type="file" id="invoiceFile1" name="file" multiple>
								                            <input type="hidden" id="file-type-invoiceFile1" name="fileType" value="${self.docBiztypePrefix}invoice_firstPaidInvoice" />
								                          </span>
								                          <!-- 进度条 -->
								                          <div id="progress-invoiceFile1" class="progress progress-success progress-striped">
								                            <div class="bar"></div>
								                          </div>
								                          </c:if>
								                          <!-- 已经上传的文件 -->
								                          ...
								                          <div id="error-invoiceFile1Id"></div>
								                        </div>
                                                    </div>
                                                   </form> 
                                                    ...
                                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data">  
                                                      <div class="form-group if-form-group-sm">
                                                        <div class="control-label col-md-offset-3 col-md-3">
                                                          &nbsp;&nbsp;
                                                        </div>
                                                        <div class="col-sm-3">
								                        <c:if test="${fn:contains(modifyFields,'invoice_secondPaidInvoice') || not isModifyStatus}">
								                          <span class="btn btn-success fileinput-button">
								                            <i class="icon-plus icon-white"></i>
								                            <span><fmt:message key='seller.apply.form.button.addFile'/></span>                            
								                            <input type="file" id="invoiceFile2" name="file" multiple>
								                            <input type="hidden" id="file-type-invoiceFile2" name="fileType" value="${self.docBiztypePrefix}invoice_secondPaidInvoice" />
								                          </span>
								                          <!-- 进度条 -->
								                          <div id="progress-invoiceFile2" class="progress progress-success progress-striped">
								                            <div class="bar"></div>
								                          </div>
								                          </c:if>
								                          <!-- 已经上传的文件 -->
								                          ...
								                          <div id="error-invoiceFile2Id"></div>
								                        </div>
                                                    </div>
                                                   </form> 
                                                      ...
                                                      <div class="form-group if-form-group-sm">
								                        ...
								                        <c:if test="${fn:contains(modifyFields,'invoice_thirdPaidInvoice') || not isModifyStatus}">
								                          <span class="btn btn-success fileinput-button">
								                            <i class="icon-plus icon-white"></i>
								                            <span><fmt:message key='seller.apply.form.button.addFile'/></span>                            
								                            <input type="file" id="invoiceFile3" name="file" multiple>
								                            <input type="hidden" id="file-type-invoiceFile3" name="fileType" value="${self.docBiztypePrefix}invoice_thirdPaidInvoice" />
								                          </span>
								                          <!-- 进度条 -->
								                          <div id="progress-invoiceFile3" class="progress progress-success progress-striped">
								                            <div class="bar"></div>
								                          </div>
								                          </c:if>
								                          <!-- 已经上传的文件 -->
								                          <div id="file-link-invoiceFile3">
								                            ${self.doc9Link}
								                          </div>
								                          <div id="error-invoiceFile3Id"></div>
								                        </div>
                                                      </div>
                                                    </form>
