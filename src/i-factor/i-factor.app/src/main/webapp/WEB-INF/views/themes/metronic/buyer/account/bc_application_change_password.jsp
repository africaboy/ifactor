        ...
        <li class="dropdown dropdown-user">
            <a href="#" class="dropdown-toggle if-dropdown-user" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                ...
                <span class="username username-hide-on-mobile">
                    <fmt:message key='bc.application.changepassword.username.hide.mobile' />
                </span>
                <i class="fa fa-angle-down"></i>
            </a>
            <ul class="dropdown-menu">
    ...
    <div class="page-content">
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li>
            <a href="#"><fmt:message key='bc.application.changepassword.content.wrapper' /></a>
      ...
      <div style="margin-top: 50px">
        <div class="form-group if-form-group-sm">
          <div class="control-label col-md-2 col-md-offset-4 if-control-label-md">
            <fmt:message key='bc.application.changepassword.content.wrapper2' /> <span class="required">*</span>
          </div>
          <div class="col-md-2">
        ...
        <div class="form-group if-form-group-sm">
          <div class="control-label col-md-2 col-md-offset-4 if-control-label-md">
            <fmt:message key='bc.application.changepassword.content.wrapper3' /> <span class="required">*</span>
          </div>
          <div class="col-md-2">
        ...
        <div class="form-group if-form-group-sm">
          <div class="control-label col-md-2 col-md-offset-4 if-control-label-md">
            <fmt:message key='bc.application.changepassword.content.wrapper4' /> <span class="required">*</span>
          </div>
          <div class="col-md-2">
            <input type="password" class="form-control if-input-sm if-div-input-md" id="confirmpwd" name="confirmpwd" data-rule-required="true"  data-msg-required="<fmt:message key='buyer.password.form.confirmpwd.required'/>" data-rule-equalTo="#newpwd" data-msg-equalTo="<fmt:message key='buyer.password.form.confirmpwd.equalTo'/>"/>
          </div>
          <div class="col-md-offset-4"></div>
        </div>
      </div>
      <div style="margin-top: 5px">
        <div class="col-md-offset-6 col-md-6">
          <a href="javascript:;" class="btn if-btn" style="padding: 0.5px 2.5px 2px 2.5px;">
            <button id="submitApplication" type="button" style="border: none;background: none;"><fmt:message key='bc.application.changepassword.content.wrapper5' /></button>
          </a>
        </div>
      </div>
      </form>
...
<script src="${base}/static/themes/metronic/js/buyer/account/change-password.js"></script>
