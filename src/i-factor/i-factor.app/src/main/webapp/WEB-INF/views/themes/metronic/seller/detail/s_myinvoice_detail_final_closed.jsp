            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended last">
                        <a href="${base}/seller/invoice/finalclosed" class="dropdown-toggle if-logout">
            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <a href="#"><fmt:message key='s.myinvoice.detail.final.closed.page.breadcrumb' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <a href="#"><fmt:message key='s.myinvoice.detail.final.closed.page.breadcrumb1' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <a href="#"><fmt:message key='s.myinvoice.detail.final.closed.page.breadcrumb2' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='s.myinvoice.detail.final.closed.page.breadcrumb3' /></b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='s.myinvoice.detail.final.closed.page.breadcrumb4' />  </b><span style="color: #d64635"><b><fmt:message key='s.myinvoice.detail.final.closed.page.breadcrumb5' /></b>&nbsp;<i class="fa fa-power-off"></i></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                <!-- Begin Financing information -->
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue"><fmt:message key='s.myinvoice.detail.final.closed.financing.information' /></div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information1' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <span class="if-icon-addon"><a href="javascript:;"><i class="fa fa-power-off" style="color: #d64635;"></i></a></span>
                                    </div>
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information2' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <div class="input-group">
                                ...
                                <!-- Row 2 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information3' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information4' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDetorID" value="${invoice.finVatInvNo}">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information5' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtSellerID" value="${invoice.finObjOfInv}">
                                </div>
                                <!-- Row 3 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information6' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information7' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information8' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <!-- Row 4 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information9' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtAuctionclosedate" value="<fmt:formatDate value='${invoice.endDate}' pattern='MM/dd/yyyy'/>">
                                </div>


                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information10' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtAuctionduration" value="${invoice.finRmngMatTerm}&nbsp;<fmt:message key='b.make.new.offer.page.tab1.days' />">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information11' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDelistingDate" value="<fmt:formatDate value='${invoice.finExpPmtDate}' pattern='MM/dd/yyyy'/>">
                                </div>
                                <!-- Row 5 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information12' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information13' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtSettlementDate" value="<fmt:formatDate value='${invoice.endDate}' pattern='MM/dd/yyyy'/>">
                                </div>

                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information14' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <!-- Row 6 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information15' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txt overduedays" value="${invoice.finRmngMatTerm}&nbsp;<fmt:message key='b.make.new.offer.page.tab1.days' />">
                                </div>

                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information16' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtSettledamount" value="<fmt:formatNumber  value='${invoice.finInvAmount}' type='number' />&nbsp;VND">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.financing.information17' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtoutstandingamount" value="<fmt:formatNumber  value='${invoice.finInvAmount}' type='number' />&nbsp;VND">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue">
                        <fmt:message key='s.myinvoice.detail.final.closed.seller.information' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.seller.information1' /></a></div>
                            ...
                            <div class="row">
                                <!-- Row 2 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.seller.information2' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue">
                        <fmt:message key='s.myinvoice.detail.final.closed.debtor.information' />
                    </div>
                    <span class="if-panel-next_to"> <a href="${base}/seller/profile/debtor">&gt;&gt;&gt; <fmt:message key='s.myinvoice.detail.final.closed.debtor.information1' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.debtor.information2' /></a></div>
                                <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.debtor.information3' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtInterest" value="${invoice.debtorBizRegNo}"></span>
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.debtor.information4' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-yellow-grey">
                       <fmt:message key='s.myinvoice.detail.final.closed.accepted.offer' />
                    </div>
                    <span class="if-panel-next_to"> <a href="${base}/seller/invoice/finalclosed/biddhistory">&gt;&gt;&gt; <fmt:message key='s.myinvoice.detail.final.closed.accepted.offer1' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.accepted.offer2' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtAdvance" value="${invoice.bestBuyerAdv}%">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.accepted.offer3' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtInterest" value="${invoice.bestBuyerInt}%">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.detail.final.closed.accepted.offer4' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                ...
                <div class="clearfix">
                    <div class="if-panel-head if-panel-blue">
                        <fmt:message key='s.myinvoice.detail.final.closed.documentation' />
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='invoice.submit.form.field.docScanOfInv' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='invoice.submit.form.field.docScanOfCont' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='invoice.submit.form.field.docDlvryCnfm' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                            ...
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='seller.myinvoice.detail.delisted.both.page.panel.body.debtorAcknowledgement' /></a></div>
                                <div class="col-sm-2 col-xs-12">
