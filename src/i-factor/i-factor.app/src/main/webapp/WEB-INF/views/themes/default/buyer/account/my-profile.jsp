...
<c:set target="${self.content}" property="main">
                <div class="tab-header clearfix">
                  <div class="tab-header-title">
                    <i></i> 
                    <span><fmt:message key="buyer.profile.viewPage.title"/></span>
                  </div>
                </div>
			    ...
			    <div id="form-content">
			      <form class="form-horizontal">
		            ...
		            <div class="form-group">
		              <label class="col-sm-4 control-label" for="first_name"><fmt:message key="buyer.register.form.field.firstName"/></label>
		              <div class="col-sm-6">
		            ...
		            <div class="form-group">
		              <label class="col-sm-4 control-label" for="last_name"><fmt:message key="buyer.register.form.field.lastName"/></label>
		              <div class="col-sm-6">
