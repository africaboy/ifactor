    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content if-detail-auction-content">
                ...
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.history.delisted.both.page.auctionStatus' />:  <span style="color: #d64635"><fmt:message key='seller.history.delisted.both.page.closed' />  <i class="icon-lock"></i></span></b><span style="padding-left: 20px; font-weight: bold"><fmt:message key='seller.history.delisted.both.page.reason' /></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
