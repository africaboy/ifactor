...
<body class="page-header-fixed page-quick-sidebar-over-content">
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
          <form class="form-inline" action="${base}/buyer/bid/insettlement"  id="formQuery" name="formQuery"  method="post" role="form">
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <a href="#"><fmt:message key='b.mybid.invoice.insettle.page.breadcrumb' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <a href="#"> <fmt:message key='b.mybid.invoice.insettle.page.breadcrumb1' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='b.mybid.invoice.insettle.page.breadcrumb2' />&nbsp;&nbsp;&nbsp;<span id="invoiceNum"></span></b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='b.mybid.invoice.insettle.page.breadcrumb4' />:&nbsp;</b><span style="color: #d64635"><b><fmt:message key='b.mybid.invoice.insettle.page.breadcrumb5' /></b>&nbsp;<i class="icon-lock"></i></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                <div class="clearfix">
                    <div class="panel panel-success">
                        <div class="panel-heading" style="padding: 5px 5px;">
                            <h3 class="if-panel-title bold"><fmt:message key='b.mybid.invoice.insettle.panel.success' /></h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-6 col-xs-6 text-left bold"><fmt:message key='b.mybid.invoice.insettle.panel.success1' /></div>
                                <div class="col-sm-6 col-xs-6 text-right"><a href="#" id="toggle_link" class="if_toggle if_show" onclick="toggle('More&nbsp;&nbsp;', 'Less&nbsp;&nbsp;','col-sm-offset-3 col-sm-1 col-xs-12 text-right','col-sm-offset-11 col-sm-1 col-xs-12 text-right');"><fmt:message key='b.mybid.invoice.insettle.panel.success2' />&nbsp;&nbsp;<i class="icon-arrow-down"></i></a></div>
                            </div>
                            <div class="row">
                                
                                <!-- Begin Invoice Amount -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="#"><fmt:message key='b.mybid.invoice.insettle.panel.success3' /></a></div>
                                ...
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm"><a href="#"><fmt:message key='b.mybid.invoice.insettle.panel.success4' /> &nbsp;</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <div class="col-sm-12 col-xs-12 text-left bold"><fmt:message key='b.mybid.invoice.insettle.panel.success5' /></div>
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm"><fmt:message key='b.mybid.invoice.insettle.panel.success6' />:</div>
                                <!-- Begin Settled -->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm"><a href="#">Fully Settled &nbsp;<span><input type="checkbox" id="fullySettled" name="fullySettled" value="option1"></span></a></div>
                                <!-- End Settled -->
                                <!-- Begin Partially settled -->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm"><a href="#">Partially settled &nbsp;<span><input type="checkbox" id="partiallySettled" name="partiallySettled" value="option1"></span></a></div>
                                <!-- End Partially settled  -->
                                <!-- Begin Overdue-->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm"><a href="#">Overdue &nbsp;<span><input type="checkbox" id="overdue" name="overdue" value="option1"></span></a></div>
                                <!-- End Overdue -->
                                <div class="col-sm-12 col-xs-12 text-left bold if_filter_hidden"><fmt:message key='b.mybid.invoice.insettle.panel.success7' /></div>
                                <!-- Begin hidden fields -->
                                <!-- Begin  Settlement date  -->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"> <fmt:message key='b.mybid.invoice.insettle.panel.success8' /> </a></div>
                                ...
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='b.mybid.invoice.insettle.panel.success9' /></a></div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm date-picker" id="expectedSettlementDateFrom" name="expectedSettlementDateFrom" value="From date" readonly="" />
                                </div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm date-picker" id="expectedSettlementDateTo" name="expectedSettlementDateTo" value="To date" readonly="" />
                                </div>
                                <!-- End Expected settlement date -->
                                <!-- End hidden fields -->
                                <div class="col-sm-offset-3 col-sm-1 col-xs-12 text-right" id="ifFilterButton">
                                    <button class="btn if-btn" type="submit"><fmt:message key='b.mybid.invoice.insettle.panel.success10' /></button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="">
                                <table class="table table-striped table-bordered table-hover" id="content_table">
                                    <thead>
                                        <tr>
                                            <th style="width:20px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead' />
                                            </th>
                                            <th style="width:60px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead1' />
                                            </th>
                                            <th style="width:60px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead2' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead3' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead4' />
                                            </th>
                                            <th style="width:60px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead5' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead6' />
                                            </th>
                                            <th style="width:250px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead7' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead8' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead9' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead10' />
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead11' />
                                            </th>
                                            <th style="width:80px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Total amount to be received" style="color:white"><fmt:message key='b.mybid.invoice.insettle.table.thead12' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='b.mybid.invoice.insettle.table.thead13' />
                                            </th>
                                            <th style="width:120px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Net outstanding amount to be received" style="color:white"><fmt:message key='b.mybid.invoice.insettle.table.thead14' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
				                      ...
				                      <c:forEach var="item" items="${page.content}" varStatus="status">
				                        <tr>
                                            ...
                                            <td>
                                              <a class="dialogbuyersettlement" style="color:#000000" href="#" >
                                                <button type="button" class="btn-small btn-circle if-tooltip" style="background-color:#ffd800" onclick="window.location='#';">
                                            ...
                                            <td>
                                              <a href="javascript:;" target="main-iframe">
				                          	    <button type="button" class="btn-small btn-info btn-circle" onclick="window.open('${base}/buyer/auction/fullysettled/biddhistory/${item.id}');">
                                            ...
                                            <td>
                                              <a href="${base}/buyer/auction/overdue/detail/${item.invoice.id}">
                                            ...
                                            <td>
                                               <fmt:formatDate value='${item.invoice.finExpPmtDate}' pattern='MM/dd/yyyy'/>
                                            </td>
                                            <td>
                                                ${item.invoice.finRmngMatTerm}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a class="dialogbuyersettlementtotal" href="#">  </a>
                                            </td>
                                            <td>
