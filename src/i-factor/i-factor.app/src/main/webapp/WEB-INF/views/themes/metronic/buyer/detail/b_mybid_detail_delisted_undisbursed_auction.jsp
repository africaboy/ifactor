    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content if-detail-auction-content">
                ...
                <h5 class="page-title">
                    <small><b>Auction status:  </b><span style="color: #d64635"><b>CLOSED - Delisted</b> <i class="icon-lock"></i>&nbsp;&nbsp;Reason: Unsuccesful disbursement</span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                    ...
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <!-- Row 5 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Delisting date</a></div>
                                <div class="col-sm-2 col-xs-12">
