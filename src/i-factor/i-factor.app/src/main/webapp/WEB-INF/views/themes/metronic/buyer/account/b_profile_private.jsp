  ...
  <div class="panel panel-success">
    <div class="panel-body">
      <div class="row">
        ...
        <div class="col-sm-2 col-xs-12 ">
          <div class="input-group">
            <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtTitle" value="${buyerApply.title}">
          </div>
        </div>
        <!-- Row 2 -->
        ...
        <div class="col-sm-2 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtFirstName" value="${buyerApply.firstName}">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtLastName" value="${buyerApply.lastName}">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtGender" value="${buyerApply.gender}">
        </div>
        <!-- Row 3 -->
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtDOB" value="<fmt:formatDate value='${buyerApply.dob}' pattern='MM/dd/yyyy'/>">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtNationality" value="${buyerApply.nationality}">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtResidence" value="${buyerApply.residenceCountry}">
        </div>
        <!-- Row 4 -->
        ...
        <div class="col-sm-2 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtIDType" value="${buyerApply.idType}">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtIDNo" value="${buyerApply.idNumber}">
        </div>
        <div class="col-sm-4 col-xs-12 if-div-input-sm"></div>
        <!-- Row 5 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.profile.private.page.panel.adress' /></a></div>
        <div class="col-sm-6 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtReleaseDate" value="${buyerApply.residenceAddress}">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtPhoneNo" value="${buyerApply.phone}">
        </div>
        <!-- Row 6 -->
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtMobileNo" value="${buyerApply.mobilePhone}">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtEmail" value="${buyerApply.email}">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtBankAcc" value="${buyerApply.bankAccountNumber}">
        </div>
      </div>
    </div>
  </div>
...
<div class="clearfix">
  <div class="if-panel-head if-panel-blue">
    <fmt:message key='buyer.profile.private.page.panel.title2' />
  </div>
  <div class="panel panel-success">
    <div class="panel-body">
      <div class="row">
        <!-- Row 1 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.profile.private.page.panel.currentEmployer' /></a></div>
        <div class="col-sm-6 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtCurrentEmpl" value="${buyerApply.employer}">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.profile.private.page.panel.employerName' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <div class="input-group">
            <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtEmplName" value="${buyerApply.employerName}">
          </div>
        </div>
        <!-- Row 2 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.profile.private.page.panel.employerAdress' /></a></div>
        <div class="col-sm-6 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtEmplAddress" value="${buyerApply.residenceAddress}">
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.profile.private.page.panel.industrySector' /></a></div>
        <div class="col-sm-6 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtIndustry sector" value="${buyerApply.priIndustry}">
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
		...
		<c:set var="idx" value="${status.index}" />
		  <div class="form-group if-form-group-sm">
			<div class="col-sm-6 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">${question[self.i18n.question_qtext]}</a></div>
			...
			<input type="hidden" name="questions[${idx}].qname" value="${question.qname}" />
				<div class="col-sm-2 col-xs-12">
					<input type="text" class="form-control if-input-sm if-div-input-sm" name="questions[${idx}].atext" value="${buyerApply.questions[idx][self.i18n.question_atext]}" readonly>
				</div>
				<div class="col-sm-4 if-div-input-sm"></div>
		  </div>
        </c:forEach>
        <c:if test="${user.fromChannels == 'Introduced from BANK/ENTITY staff' }">
		  <div class="col-sm-6 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.profile.institution.page.panel.question3' /></a></div>
			<div class="col-sm-2 col-xs-12">
			  <div class="input-group">
