    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content if-detail-auction-content">
                ...
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.history.delisted.both.page.auctionStatus' />:  </b><span style="color: #d64635"><b><fmt:message key='seller.history.delisted.both.page.closed' /></b>&nbsp;<i class="icon-lock"></i></span><b>&nbsp;<fmt:message key='seller.history.delisted.expried.page.reason' /></b></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="${base}/seller/invoice/delistedexpried/biddhistory">&gt;&gt;&gt; <fmt:message key='seller.myinvoice.detail.delisted.both.page.viewBiddingHistory' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
