    ...
    <div class="panel-body">
      <div class="row">
        ...
        <div class="col-sm-4 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  value="${invoice.sellerRepresentedByName}"></span>
        </div>
        <!-- Row 2 -->
      </div>
    </div>
    ...
    <div class="panel-body">
      <div class="row">
        ...
        <div class="col-sm-12 text-center" style="margin-top: 10px">
          <a href="javascript:;" class="btn if-detail-btn-group if-btn-medium dialog_accept_offer" style="margin-right: 3px" >
...
<script>
  ...
  var app = {
			...
			strOfferRts : "<fmt:message key='b.make.str.make.an.offer1'/> ${invoice.finInvAmount} <fmt:message key='b.make.str.make.an.offer2'/> ${invoice.bestBuyerAdv}%<fmt:message key='b.make.str.make.an.offer3'/> ${invoice.bestBuyerInt}%<fmt:message key='b.make.str.make.an.offer4'/>",
			titleOffer : "<fmt:message key='b.make.title.make.an.offer'/> ${invoice.id}:",
			strOffer1 : "<fmt:message key='b.make.str.make.an.offer1'/> ${invoice.finInvAmount} <fmt:message key='b.make.str.make.an.offer2'/> ",
