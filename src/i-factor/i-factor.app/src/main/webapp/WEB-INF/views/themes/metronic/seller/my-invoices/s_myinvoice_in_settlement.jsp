...
<body class="page-header-fixed page-quick-sidebar-over-content">
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
          <form class="form-inline" action="${base}/seller/invoice/insettle"  id="formQuery" name="formQuery"  method="post" role="form">
            <div class="page-content">
                <!-- BEGIN PAGE HEADER-->
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <a href="#"><fmt:message key='s.myinvoice.insettlement.page.breadcrumb' /></a>
                ...
                <h5 class="page-title">
                    <b><fmt:message key='s.myinvoice.insettlement.page.breadcrumb2' />&nbsp;&nbsp;&nbsp;<span id="invoiceNum"></span></b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='s.myinvoice.insettlement.page.breadcrumb4' />&nbsp;<span style="color:#ff0000"><fmt:message key='s.myinvoice.insettlement.page.breadcrumb5' />&nbsp;<i class="icon-lock"></i></span></b></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                <form action="">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-6 text-right"><a href="#" id="toggle_link" class="if_toggle if_show" onclick="toggle('More&nbsp;&nbsp;', 'Less&nbsp;&nbsp;','col-sm-offset-2 col-sm-1 col-xs-12 text-right','col-sm-offset-11 col-sm-1 col-xs-12 text-right');"><fmt:message key='s.myinvoice.insettlement.panel.success2' />&nbsp;&nbsp;<i class="icon-arrow-down"></i></a></div>                       
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" id="invoiceAmountFrom" name="invoiceAmountFrom" placeholder="From">
                                </div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" id="invoiceAmountTo" name="invoiceAmountTo" 	placeholder="To">
                                </div>
                                <!--End Amount-->                                 
                                <!--Begin No. of overdue days-->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm"><a href="#"><fmt:message key='s.myinvoice.insettlement.panel.success4' /> &nbsp;</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                ...
                                <div class="col-sm-12 col-xs-12 text-left bold"><fmt:message key='s.myinvoice.insettlement.panel.success8' /></div>
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm"><fmt:message key='s.myinvoice.insettlement.panel.success9' />:&nbsp;</div>
                                <!-- Begin Settled-->
                                ...
                                <!-- Begin Overdue -->
                                <div class="col-sm-3 col-xs-12 text-left  if-div-input-sm"><a href="#">Overdue  &nbsp;<span><input type="checkbox" id="overdue" name="overdue" value="option1"></span></a></div>
                                <!-- End Overdue  -->                                                               
                            ...
                            <div class="">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="content_table">
                                    <thead>
                                        <tr>
                                            <th style="width:20px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead' />
                                            </th>
                                            <th style="width:60px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead1' />
                                            </th>
                                            <th style="width:60px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead2' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead3' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead4' />
                                            </th>
                                            <th style="width:150px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead5' />
                                            </th>
                                            <th style="width:250px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead6' />
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead7' />
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead8' />
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead9' />
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead10' />   
                                            </th>
                                            <th style="width:100px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Total amount to be received / paid" style="color:white"><fmt:message key='s.myinvoice.insettlement.table.thead11' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:100px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead12' />
                                            </th>
                                            <th style="width:100px">
                                                <fmt:message key='s.myinvoice.insettlement.table.thead13' />
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
	                                          <a href="javascript:;" target="main-iframe">
					                          	<button type="button" class="btn-small btn-info btn-circle" onclick="window.open('${base}/seller/invoice/particalsettled/biddhistory/${item.id}');"><i class="fa fa-list"></i></button>
					                          </a>	
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                               <a href="${base}/seller/invoice/particalsettled/detail/${item.id}">
			                          	       	${item.finStickerId}
			                           	       </a> 
                                            </td>
                                            <td>
