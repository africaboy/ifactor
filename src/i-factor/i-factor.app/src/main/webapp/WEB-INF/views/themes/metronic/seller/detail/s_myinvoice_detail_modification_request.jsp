            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"><fmt:message key='seller.myinvoice.detail.modification.page.header.invoiceApprovalStatus' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                ...
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.myinvoice.detail.modification.page.invoiceStatus' />:  </b><span style="color:#ff6a00"><b><fmt:message key='buyer.update.page.Status' /></b></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <span class="if-icon-addon"><a href="javascript:;"><i class="glyphicon glyphicon-pencil" style="color: #ff6a00;"></i></a></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.mybid.detail.dealed.page.panel.remainingMaturityTerm' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
