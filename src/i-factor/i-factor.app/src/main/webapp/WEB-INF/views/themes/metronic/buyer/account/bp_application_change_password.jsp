    ...
    <div class="page-content">
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li>
            <a href="#"><fmt:message key='buyer.password.page.title' /></a>
          </li>
        </ul>
      </div>
      <h5 class="page-title">
        <b><fmt:message key='buyer.password.page.title' /></b>
      </h5>
      ...
      <div style="margin-top: 5px">
        <div class="col-md-offset-6 col-md-6">
        	<button style="padding: 0.5px 8px 2px 8px;" class="btn if-btn" id="submitApplication" type="button"><fmt:message key='buyer.password.button.submit'/></button>
        </div>
      </div>
      </form>
      <!-- END PAGE CONTENT-->
