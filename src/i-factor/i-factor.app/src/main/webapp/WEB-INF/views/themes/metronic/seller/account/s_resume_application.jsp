                                            ...
                                            <div class="tab-content">
                                                  ...
                                                  <form class="form-horizontal" id="form-company-info" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
			                                              ...
			                                              <select  class="form-control if-input-sm if-div-input-md" id="comRegisteredCountry" name="comRegisteredCountry" 	data-rule-required="true" data-msg-required="<fmt:message key='seller.apply.form.field.comRegisteredCountry.required'/>"  <c:if test="${sellerApply.isComVietnam == 'Yes' }">disabled</c:if>>
															<option value="">  </option>
															<c:forEach var="item" items="${countryList}" varStatus="status">
                                                ...
                                                <div class="tab-pane" id="tab-documents">
                                                   <%--  <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <form class="form-horizontal" id="div-IdentificationFile" 	method="POST" enctype="multipart/form-data">
											          <div class="form-group if-form-group-sm">
											          ...
											          <div class="col-md-3" style="margin-top: 10px;">
														<span class="file-extend">
															...
															<span class="file-uploadBtn"><fmt:message key='seller.apply.form.button.addFile'/></span>
									                        <input type="file" 
											        ...
											        <div class="form-group if-form-group-sm">
											          ...
											          <div class="col-md-3" style="margin-top: 6px;">
														<span class="file-extend">
									                        ...
									                        <input type="hidden" id="file-type-taxCodeFile" name="fileType" value="${self.docBiztypePrefix}license_companyLicense" />
															</span>
														</span>
                                                  ...
                                                  <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                                   ...
                                                   <form class="form-horizontal"  method="POST" enctype="multipart/form-data">
											          <div class="form-group if-form-group-sm">
														...
														<div id="file-link-invoiceFile3" class="filename">
