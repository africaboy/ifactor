  ...
  <div class="page-content if-detail-auction-content">
    ...
    <div class="page-bar">
      <ul class="page-breadcrumb">
        <li>
          <a href="#"><fmt:message key='b.history.unsuccessful.aution.page.breadcrumb' /></a>
          <i class="fa fa-angle-right"></i>
        </li>
        <li>
          <a href="#"><fmt:message key='b.history.unsuccessful.aution.page.breadcrumb1' /></a>
          <i class="fa fa-angle-right"></i>
        </li>
        <li>
          <a href="#"><fmt:message key='b.history.unsuccessful.aution.page.breadcrumb2' /></a>
        </li>
      </ul>
    </div>
    <h5 class="page-title">
      <b><fmt:message key='b.history.unsuccessful.aution.page.breadcrumb3' /></b>
    </h5>
    <h5 class="page-title">
      <small><b><fmt:message key='b.history.unsuccessful.aution.page.breadcrumb4' />  <span style="color: #d64635"> <fmt:message key='b.history.unsuccessful.aution.page.breadcrumb5' /> <i class="icon-lock"></i>  </span>  <fmt:message key='b.history.unsuccessful.aution.page.breadcrumb6' /></b></small>
    </h5>
    <!-- END PAGE HEADER-->
    <!-- BEGIN PAGE CONTENT-->
    ...
    <div class="clearfix">
      <div class="if-panel-head if-panel-light-grey">
          <fmt:message key='b.history.unsuccessful.aution.invoice.summary' />
      </div>
      <div class="panel panel-success">
        <div class="panel-body">
          <div class="row">
            <!-- Row 1 -->
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.unsuccessful.aution.invoice.summary1' /></a></div>
            ...
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.unsuccessful.aution.invoice.summary2' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
              <div class="input-group">
            ...
            <!-- Row 2 -->
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.unsuccessful.aution.invoice.summary3' /></a></div>
            <div class="col-sm-2 col-xs-12">
              <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtSellerID" value="${auction.invoice.sellerId}">
            </div>
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.unsuccessful.aution.invoice.summary4' /></a></div>
            ...
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.unsuccessful.aution.invoice.summary5' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
              <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtObject" value="${auction.invoice.finObjOfInv}">
            </div>
            <!-- Row 3 -->
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.unsuccessful.aution.invoice.summary6' /></a></div>
            <div class="col-sm-2 col-xs-12">
            ...
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.unsuccessful.aution.invoice.summary7' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
            ...
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.unsuccessful.aution.invoice.summary8' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
    ...
    <!-- End ready to sell information -->
      ...
      <div class="clearfix">
          <div class="if-panel-head if-panel-green">
              <fmt:message key='b.history.unsuccessful.aution.your.offer' />
          </div>
          <div class="panel panel-success">
              <div class="panel-body">
                  <div class="row">
      ...
      <!-- Your offer (Accepted) -->
    <h5 class="page-title">
      <small><b><fmt:message key='b.history.unsuccessful.aution.bidding.history' /></b></small>
    </h5>
    <div class="row">
      <div class="col-md-12">
        <div class="portlet box">
          <div class="">
            ...
            <table class="table table-striped table-bordered table-hover" id="content_table">
              ...
              <tr>
                <th style="width:20px">
                  <fmt:message key='b.history.unsuccessful.aution.bidding.history1' />
                </th>
                <th>
                  <fmt:message key='b.history.unsuccessful.aution.bidding.history2' />
                </th>
                <th style="width:120px">
                  <fmt:message key='b.history.unsuccessful.aution.bidding.history3' />
                </th>
                <th style="width:120px">
                  <fmt:message key='b.history.unsuccessful.aution.bidding.history4' />
                </th>
                <th>
                  <fmt:message key='b.history.unsuccessful.aution.bidding.history5' />
                </th>
                <th>
                  <fmt:message key='b.history.unsuccessful.aution.bidding.history6' />
                </th>
                <th>
                  <fmt:message key='b.history.unsuccessful.aution.bidding.history7' />
                </th>
              </tr>
              </thead>
              <tbody>
