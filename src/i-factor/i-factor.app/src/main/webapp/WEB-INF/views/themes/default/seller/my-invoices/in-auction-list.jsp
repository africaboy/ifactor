...
<c:set target="${self.js}" property="main">
    ...
    <script type="text/javascript" src="${base}/static/themes/default/js/seller/my-invoices/in-auction-list.js"></script>
                      ...
                      <table class="table table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th><fmt:message key='invoice.list.thead.bestAdv'/></th>
                            <th><fmt:message key='invoice.list.thead.bestInt'/></th>
                        ...
                        <c:if test="${not empty page.content}">
                          ...
                          <tr>
                            <td width="20%">
                              ...
                              <c:if test="${not empty item.bestBuyerAdv}">
                               <a href="${base}/seller/invoice/under-approval/confirm/${item.id }" class="btn btn-default" target="main-iframe"><fmt:message key='invoice.list.tbody.button.confirm'/></a>
                              </c:if>
                            </td >
