  ...
  <div class="page-content if-detail-auction-content">
    ...
    <div class="page-bar">
      <ul class="page-breadcrumb">
        <li>
          <a href="#"><fmt:message key='s.history.invoice.inauction.page.breadcrumb' /></a>
          <i class="fa fa-angle-right"></i>
        </li>
        <li>
          <a href="#"><fmt:message key='s.history.invoice.inauction.page.breadcrumb1' /></a>
          <i class="fa fa-angle-right"></i>
        </li>
        <li>
          <a href="#"><fmt:message key='s.history.invoice.inauction.page.breadcrumb2' /></a>
        </li>
      </ul>
    </div>
    <h5 class="page-title">
      <b><fmt:message key='s.history.invoice.inauction.page.breadcrumb3' /></b>
    </h5>
    <h5 class="page-title">
      <small><b><fmt:message key='s.history.invoice.inauction.page.breadcrumb4' />  <span style="color: green"><fmt:message key='s.history.invoice.inauction.page.breadcrumb5' /> <i class="icon-lock-open"></i></span></b></small>
    </h5>
    <!-- END PAGE HEADER-->
    <!-- BEGIN PAGE CONTENT-->
    ...
    <div class="clearfix">
      <div class="if-panel-head if-panel-light-grey">
        <fmt:message key='s.history.invoice.inauction.invoice.summary' />
      </div>
      <div class="panel panel-success">
        <div class="panel-body">
          <div class="row">
            <!-- Row 1 -->
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.invoice.inauction.invoice.summary1' /></a></div>
            ...
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.invoice.inauction.invoice.summary2' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
              <div class="input-group">
            ...
            <!-- Row 2 -->
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.invoice.inauction.invoice.summary3' /></a></div>
            <div class="col-sm-6 col-xs-12 ">
              <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtDetorID" value="${invoice.debtorName}">
            </div>
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.invoice.inauction.invoice.summary4' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
              <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtObject" value="${invoice.finObjOfInv}">
            </div>
          
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.invoice.inauction.invoice.summary5' /></a></div>
            <div class="col-sm-2 col-xs-12">
              ...
              <!-- Row 3 -->
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.invoice.inauction.invoice.summary6' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
            ...
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.history.invoice.inauction.invoice.summary7' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
              <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtDueDate" value="${invoice.reDaysStillDelisting}">
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- End ready to sell information -->
      ...
      <div class="clearfix">
          <div class="if-panel-head if-panel-green">
              <fmt:message key='s.history.invoice.inauction.current.bestoffer' />
          </div>
          <span class="if-panel-next_to if-tooltip"> <a href="s_accept_an_offer.html"  data-toggle="tooltip" data-original-title="Accept offer" data-container="body"><i class="fa fa-hand-o-right" style="color: green;"></i></a></span>
          <div class="panel panel-success">
              <div class="panel-body">
                  <div class="row">
                      <!-- Row 1 -->
	  ...
	  <h5 class="page-title">
		  <small><b> <fmt:message key='s.history.invoice.inauction.bidding.history' /></b></small>
		</h5>
    <div class="row">
      <div class="col-md-12">
      ...
      <tr>
        <th style="width:20px">
          <fmt:message key='s.history.invoice.inauction.bidding.history1' />
        </th>
        <th>
          <fmt:message key='s.history.invoice.inauction.bidding.history2' />
        </th>
        <th style="width:120px">
            <fmt:message key='s.history.invoice.inauction.bidding.history3' />
        </th>
        <th style="width:120px">
            <fmt:message key='s.history.invoice.inauction.bidding.history4' />
        </th>
        <th>
            <fmt:message key='s.history.invoice.inauction.bidding.history5' />
        </th>
        <th>
            <fmt:message key='s.history.invoice.inauction.bidding.history6' />
        </th>
      </tr>
      </thead>
      <tbody>
      ...
      <tr class="tr_pink if-tooltip odd" role="row">
