            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>
                            <a href="#"><fmt:message key='seller.market.list.page.header.invoices' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                            <a href="#"><fmt:message key='seller.market.list.page.header.open' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='seller.market.list.page.title' />&nbsp;&nbsp;&nbsp;<span id="invoiceNum"></span></b>
                </h5>
                <h5 class="page-title">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if-tooltip if_filter_hidden"><a href="#" data-toggle="tooltip" data-original-title="Remaining maturity term"><fmt:message key='seller.market.list.page.panel.body.tmt' /> &nbsp;<i class="icon-question"></i></a></div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" id="finRmngMatTermFrom" name="finRmngMatTermFrom" placeholder="From (days)">
                                </div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" id="finRmngMatTermTo" name="finRmngMatTermTo" placeholder="To (days)">
                                </div>
                                ...
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><fmt:message key='seller.market.list.page.panel.body.invoiceObject' />:</div>
                                <!-- Begin Services delivery-->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='seller.market.list.page.panel.body.services' /> &nbsp;<span><input type="checkbox" id="finObjOfInv1" name="finObjOfInv" value="Services delivery"></span></a></div>
                                <!-- End Services delivery -->
                                <!-- Begin Goods delivery - perishable -->
                                <div class="col-sm-3 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='seller.market.list.page.panel.body.perishable' />  &nbsp;<span><input type="checkbox" id="finObjOfInv2" name="finObjOfInv" value="Goods delivery - perishable"></span></a></div>
                                <!-- End Goods delivery - perishable  -->
                                <!-- Begin Goods delivery - nonperishable-->
                                <div class="col-sm-4 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='seller.market.list.page.panel.body.nonperishable' /> &nbsp;<span><input type="checkbox" id="finObjOfInv3" name="finObjOfInv" value="Goods delivery - nonperishable"></span></a></div>
                                <!-- End Goods delivery - nonperishable -->                                
                                <!-- Begin Invoice seller ID -->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='seller.market.list.page.panel.body.invoiceSellerID' /></a></div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" id="sellerId" name="sellerId" placeholder="Invoice seller ID">
                                </div>
                                <!-- End Invoice seller ID -->
                                <!-- Begin Invoice debtor -->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='seller.market.list.page.panel.body.invoiceDedtor' /></a></div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" id="debtorName" name="debtorName" placeholder="Invoice debtor">
                                </div>
                                <!-- End Invoice debtor -->
                                <!-- End hidden fields -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="content_table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:80px">
                                                <fmt:message key='seller.market.list.page.table.th.invoiceSellerID' />
                                            </th>
                                            <th style="width:250px">
                                                <fmt:message key='seller.market.list.page.table.th.invoiceDebtor' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='seller.market.list.page.table.th.invoiceObject' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='seller.market.list.page.table.th.delistingDate' />
                                            </th>
                                            <th style="width:90px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Ready to sell advance" style="color:white"><fmt:message key='seller.market.list.page.table.th.rtsa' />&nbsp;<br><i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:100px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Current best offered advance" style="color:white"><fmt:message key='seller.market.list.page.table.th.cboa' />&nbsp;<br><i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:90px" class="if-tooltip">
                                                <a  data-toggle="tooltip white" data-original-title="Ready to sell interest" style="color:white"><fmt:message key='seller.market.list.page.table.th.rtsi' />&nbsp;<br><i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:100px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Current best offered interest" style="color:white"><fmt:message key='seller.market.list.page.table.th.cboi' />&nbsp;<br><i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:90px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Remaining maturity term" style="color:white"><fmt:message key='seller.market.list.page.table.th.tmt' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='seller.market.list.page.table.th.numberOfBids' />
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                      <%--  <c:if test="${not empty page.content}">
				                       ...
				                       <c:if test="${status.index%2==0&&item.sellerId==loginUser.id}"><tr class="success ifactive odd"></c:if>
				                       <c:if test="${status.index%2==0&&item.sellerId!=loginUser.id}"><tr class="odd"></c:if>
				                       <c:if test="${status.index%2!=0&&item.sellerId==loginUser.id}"><tr class="success ifactive even"></c:if>
				                       <c:if test="${status.index%2!=0&&item.sellerId!=loginUser.id}"><tr class="even"></c:if>
				                          <td>${status.index + 1}</td> 
				                          <td>
				                          	<c:if test="${item.sellerId==loginUser.id}">
				                          ...
				                          <td><fmt:formatDate value='${item.releasedDate}' pattern='MM/dd/yyyy'/></td>
				                          <td class="if-tooltip">
				                          	   <c:if test="${item.sellerId==loginUser.id}">
			                          	    	<a data-toggle="tooltip" data-original-title="<fmt:message key='seller.market.list.page.table.myinvoice' />">${item.finStickerId}</a>
			                          	    	<img style="padding-left: 2px" src="${base}/static/themes/metronic/img/mybid.png"/>
			                          	       </c:if>
			                          	       <c:if test="${item.sellerId!=loginUser.id}">
			                          	    	<a data-toggle="tooltip" data-original-title="<fmt:message key='seller.market.list.page.table.nmhit' />">${item.finStickerId}</a>
			                          	       </c:if>
				                          </td>
				                          <td><fmt:formatNumber  value="${item.finInvAmount}" type="number" />&nbsp;VND</td>
				                          <td>
				                          	<a href="${base}/seller/profile/view/${item.sellerId}">
				                          	   ${item.sellerId}
				                           	</a>
				                          </td>
				                          <td>
				                          ...
				                          <td>${item.finObjOfInv}</td>
				                          <td><fmt:formatDate value='${item.endDate}' pattern='MM/dd/yyyy'/></td>
				                          <td>${item.readyToSellAdv }&nbsp;%</td>
				                          <td>${item.bestBuyerAdv}&nbsp;%</td>
				                          <td>${item.readyToSellInt }&nbsp;%</td>
				                          <td>${item.bestBuyerInt }&nbsp;%</td>
				                          <td>${item.finRmngMatTerm }&nbsp;<fmt:message key='b.make.new.offer.page.tab1.days' /></td>
				                          <td>
				                          		<c:if test="${item.noOfOffers==null}">0&nbsp;<fmt:message key='b.make.new.offer.page.bid' /></c:if>
				                          		<c:if test="${item.noOfOffers==1}">${item.noOfOffers}&nbsp;<fmt:message key='b.make.new.offer.page.bid' /></c:if>
				                          		<c:if test="${item.noOfOffers>1}">${item.noOfOffers}&nbsp;<fmt:message key='b.make.new.offer.page.bids' /></c:if>
				                          </td>
				                        </tr>
				                        </c:forEach>
				                        </c:if> --%>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $('#content_table').DataTable({
                ...
                sAjaxSource: app.base + '/seller/auction/apply/list',
                ...
                "aoColumns":[ 
                         	...
                         	{ "mData": "finRmngMatTerm", 'sClass':'left'},
                             ...
                             /*       $('td:eq(9)', nRow).html("<a href='' user_id='" + aData.user_id + "' class='ace_detail'>详情</a>");
                                   if (aData.status != 1 && aData.status != 4 && aData.active == 0) { */
                                 	  ...
                                 	  if(aData.sellerId==${loginUser.id}){
                                 	 ...
                                 	 if(aData.sellerId==${loginUser.id}){
                                       ...
                                       if(aData.sellerId==${loginUser.id}){
                                         var td4="<a data-toggle='tooltip' data-original-title='<fmt:message key='seller.market.list.page.table.myinvoice' />'>"+aData.finStickerId+"</a>"
                          	    	       +"<img style='padding-left: 2px' src='${base}/static/themes/metronic/img/mybid.png'/>";
                                       }else{
                                         var td4 =  aData.finStickerId; 
                                       }
                                       var td5 =  decimalInputFormatFunc(aData.finInvAmount)+"&nbsp;VND";
                                       var td6 = "<a href='${base}/seller/profile/view/"+aData.sellerId+"'> "+aData.sellerId+" </a>";
                                       var td7 = "<a href='${base}/seller/profile/debtorById/"+aData.id+"'> "+aData.debtorName+" </a>";
                                       var td8 =  aData.finObjOfInv;
                                       var td9 =  eDate.Format('MM/dd/yyyy');
                                       var td10 =  aData.readyToSellAdv+"&nbsp;%";
                                       var td11 = aData.bestBuyerAdv== null?0:aData.bestBuyerAdv+"&nbsp;%";
                                       var td12 = aData.readyToSellInt+"&nbsp;%";
                                       var td13 = aData.bestBuyerInt== null?0:aData.bestBuyerInt+"&nbsp;%";
                                       var td14 = aData.finRmngMatTerm+"&nbsp;<fmt:message key='b.make.new.offer.page.tab1.days' />";
                                       if(aData.noOfOffers==null){
                                          var td15 = 0+"&nbsp;<fmt:message key='b.make.new.offer.page.bid' />";
                                       }else if(aData.noOfOffers==1){
                                          var td15 = 1+"&nbsp;<fmt:message key='b.make.new.offer.page.bid' />";
                                       }else{
                                     	  var td15 = aData.noOfOffers+"&nbsp;<fmt:message key='b.make.new.offer.page.bids' />";
                                       }
                                       ...
                                       $('td:eq(4)', nRow).addClass("if-tooltip");
                                       ...
                                       $('td:eq(12)', nRow).html(td12);
                                       $('td:eq(13)', nRow).html(td13);   
                                       $('td:eq(14)', nRow).html(td14);
                                       $('td:eq(15)', nRow).html(td15);
                                   
                                       if(status.index%2==0 && aData.sellerId==${loginUser.id}){
                                    	    $(nRow).addClass("success ifactive odd");
                                       }else if(status.index%2==0 && aData.sellerId!=${loginUser.id}){
                                         $(nRow).addClass("odd");
                                       }else if(status.index%2!=0 && aData.sellerId==${loginUser.id}){
                                         $(nRow).addClass("success ifactive even");
                                       }else{
                                    	   $(nRow).addClass("even"); 
                                       }

                                       
                                       $('td:eq(4) a', nRow).tooltip({
                                     	    placement : 'top'
                                        });
