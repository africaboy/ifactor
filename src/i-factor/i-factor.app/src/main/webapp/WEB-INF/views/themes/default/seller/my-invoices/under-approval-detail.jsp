...
<c:set target="${self.js}" property="main">
    ...
    <script type="text/javascript" src="${base}/static/themes/default/js/seller/my-invoices/under-approval-detail.js"></script>
</c:set>
              ...
              <div class="form-content">
                <div class="tab-header clearfix">
                  <div class="tab-header-title">
                    <i></i> 
                    <span><fmt:message key='myInvoice.underApproval.detail.tabs.title'/></span>
                  </div>
