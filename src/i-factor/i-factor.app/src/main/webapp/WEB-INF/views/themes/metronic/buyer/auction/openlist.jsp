...
<!--              <li>
              ...
              <li>
                <a href="#"><fmt:message key='invoice.list.tbody.queryForm.title.market'/></a>
                <i class="fa fa-angle-right"></i>
              </li>
              <li>
                <a href="#"><fmt:message key='invoice.list.tbody.queryForm.title.openAuction'/></a>
              </li>
            </ul>
          </div>
          <h5 class="page-title">
            <b><fmt:message key='buyer.auction.openlist.page.title.openAuctions'/>&nbsp;&nbsp;&nbsp;<span id="invoiceNum"></span></b>
          </h5>
          <h5 class="page-title">
            <small><b><fmt:message key='invoice.list.tbody.queryForm.field.auctionstatus'/>&nbsp;<span style="color: green"><fmt:message key='seller.market.list.page.status'/>&nbsp;<i class="icon-lock-open"></i></span></b></small>
          </h5>
          <!-- END PAGE HEADER-->
          <!-- BEGIN PAGE CONTENT-->
          <%-- <form class="form-inline" action="${base}/buyer/auction/openList"  id="formQuery" name="formQuery"  method="post" role="form"> --%>
          ...
          <div class="clearfix">
            <div class="panel panel-success">
              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-sm-6 col-xs-6 text-left bold"><fmt:message key='invoice.list.tbody.queryForm.field.financinginfor'/></div>
                ...
                <div class="row">
                  <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="#"><fmt:message key='invoice.list.thead.invoiceAmount'/></a></div>
                ...
                <div class="col-sm-12 col-xs-12 text-left bold if_filter_hidden"><fmt:message key='invoice.list.tbody.queryForm.field.dateinfor'/></div>
                  <!-- Begin hidden fields -->
                  <!-- Begin Release Date -->
                  ...
                  <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if-tooltip if_filter_hidden"><a href="#" data-toggle="tooltip" data-original-title="Remaining maturity term"><fmt:message key='invoice.list.thead.tmt'/> &nbsp;<i class="icon-question"></i></a></div>
                  <div class="col-sm-2 col-xs-12 if_filter_hidden">
                    <input type="text" class="form-control if-input-sm if-div-input-sm"  id="finRmngMatTermFrom" name="finRmngMatTermFrom" placeholder="From (%)">
                  </div>
                  <div class="col-sm-2 col-xs-12 if_filter_hidden">
                    <input type="text" class="form-control if-input-sm if-div-input-sm"  id="finRmngMatTermTo" name="finRmngMatTermTo" placeholder="To (%)">
                  </div>
                  <!-- End Remaining maturity term -->
                  <div class="col-sm-12 col-xs-12 text-left bold if_filter_hidden"><fmt:message key='invoice.list.tbody.queryForm.field.invoiceinfor'/></div>
                  <!-- Begin my bid -->
                  <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='invoice.list.tbody.queryForm.field.mybids'/> &nbsp;<span><input type="checkbox" id="inlineCheckbox1" name="inlineCheckbox1" value="My bids"></span></a></div>
                  <!-- End my bid -->
                  <!-- Begin Invoice sticker ID -->
                  <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='invoice.list.thead.stickerId'/></a></div>
                  <div class="col-sm-2 col-xs-12 if_filter_hidden">
                    <input type="text" class="form-control if-input-sm if-div-input-sm"  id="finStickerId" name="finStickerId" placeholder="Sticker ID">
                  </div>
                  <!-- End Invoice sticker ID -->
                  <!-- Begin Invoice seller ID -->
                  <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='invoice.list.thead.invoiceSellerId'/></a></div>
                  <div class="col-sm-2 col-xs-12 if_filter_hidden">
                  ...
                  <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='invoice.list.thead.invoiceDetor'/></a></div>
                  <div class="col-sm-2 col-xs-12 if_filter_hidden">
            ...
            <div class="col-md-12">
                    ...
                    <thead >
                      <tr>
                        ...
                        <th style="width:100px" class="if-tooltip">
                          <a data-toggle="tooltip white" data-original-title="Ready to sell advance" style="color:white"><fmt:message key='seller.market.list.page.panel.body.rtsa'/>&nbsp;<i class="icon-question"></i></a>
                        </th>
                        <th style="width:100px" class="if-tooltip">
                          <a data-toggle="tooltip white" data-original-title="Current best offered advance" style="color:white"><fmt:message key='seller.market.list.page.panel.body.cboa'/>&nbsp;<i class="icon-question"></i></a>
                        </th>
                        <th style="width:100px" class="if-tooltip">
                        ...
                        <th style="width:100px" class="if-tooltip">
                          <a data-toggle="tooltip white" data-original-title="Current best offered interest" style="color:white"><fmt:message key='seller.market.list.page.panel.body.cboi'/>&nbsp;<i class="icon-question"></i></a>
                        </th>
                        <th style="width:100px" class="if-tooltip">
                          <a data-toggle="tooltip white" data-original-title="Remaining maturity term" style="color:white"><fmt:message key='seller.market.list.page.panel.body.tmt'/>&nbsp;<i class="icon-question"></i></a>
                        </th>
                        <th style="width:20px">
             ...
             <%--          <c:if test="${not empty page.content}">
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="${base}/buyer/auction/makeoffer/biddhistory/${item.id}" target="main-iframe">
                          ...
                          <td>
                             <button type="button" class="btn-small btn-primary btn-circle">
		                	   <a href="/buyer/openauction/openDetail/makeOffer/${item.id}" style="color:#ffffff;"><i class="fa fa-hand-o-right"></i></a>
		                     </button>
                          </td>
                          <td><fmt:formatDate value='${item.releasedDate}' pattern='MM/dd/yyyy'/></td>
                          <td>${item.finStickerId}</td>
                          <td>${item.finInvAmount }&nbsp;VND</td>
                          <td>
                          ...
                          <td>
                          	<a href="${base}/buyer/profile/debtor/${item.debtorName}">
                          	   ${item.debtorName}
                           	</a>
                          </td>
...
<%--     <script type="text/javascript" src="${base}/static/themes/metronic/js/buyer/auction/openlist.js"></script> --%>
    ...
    <script>
      jQuery(document).ready(function() {
        ...
        $('#content_table').DataTable({
            ...
            sAjaxSource: app.base + '/buyer/auction/open/list',
            ...
            "aoColumns":[ 
                ...
                /*       $('td:eq(9)', nRow).html("<a href='' user_id='" + aData.user_id + "' class='ace_detail'>详情</a>");
                      if (aData.status != 1 && aData.status != 4 && aData.active == 0) { */
                    	  ...
                    	  var td1 = "<a href='${base}/buyer/auction/makeoffer/biddhistory/"+aData.id+"' target='main-iframe'><button type='button' class='btn-small btn-info btn-circle'>    <i class='fa fa-list'></i>"
                                     +"</button></a>";
                          var td2 = "<button type='button' class='btn-small btn-primary btn-circle'><a href='/buyer/openauction/openDetail/makeOffer/"+aData.id+"' style='color:#ffffff;'><i class='fa fa-hand-o-right'></i></a>"
		                             +"</button>";
                          var td3 =  rDate.Format('MM/dd/yyyy');
                          if(aData.buyerId==${loginUser.id}){
                            var td4 = "<a data-toggle='tooltip' data-original-title='My bid'>"+aData.finStickerId+"</a><img style='padding-left: 2px' src='${base}/static/themes/metronic/img/mybid.png'>";
                          }else{
                            var td4 =  aData.finStickerId; 
                          }
                          var td5 =  decimalInputFormatFunc(aData.finInvAmount)+"&nbsp;VND";
                          var td6 = "<a href='${base}/buyer/profile/seller/"+aData.sellerId+"'> "+aData.sellerId+" </a>";
                          var td7 = "<a href='${base}/buyer/profile/debtorById/"+aData.id+"'> "+aData.debtorName+" </a>";
                          var td8 =  eDate.Format('MM/dd/yyyy');
                          var td9 =  aData.readyToSellAdv+"&nbsp;%";
                          var td10 = aData.bestBuyerAdv== null?0:aData.bestBuyerAdv+"&nbsp;%";
                          var td11 = aData.readyToSellInt+"&nbsp;%";
                          var td12 = aData.bestBuyerInt== null?0:aData.bestBuyerInt+"&nbsp;%";
                          var td13 = aData.finRmngMatTerm+"&nbsp;<fmt:message key='b.make.new.offer.page.tab1.days' />";
                          if(aData.noOfOffers==null){
                             var td14 = 0+"&nbsp;<fmt:message key='b.make.new.offer.page.bid' />";
                          }else if(aData.noOfOffers==1){
                             var td14 = 1+"&nbsp;<fmt:message key='b.make.new.offer.page.bid' />";
                          }else{
                        	 var td14 = aData.noOfOffers+"&nbsp;<fmt:message key='b.make.new.offer.page.bids' />";
                          }
