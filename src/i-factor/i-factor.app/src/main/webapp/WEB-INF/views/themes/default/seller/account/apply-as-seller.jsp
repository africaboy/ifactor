                                                    ...
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <select  class="form-control if-input-sm if-div-input-md" id="comIndustrySector" name="comIndustrySector" data-rule-required="true" data-msg-required="<fmt:message key='seller.apply.form.field.comIndustrySector.required'/>">
								                            ...
								                            <option value="${item.code}"  class="option1" disabled>${item[self.i18n.catalog_name]}</option>
								                              ...
								                              <option value="${item2.code}" class="option2" disabled> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp${item2[self.i18n.catalog_name]}</option>
									                             <c:forEach var="item3" items="${item2.children}"> 
									                             <option value="${item3.code}" class="option3">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp${item3[self.i18n.catalog_name]}</option>
									                             </c:forEach>
								                              </c:forEach>
								                            </c:forEach>
								                          </select>
                                                  ...
                                                  <form class="form-horizontal" id="form-further-details" method="POST" enctype="multipart/form-data">  
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
								                          ...
								                          <input type="text" class="form-control"  id="debtorA1Name" name="debtorA1Name" data-rule-required="false" data-msg-required="<fmt:message key='seller.apply.form.field.mainDebtor.required'/>" />
								                          <input type="hidden"  id="debtorA2Id" name="debtorA2Id" />
								                          <input type="text" class="form-control"  id="debtorA2Name" name="debtorA2Name" data-rule-required="false" data-msg-required="<fmt:message key='seller.apply.form.field.mainDebtor.required'/>" />
								                          <input type="hidden"  id="debtorA3Id" name="debtorA3Id" />
								                          <input type="text" class="form-control"  id="debtorA3Name" name="debtorA3Name" data-rule-required="false" data-msg-required="<fmt:message key='seller.apply.form.field.mainDebtor.required'/>" />
								                          <input type="hidden"  id="debtorA4Id" name="debtorA4Id" />
								                          <input type="text" class="form-control"  id="debtorA4Name" name="debtorA4Name" data-rule-required="false" data-msg-required="<fmt:message key='seller.apply.form.field.mainDebtor.required'/>" />
								                          <input type="hidden"  id="debtorA5Id" name="debtorA5Id" />
								                          <input type="text" class="form-control"  id="debtorA5Name" name="debtorA5Name" data-rule-required="false" data-msg-required="<fmt:message key='seller.apply.form.field.mainDebtor.required'/>" />
                                                        </div>
                                                        <div class="control-label col-md-3">
                                                    ...
                                                    <div class="form-group if-form-group-sm">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control"  id="esignatureSN"   maxlength="255" name="esignatureSN" />
                                                        </div>
                                                    </div>
                                                  </form>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 text-center">
                                                  ...
                                                  <!--   <a href="javascript:;"  id="saveApplication" class="btn default" style=" margin-right: 3px">
                                                    ...
                                                    <button class="btn default" style=" margin-right: 3px" id="saveApplication" type="button" >Save</button>
                                                    
                                                    <button class="btn default button-next"  id="continueApp"  type="button" >Continue</button>
                                                 ...
                                                 <!--    <a href="javascript:;"  id="submitApplication"  class="btn default button-submit">
                                                    ...
                                                    <button  class="btn default button-submit"  id="submitApplication"  type="button" >Submit</button>
