    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <h5 class="page-title">
                    <b><fmt:message key='seller.myinvoice.list.page.title' /> &nbsp;&nbsp;&nbsp;<fmt:message key='seller.market.list.page.title.590' /></b>
                </h5>
                <h5 class="page-title">
                                    ...
                                    <tbody>
				                       ...
				                       <c:forEach var="item" items="${page.content}" varStatus="status">
				                        <tr>
				                          ...
				                          <td>
				                            <a href="${base}/seller/invoice/inauction/biddhistory/${item.id}" target="main-iframe">
			                          	      <button type="button" class="btn-small btn-info btn-circle"><i class="fa fa-list"></i></button>
			                          	    </a>
				                          </td>	
				                          <!-- <td>
				                          ...
				                          <td>
		                          		    <button type="button" class="btn-small btn-primary btn-circle">
				                              <a href="${base}/seller/openauction/openDetail/acceptAnOffer/${item.id}" style="color:#ffffff;"><i class="fa fa-hand-o-right"></i></a>
				                          	</button>
				                          </td>
