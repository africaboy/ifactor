...
<body class="page-header-fixed page-quick-sidebar-over-content">
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
          <form class="form-inline" action="${base}/seller/invoice/delisted"  id="formQuery" name="formQuery"  method="post" role="form">
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"><fmt:message key='s.myinvoice.delisted.page.breadcrumb1' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='s.myinvoice.delisted.page.breadcrumb2' />&nbsp;&nbsp;&nbsp;<span id="invoiceNum"></span></b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='s.myinvoice.delisted.page.breadcrumb4' />:&nbsp;<span style="color:#ff0000"><fmt:message key='s.myinvoice.delisted.page.breadcrumb5' />&nbsp;<i class="icon-lock"></i></span></b></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                <div class="clearfix">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-6 text-right"><a href="#" id="toggle_link" class="if_toggle if_show" onclick="toggle('More&nbsp;&nbsp;', 'Less&nbsp;&nbsp;','col-sm-offset-5 col-sm-1 col-xs-12 text-right','col-sm-offset-1 col-sm-1 col-xs-12 text-right');"><fmt:message key='s.myinvoice.insettlement.panel.success2' />&nbsp;&nbsp;<i class="icon-arrow-down"></i></a></div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" id="invoiceAmountFrom" name="finInvAmountFrom" placeholder="From (VND)">
                                </div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" id="invoiceAmountTo" name="finInvAmountTo" placeholder="To (VND)">
                                </div>
                                <!--End Invoice Amount-->                              
                                ...
                                <!-- Begin hidden fields -->
                                <!-- Begin Accepted Date -->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='s.myinvoice.delisted.page.breadcrumb6' /></a></div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm date-picker" id="delistingDateFrom" name="delistingDateFrom" value="From" readonly="" />
                                </div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm date-picker" id="delistingDateTo" name="delistingDateTo" value="To" readonly="" />
                                </div>
                                <!-- End Accepted Date -->                          
                                <div class="col-sm-12 col-xs-12 text-left bold if_filter_hidden"><fmt:message key='s.myinvoice.insettlement.panel.success8' /></div>
                                
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><fmt:message key='s.myinvoice.delisted.page.breadcrumb7' />:&nbsp;</div>
                                <!-- Begin Expired-->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#">Expired &nbsp;<span><input type="checkbox" id="reason1" name="reason" value="Expired"></span></a></div>
                                <!-- End Expired -->
                                <!-- Begin Unsuccessful disbursement-->
                                <div class="col-sm-3 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#">Unsuccessful disbursement &nbsp;<span><input type="checkbox" id="reason2" name="reason" value="Unsuccessful disbursement"></span></a></div>
                                <div class="col-sm-4 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#">Unsuccessful disbursement & Expired &nbsp;<span><input type="checkbox" id="reason3" name="reason" value="Unsuccessful disbursement & Expired"></span></a></div>
                                    <!-- End Unsuccessful disbursement -->
                                    <!-- Begin hidden fields -->

                                    <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><fmt:message key='s.myinvoice.delisted.page.breadcrumb8' />:&nbsp;</div>
                                    <!-- Begin Services delivery -->
                                    <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#">Services delivery  &nbsp;<span><input type="checkbox" id="finObjOfInv1" name="finObjOfInv" value="Services delivery"></span></a></div>
                                    <!-- End Services delivery  -->
                                    <!-- Begin Goods delivery - perishable -->
                                    <div class="col-sm-3 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#">Goods delivery - perishable  &nbsp;<span><input type="checkbox" id="finObjOfInv2" name="finObjOfInv" value="Goods delivery - perishable"></span></a></div>
                                    <!-- End Goods delivery - perishable -->
                                    <!-- Begin Goods delivery - nonperishable -->
                                    <div class="col-sm-3 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#">Goods delivery - nonperishable  &nbsp;<span><input type="checkbox" id="finObjOfInv3" name="finObjOfInv" value="Goods delivery - nonperishable"></span></a></div>
                            ...
                            <div class="">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="content_table">
                                    <thead>
                                        <tr>
                                            <th style="width:20px">
                                                <fmt:message key='s.myinvoice.delisted.table.thead' />
                                            </th>
                                            <th style="width:40px">
                                                <fmt:message key='s.myinvoice.delisted.table.thead1' />
                                            </th>
                                            <th style="width:60px">
                                                <fmt:message key='s.myinvoice.delisted.table.thead2' />
                                            </th>
                                            <th style="width:60px">
                                                <fmt:message key='s.myinvoice.delisted.table.thead3' />
                                            </th>
                                            <th style="width:100px">
                                                <fmt:message key='s.myinvoice.delisted.table.thead4' />
                                            </th>
                                            <th style="width:180px">
                                                <fmt:message key='s.myinvoice.delisted.table.thead5' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='s.myinvoice.delisted.table.thead6' />
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='s.myinvoice.delisted.table.thead7' />
                                            </th>
                                            <th style="width:60px">
                                                <fmt:message key='s.myinvoice.delisted.table.thead8' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='s.myinvoice.delisted.table.thead9' /> 
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='s.myinvoice.delisted.table.thead10' />
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <a href="javascript:;" target="main-iframe">
				                          	    <button type="button" class="btn-small btn-info btn-circle" onclick="window.open('${base}/seller/invoice/delistedboth/biddhistory/${item.id}');"><i class="fa fa-list"></i></button>
				                          	  </a>
                                            </td>
                                            <td>
                                              <fmt:formatDate value='${item.delistingDate}' pattern='MM/dd/yyyy'/>
                                            </td>
                                            <td>
                                              <a href="${base}/seller/invoice/settledundisbursed/detail/${item.id}">
                                               	${item.finStickerId}
			                           	      </a>  
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                              <a href="${base}/seller/profile/debtor">
				                          	    ${item.debtorName}
				                           	  </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <fmt:formatDate value='${item.finInvIssDate}' pattern='MM/dd/yyyy'/> 
                                            </td>
                                            <td>
        ...
        jQuery(document).ready(function () {
            ...
            $('#content_table').DataTable({
                ...
                pagerSettings: {
                 ...
                 sAjaxSource: app.base + '/seller/invoice/delisted/list',
                ...
                "aoColumns":[ 
                             ...
                             /*       $('td:eq(9)', nRow).html("<a href='' user_id='" + aData.user_id + "' class='ace_detail'>详情</a>");
                                   if (aData.status != 1 && aData.status != 4 && aData.active == 0) { */
                                 	  var fDate=new Date(aData.finInvIssDate);
                                 	  var eDate=new Date(aData.endDate);
                                 	  var td0 = nRow._DT_RowIndex+1;
                                 	  var td1 = "<a href='${base}/seller/invoice/delistedboth/biddhistory/"+aData.id+"' target='main-iframe'><button type='button' class='btn-small btn-info btn-circle'>    <i class='fa fa-list'></i>"
                                                  +"</button></a>";
                                      var td2 =  eDate.Format('MM/dd/yyyy');
                                      var td3 = "<a href='${base}/seller/invoice/settledundisbursed/detail/"+aData.id+"'> "+aData.finStickerId+" </a>";
                                      var td4 =  decimalInputFormatFunc(aData.finInvAmount)+"&nbsp;VND";
                                      var td5 = "<a href='${base}/seller/profile/debtorById/"+aData.id+"'> "+aData.debtorName+" </a>";
                                      var td6 =  aData.finObjOfInv;
                                      var td7 =  aData.flowOpinion;
                                      var td8 =  fDate.Format('MM/dd/yyyy');
                                      var saccanoffrtsienaatbrtf = aData.finInvAmount*aData.bestBuyerAdv/100*0.015;
                                      var saccanoffrtsienaatbr = aData.finInvAmount*aData.bestBuyerAdv/100-saccanoffrtsienaatbrtf;
                                      var td9 = decimalInputFormatFunc(saccanoffrtsienaatbr)+"&nbsp;VND";
                                      var interval = aData.finExpPmtDate - aData.startDate;
                                      var days1 = interval/1000/60/60/24;
                                      var days2 = decimalInputFormatFunc(days1-2);
                                      var saccanoffrtsieraasif = aData.finInvAmount*aData.bestBuyerAdv/100*aData.bestBuyerInt/100*(days2/360);
                                      var saccanoffrtsieraas = aData.finInvAmount-aData.finInvAmount*aData.bestBuyerAdv/100-saccanoffrtsieraasif;
                                      var td10 = decimalInputFormatFunc(saccanoffrtsieraas)+"&nbsp;VND";
