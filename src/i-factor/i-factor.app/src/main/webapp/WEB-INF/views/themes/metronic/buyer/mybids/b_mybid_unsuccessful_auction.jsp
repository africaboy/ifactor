...
<body class="page-header-fixed page-quick-sidebar-over-content">
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
          <form class="form-inline" action="${base}/buyer/bid/unsuccessful"  id="formQuery" name="formQuery"  method="post" role="form">
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"><fmt:message key='buyer.mybid.unsuccessful.page.header.disbursedAuction' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='buyer.mybid.unsuccessful.page.title.myBids' />&nbsp;&nbsp;&nbsp;<span id="invoiceNum"></span></b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.market.list.page.auctionStatus' />:&nbsp;</b><span style="color: #d64635"><b><fmt:message key='buyer.mybid.unsuccessful.page.Status' /></b>&nbsp;<i class="icon-lock"></i>&nbsp;&nbsp;<fmt:message key='buyer.mybid.unsuccessful.page.statusExplain' />.</span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                <div class="clearfix">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xs-6 text-right"><a href="#" id="toggle_link" class="if_toggle if_show" onclick="toggle('More&nbsp;&nbsp;', 'Less&nbsp;&nbsp;','col-sm-offset-5 col-sm-1 col-xs-12 text-right','col-sm-offset-5 col-sm-1 col-xs-12 text-right');">More&nbsp;&nbsp;<i class="icon-arrow-down"></i></a></div>
                            </div>
                            <div class="row">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:100px" class="if-tooltip">
                                                <a  data-toggle="tooltip white" data-original-title="Ready to sell advance" style="color:white"><fmt:message key='buyer.mybid.unsuccessful.page.table.th.rtsa' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='seller.myinvoice.dealed.page.panel.body.acceptedAdvance' />
                                            </th>
                                            <th style="width:100px" class="if-tooltip">
                                                <a  data-toggle="tooltip white" data-original-title="Your best offered advance" style="color:white"><fmt:message key='buyer.mybid.unsuccessful.page.table.th.yboa' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width: 100px" class="if-tooltip">
                                                <a  data-toggle="tooltip white" data-original-title="Ready to sell interest" style="color:white"><fmt:message key='buyer.mybid.unsuccessful.page.table.th.rtsi' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='seller.myinvoice.dealed.page.panel.body.acceptedInterest' /> 
                                            </th>
                                            <th style="width:100px" class="if-tooltip">
                                                <a  data-toggle="tooltip white" data-original-title="Your best offered interest" style="color:white"><fmt:message key='buyer.mybid.unsuccessful.page.table.th.yboi' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:20px">
				                        ...
				                        <tr>
				                          ...
				                          <td>
				                            <a href="javascript:;" target="main-iframe">
		                          	          <button type="button" class="btn-small btn-info btn-circle" onclick="window.open('${base}/buyer/auction/unsuccessful/biddhistory/${item.id}');">
                                                <i class="fa fa-list"></i>
                                              </button>
				                            </a>
				                          </td>
				                          <td><fmt:formatDate value='${item.invoice.endDate}' pattern='MM/dd/yyyy'/></td>
				                          <td>
				                          	<a href="${base}/buyer/auction/unsuccessful/detail/${item.invoice.id}">
				                          ...
				                          <td>${item.invoice.readyToSellAdv}%</td>
				                          <td>${item.invoice.bestBuyerAdv }%</td>
				                          <td>${item.invoice.advance}%</td>
				                          <td>${item.invoice.readyToSellInt }%</td>
				                          <td>${item.invoice.curBestOffrInt }%</td>
				                          <td>${item.invoice.interest }%</td>
				                          <td>${item.invoice.noOfOffers}</td>
				                        </tr>
				                      </c:forEach>
				                      </c:if>
                                    </tbody>
