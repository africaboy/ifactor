    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content if-detail-auction-content">
                ...
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.myinvoice.detail.modification.page.invoiceStatus' />:  </b><span style="color:green"><b><fmt:message key='buyer.view.page.Status' /></b></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
