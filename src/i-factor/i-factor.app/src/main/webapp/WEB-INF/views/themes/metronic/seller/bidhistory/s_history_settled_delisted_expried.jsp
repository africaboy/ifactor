            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                  <ul class="page-breadcrumb">
                    ...
                    <li>
                      <a href="#"> <fmt:message key='invoice.list.thead.biddinghistory' /> </a>
                    </li>
                  </ul>
                </div>
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.history.delisted.both.page.auctionStatus' />:  <span style="color: #d64635"><fmt:message key='seller.history.delisted.both.page.closed' />  <i class="icon-lock"></i></span></b><span style="padding-left: 20px; font-weight: bold"><fmt:message key='seller.history.delisted.expried.page.reason' /></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                    ...
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDueDate" value="12/12/2014">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='s.myinvoice.delisted.table.thead9' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtDisbursementdate" value="100,000,000 VND">
                                </div>
                            </div>
                        </div>
                    </div>
