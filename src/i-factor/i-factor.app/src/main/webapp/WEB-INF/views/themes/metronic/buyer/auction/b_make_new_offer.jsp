...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li>
      <a href="javascript:;"><fmt:message key='b.make.new.offer.page.new.tbreadcrumb2' /></a>
    </li>
  </ul>
</div>
<h5 class="page-title">
  <b><fmt:message key='b.make.new.offer.page.title' /> ${invoice.id}</b>
</h5>
        ...
        <div class="col-sm-12">
          <div class="if-detail-block" id="RTSDetail">
            ...
            <div style="float: left; padding-top: 10px;position: relative; max-width: 95%; padding-left: 20px">
              <div id="newoffrtsitatbt" style="margin-bottom: 10px">
                
              </div>
              <div id="newoffrtsietraas" style="margin-bottom: 10px">
                
              </div>
              <div id="newoffrtsienras" style="margin-bottom: 10px">
...
<div class="clearfix">
  ...
  <span class="if-panel-next_to"><a href="${base}/buyer/auction/newoffer/biddhistory/${invoice.id}">&gt;&gt;&gt; <fmt:message key='b.make.new.offer.page.history' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
  <div class="panel panel-success">
    <div class="panel-body">
      <div class="row">
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.make.new.offer.page.tab2.field1' /></a></div>
...
<div class="clearfix">
  <div class="if-panel-head if-panel-green">
    <fmt:message key='b.make.new.offer.page.tab4' />
  </div>
  <div class="panel panel-success">
    <div class="panel-body">
      <div class="row">
        ...
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.make.new.offer.page.tab2.field1' /></a></div>
        <div class="col-sm-2 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="youoffadvance1" value="${advance}&nbsp;%">
          <input type="hidden" id="youoffadvance" value="${advance}">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.make.new.offer.page.tab2.field2' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="youoffinterest1" value="${interest}&nbsp;%"></span>
          <input type="hidden" id="youoffinterest" value="${interest}">
        </div>
        <div class="col-sm-4 col-xs-12 if-div-input-sm">
          <a class="if-view-detail" href="javascript:;" id="MAOToggle" onclick="toggleDetail('<fmt:message key='b.make.new.offer.page.finance' />&nbsp;&nbsp;','<fmt:message key='b.make.new.offer.page.finance.hide' />&nbsp;&nbsp;','#MAOToggle', '#MAODetail');"><fmt:message key='b.make.new.offer.page.finance' />&nbsp;&nbsp;<i class="icon-arrow-down"></i></a>
        </div>
        <div class="col-sm-12">
          <div class="if-detail-block" id="MAODetail">
            <div style="float: right; padding-top: 10px;padding-right: 10px; width: 30px">
              <a onclick="toggleDetail('<fmt:message key='b.make.new.offer.page.finance' />&nbsp;&nbsp;','<fmt:message key='b.make.new.offer.page.finance.hide' />&nbsp;&nbsp;','#MAOToggle', '#MAODetail');"><i class="icon-close"></i></a>
            </div>
            <div style="float: left; padding-top: 10px;position: relative; max-width: 95%; padding-left: 20px">
              <div id="newoffyotatbt" style="margin-bottom: 10px">
                
              </div>
              <div id="newoffyoetraas" style="margin-bottom: 10px">
                
              </div>
              <div id="newoffyoenras" style="margin-bottom: 10px">
        ...
        <div class="col-sm-12 text-center" style="margin-top: 10px">
          <a href="#panel_make_offer" class="btn if-detail-btn-group if-btn-medium" onclick="if($('#panel_make_offer').css('display') == 'none')$('#panel_make_offer').css('display','block');if($('#panel_make_offer').css('display') == 'block')$('html,body').animate({scrollTop:$(this.hash).offset().top}, 500);" id="btn_make_offer" >
            <fmt:message key='b.make.new.offer.page.makeBtn' />
          </a>
        </div>
        <!-- Row 2 -->
      </div>
...
<!-- End your offer -->
<!-- Begin make a new offer -->
<div class="clearfix" style="display: none" id="panel_make_offer">
  <div class="if-panel-head if-panel-green">
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="if-detail-block" id="MNODetail">
            ...
            <div style="float: left; padding-top: 10px;position: relative; max-width: 95%; padding-left: 20px">
              <div id="newoffmaotatbt" style="margin-bottom: 10px">
                
              </div>
              <div id="newoffmaoetraas" style="margin-bottom: 10px">
                
              </div>
              <div id="newoffmaoenras" style="margin-bottom: 10px">
...
<script src="${base}/static/themes/metronic/js/ifactormakenewoffer.js"></script>
