            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended last">
                        <a href="${base}/buyer/bid/delisted" class="dropdown-toggle if-logout">
            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"> <fmt:message key='buyer.mybid.detail.delisted.both.page.header.delistedAuction' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                ...
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.history.delisted.both.page.auctionStatus' />:  </b><span style="color: #d64635"><b><fmt:message key='seller.history.delisted.both.page.closed' /></b> <i class="icon-lock"></i>&nbsp;&nbsp;<fmt:message key='seller.history.delisted.expried.page.reason' /></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="clearfix">
                    ...
                    <span class="if-panel-next_to"> <a href="${base}/buyer/auction/delistedexpried/biddhistory">&gt;&gt;&gt; <fmt:message key='seller.myinvoice.detail.delisted.both.page.viewBiddingHistory' />&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
