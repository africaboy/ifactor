    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <h5 class="page-title">
                    <small><span><b><fmt:message key='buyer.update.page.date' />: </b>  &nbsp; <fmt:formatDate value='${buyerApply.submissionDate}' pattern='MM/dd/yyyy'/>  </span></small>                    
                </h5>
                <h5 class="page-title">
                    <small><b><span><fmt:message key='buyer.update.page.status' />:  &nbsp;</span> <span style="color:#ffac00"> <fmt:message key='buyer.update.page.Status' /> </span></b></small>                  
                </h5>

                <h5 class="page-title">
                    <small><span><b><fmt:message key='buyer.update.page.deadline' />: </b> &nbsp; <span style="color:#ff0000"> <fmt:formatDate value='${buyerApply.deadLineDate}' pattern='MM/dd/yyyy'/>   </span></small>
                </h5>
                                        ...
                                        <div class="form-body">
                                                ...
                                                <li>
                                                    <a href="#tab1" data-toggle="tab" class="step">
                                                      <a href="javascript:void(0)" class="step" id="table1">
                                                        ...
                                                        <div class="desc">
                                                            <i class="fa fa-check"></i> <fmt:message key='buyer.apply.tab.opinion' />
                                                        </div>
                                                      </a>
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <a href="#tab4" data-toggle="tab" class="step active">
                                                      <a href="javascript:void(0)" class="step" id="table4">
                                                        ...
                                                        <div class="desc">
                                                            <i class="fa fa-check"></i> <fmt:message key='buyer.apply.tab.documents' />
                                                        </div>
                                                      </a>
                                                    </a>
                                                </li>
                                            ...
                                            <div class="tab-content">
                                                <div class="step-title">
                                                    <fmt:message key='bp.update.application.opinion.modification.request2' />
                                                </div>
                                                ...
                                                <!--Begin tab1:Opinion on modification request-->
                                                    ...
                                                    <div class="tab-pane" id="tab2">
                                                    	<form class="form-horizontal" id="form-personal-info" method="post"
	                                                        ...
	                                                        <div class="form-group if-form-group-sm">
	                                                            ...
	                                                            <div class="col-md-3">
										                         <c:choose>
																	<c:when test="${(not fn:contains(modifyFields,'&title&') && isModifyStatus) || !isModifyStatus}">
																	<input type="text" class="form-control if-input-sm if-div-input-md" id="title" name="title" value="${buyerApply.title}"  disabled="disabled" />
																	</c:when>
																	<c:otherwise>
																	<select class="form-control if-input-sm if-div-input-md" id="title" name="title" data-rule-required="true" data-msg-required="<fmt:message key='buyer.register.form.field.title.required'/>">
																		<option value=""></option>
	                                                            ...
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" name="firstName" id="firstName" value="${buyerApply.firstName}" <c:if test="${(not fn:contains(modifyFields,'&firstName&') && isModifyStatus)||!isModifyStatus}">disabled="disabled"</c:if> />
	                                                            </div>
	                                                        ...
	                                                        <div class="form-group if-form-group-sm">
	                                                            ...
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" name="lastName" id="lastName" value="${buyerApply.lastName}"  <c:if test="${(not fn:contains(modifyFields,'&lastName&') && isModifyStatus)||!isModifyStatus}">disabled="disabled"</c:if>>
	                                                            </div>
	                                                            <div class="control-label col-md-2" <c:if test="${fn:contains(modifyFields,'&email&') && isModifyStatus}">style="color: #ff0000;"</c:if>> 
	                                                                <fmt:message key='buyer.register.form.field.email' /><span class="required">*</span>
	                                                            </div>
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" id="email" name="email" value="${buyerApply.email}" disabled="disabled"
	                                                                <c:if test="${not fn:contains(modifyFields,'&email&') && isModifyStatus}">readonly</c:if> />
	                                                            </div>
	                                                            <div class="col-md-offset-1"></div>
	                                                        </div>
	                                                        <div class="form-group if-form-group-sm">
	                                                            ...
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" id="investAs" name="investAs" disabled="disabled" value="${buyerApply.investAs}"
	                                                                <c:if test="${not fn:contains(modifyFields,'&investAs&') && isModifyStatus}">readonly</c:if> >
	                                                            </div>
	                                                        ...
	                                                        <div class="form-group if-form-group-sm">
	                                                            ...
	                                                            <div class="col-md-3 if-input-md">
																	...
																	<c:when test="${not fn:contains(modifyFields,'&dob&') && isModifyStatus}">
																		<input type="text" class="form-control if-input-sm if-div-input-md" id="dobRead" name="dobRead" value="<fmt:formatDate value='${buyerApply.dob}' pattern='MM/dd/yyyy'/>"   readonly>
																	</c:when>
																	<c:otherwise>
																		<input type="text" value="<fmt:formatDate value='${buyerApply.dob}' pattern='MM/dd/yyyy'/>" class="form-control if-input-sm if-div-input-md date-picker" 
																		id="dob" name="dob" autocomplete="off" 
																		data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.dob.required'/>" 
																		data-rule-isBeforeToday="true" data-msg-isBeforeToday="<fmt:message key='buyer.apply.form.field.dob.isBeforeToday'/>" 
																		data-rule-isAdult="true" data-msg-isAdult="<fmt:message key='buyer.apply.form.field.dob.isAdult'/>" 
																		...
																		data-msg-pattern="<fmt:message key='buyer.apply.form.field.dob.pattern'/>" readonly />
	                                                        ...
	                                                        <div class="form-group if-form-group-sm">
	                                                            ...
	                                                            <div class="col-md-3">
																	...
																	<c:if test="${not fn:contains(modifyFields,'&idNumber&') && isModifyStatus}">disabled="disabled"</c:if>>
	                                                            </div>
	                                                            ...
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" style="display: inline-block; max-width: 20%;float: left"  value="${buyerApply.workCountryCode}"   data-rule-pattern="^\+?[0-9]{2,4}$"   data-msg-pattern="<fmt:message key='buyer.apply.form.field.workCountryCode.pattern'/>"  <c:if test="${(not fn:contains(modifyFields,'&workCountryCode&') && isModifyStatus)||!isModifyStatus}">disabled="disabled"</c:if>  />
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" style="display: inline-block; max-width: 79%;float: right" value="${buyerApply.phone}" data-rule-required="false" data-rule-pattern="^[0-9]{5,15}$" 	data-msg-pattern="<fmt:message key='seller.apply.form.field.workPhone.pattern'/>"  <c:if test="${(not fn:contains(modifyFields,'&phone&') && isModifyStatus)||!isModifyStatus}">disabled="disabled"</c:if>/>
	                                                            </div>
	                                                            <div class="col-md-offset-1"></div>
	                                                        </div>
	                                                        <div class="form-group if-form-group-sm">
	                                                            ...
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md"  style="display: inline-block; max-width: 20%;float: left"id="mobileCountryCode" name="mobileCountryCode" value="${buyerApply.mobileCountryCode}"  data-rule-pattern="^\+?[0-9]{2,4}$"   data-msg-pattern="<fmt:message key='buyer.apply.form.field.mobileCountryCode.pattern'/>" <c:if test="${(not fn:contains(modifyFields,'&mobileCountryCode&') && isModifyStatus)||!isModifyStatus}">disabled="disabled"</c:if>>
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" style="display: inline-block; max-width: 79%;float: right" id="mobilePhone"   name="mobilePhone" value="${buyerApply.mobilePhone}"    data-rule-pattern="^[0-9]{5,15}$" 	data-msg-pattern="<fmt:message key='seller.apply.form.field.workPhone.pattern'/>"   <c:if test="${(not fn:contains(modifyFields,'&mobilePhone&') && isModifyStatus)||!isModifyStatus}">disabled="disabled"</c:if>/>
	                                                            </div>
	                                                        </div>
                                                        </form>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane" id="tab3">
	                                                    <form class="form-horizontal" id="form-further-details" method="post" enctype="multipart/form-data">
	                                                        <!-- row 1 -->
	                                                        <div class="form-group if-form-group-sm">
	                                                            <div class="control-label col-md-2 col-md-offset-1 if-control-label-md" <c:if test="${fn:contains(modifyFields,'&residenceAddress&')  && isModifyStatus}">style="color: #ff0000;"</c:if>> 
	                                                                <fmt:message key='buyer.apply.form.field.residenceAddress' /> <span class="required">*</span>
	                                                            </div>
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" id="residenceAddress" name="residenceAddress" data-rule-required="true"  maxlength="255" value="${buyerApply.residenceAddress}"  data-msg-required="<fmt:message key='buyer.apply.form.field.residenceAddress.required'/>"
																	<c:if test="${not fn:contains(modifyFields,'&residenceAddress&') && isModifyStatus}">disabled="disabled"</c:if>>
	                                                            </div>
	                                                            <div class="control-label col-md-3" <c:if test="${fn:contains(modifyFields,'&district&')  && isModifyStatus}">style="color: #ff0000;"</c:if>> 
	                                                                <fmt:message key='buyer.apply.form.field.district' /><span class="required">*</span>
	                                                            </div>
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" d="district" name="district" data-rule-required="true" maxlength="255" value="${buyerApply.district}" data-msg-required="<fmt:message key='buyer.apply.form.field.district.required'/>"
																	<c:if test="${not fn:contains(modifyFields,'&district&') && isModifyStatus}">disabled="disabled"</c:if>>
	                                                            </div>
	                                                        </div>
	                                                        <!-- row 2 -->
	                                                        <div class="form-group if-form-group-sm">
	                                                            ...
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" id="city" name="city" data-rule-required="true"  maxlength="255" value="${buyerApply.city}" data-msg-required="<fmt:message key='buyer.apply.form.field.city.required'/>"
																	<c:if test="${not fn:contains(modifyFields,'&city&') && isModifyStatus}">disabled="disabled"</c:if>>
	                                                            </div>
	                                                            <div class="control-label col-md-3" <c:if test="${fn:contains(modifyFields,'&region&') && isModifyStatus}">style="color: #ff0000;"</c:if>>
	                                                                <fmt:message key='buyer.apply.form.field.region' /> <span class="required"></span>
	                                                            </div>
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" id="region"  maxlength="255" name="region" value="${buyerApply.region}"
																	<c:if test="${not fn:contains(modifyFields,'&region&') && isModifyStatus}">disabled="disabled"</c:if>>
	                                                            </div>
	                                                        </div>
	                                                        <!-- row 3 -->
	                                                        <div class="form-group if-form-group-sm">
	                                                            ...
	                                                            <div class="control-label col-md-3"  <c:if test="${fn:contains(modifyFields,'&employer&')  && isModifyStatus}">style="color: #ff0000;"</c:if>> 
	                                                                <fmt:message key='buyer.apply.form.field.employer' /> <span class="required">*</span>
	                                                            </div>
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" id="employer" name="employer" data-rule-required="true" maxlength="255" value="${buyerApply.employer}" data-msg-required="<fmt:message key='buyer.apply.form.field.employer.required'/>"
																	<c:if test="${not fn:contains(modifyFields,'&employer&') && isModifyStatus}">disabled="disabled"</c:if>>
	                                                            </div>
	                                                        </div>
	                                                        <!-- row 4 -->
	                                                        <div class="form-group if-form-group-sm">
	                                                            <div class="control-label col-md-3 if-control-label-md"  <c:if test="${fn:contains(modifyFields,'&employerName&')  && isModifyStatus}">style="color: #ff0000;"</c:if>> 
	                                                                <fmt:message key='buyer.apply.form.field.employerName' />
	                                                            </div>
	                                                            <div class="col-md-3">
	                                                                <input type="text" class="form-control if-input-sm if-div-input-md" id="employerName"  maxlength="255" name="employerName" value="${buyerApply.employerName}" 
																	<c:if test="${not fn:contains(modifyFields,'&employerName&') && isModifyStatus}">disabled="disabled"</c:if>>
	                                                            </div>
	                                                            <div class="control-label col-md-3" <c:if test="${fn:contains(modifyFields,'&priIndustry&')  && isModifyStatus}">style="color: #ff0000;"</c:if>>
	                                                                <fmt:message key='buyer.apply.form.field.comIndustry' />  <span class="required">*</span>
	                                                            </div>
	                                                            <div class="col-md-3">
	                                                            	<select class="form-control if-input-sm if-div-input-md" id="priIndustry" name="priIndustry" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.comIndustry.required'/>"
	                                                        ...
	                                                        <!-- row 5 -->
	                                                        <div class="form-group if-form-group-sm">
	                                                            <div class="control-label col-md-3 if-control-label-md"  <c:if test="${fn:contains(modifyFields,'&haveEverTradingOther&')  && isModifyStatus}">style="color: #ff0000;"</c:if>>
	                                                            ...
	                                                            <div class="control-label col-md-3"  <c:if test="${fn:contains(modifyFields,'&whatIsAsset&')  && isModifyStatus}">style="color: #ff0000;"</c:if>>
	                                                                <fmt:message key='buyer.apply.form.field.whatIsAsset' />  <span class="required">*</span>
	                                                            </div>
	                                                            <div class="col-md-3">
	                                                            	<select class="form-control if-input-sm if-div-input-md" id="whatIsAsset" name="whatIsAsset" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.whatIsAsset.required'/>"
																		<c:if test="${not fn:contains(modifyFields,'&whatIsAsset&') && isModifyStatus}">disabled=true</c:if>
																		<c:if test="${buyerApply.haveEverTradingOther=='No'}">disabled=true</c:if>>
																		<option value=""></option>
													        ...
													        <c:forEach var="question" items="${questions}" varStatus="status">
																...
																<c:if test="${idx%2 != 0}">
																	...
																	<div class="control-label col-md-3" <c:if test="${fn:contains(modifyFields,qname)  && isModifyStatus}">style="color: #ff0000;"</c:if>>
																		${question[self.i18n.question_qtext]}<span class="required">*</span>
																	</div>
																	<input type="hidden" name="questions[${idx}].qid" value="${question.id}" /> 
																	<input type="hidden" name="questions[${idx}].qname" value="${question.qname}" />
													        ...
													        <c:if test="${user.fromChannels == 'Introduced from BANK/ENTITY staff' }">
																<div class="control-label col-md-3" <c:if test="${fn:contains(modifyFields,'&whichBusFrom&')  && isModifyStatus}">style="color: #ff0000;"</c:if>>
                                                    ...
                                                    <!-- Begin tab4: Further details-->
                                                    <div class="tab-pane" id="tab4">
	                                                     <form class="form-horizontal" id="form-applicatntfile-info" 	method="POST" enctype="multipart/form-data">
	                                                        <div class="form-group if-form-group-sm">
	                                                            <div class="control-label col-md-offset-3 col-md-3 if-control-label-md" <c:if test="${fn:contains(modifyFields,'&idcard_applicant&')  && isModifyStatus}">style="color: #ff0000;"</c:if>>
	                                                                <fmt:message key='buyer.apply.form.field.identification'/><span class="required">*</span>
	                                                            </div>
	                                                            <div class="col-md-3" style="margin-top: 10px">
																	...
																	<div id="file-link-applicatntFile" class="filename">${self.doc1Link}</div>
