...
<body class="page-header-fixed page-quick-sidebar-over-content">
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
          <form class="form-inline" action="${base}/buyer/bid/finalclosed"  id="formQuery" name="formQuery"  method="post" role="form">        
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"> <fmt:message key='b.mybid.final.closed.auction.page.breadcrumb1' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='b.mybid.final.closed.auction.page.breadcrumb2' />&nbsp;&nbsp;&nbsp;<span id="invoiceNum"></span></b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='b.mybid.final.closed.auction.page.breadcrumb4' />:&nbsp;</b><span style="color: #d64635"><b><fmt:message key='b.mybid.final.closed.auction.page.breadcrumb5' /></b>&nbsp;<i class="fa fa-power-off"></i></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                <div class="clearfix">
                    <div class="panel panel-success">
                        <div class="panel-heading" style="padding: 5px 5px;">
                            <h3 class="if-panel-title bold"><fmt:message key='b.mybid.final.closed.auction.panel.success' /></h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-6 col-xs-6 text-left bold"><fmt:message key='b.mybid.final.closed.auction.panel.success1' /></div>
                                <div class="col-sm-6 col-xs-6 text-right"><a href="#" id="toggle_link" class="if_toggle if_show" onclick="toggle('More&nbsp;&nbsp;', 'Less&nbsp;&nbsp;','col-sm-offset-5 col-sm-1 col-xs-12 text-right','col-sm-offset-11 col-sm-1 col-xs-12 text-right');"><fmt:message key='b.mybid.final.closed.auction.panel.success2' />&nbsp;&nbsp;<i class="icon-arrow-down"></i></a></div>
                            </div>
                            <div class="row">                                
                                <!-- Begin Invoice Amount -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="#"><fmt:message key='b.mybid.final.closed.auction.panel.success3' /></a></div>
                                ...
                                <!-- End Invoice Amount -->                               
                                <div class="col-sm-12 col-xs-12 text-left bold if_filter_hidden"><fmt:message key='b.mybid.final.closed.auction.panel.success4' /></div>
                                <!-- Begin hidden fields -->
                                <!-- Begin  Settlement date  -->
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"> <fmt:message key='b.mybid.final.closed.auction.panel.success5' /> </a></div>
                                ...
                                <div class="col-sm-2 col-xs-12 text-left  if-div-input-sm if_filter_hidden"><a href="#"><fmt:message key='b.mybid.final.closed.auction.panel.success6' /></a></div>
                                <div class="col-sm-2 col-xs-12 if_filter_hidden">
                                ...
                                <div class="col-sm-offset-5 col-sm-1 col-xs-12 text-right" id="ifFilterButton">
                                    <button class="btn if-btn" type="submit"><fmt:message key='b.mybid.final.closed.auction.panel.success7' /></button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="">
                                <table class="table table-striped table-bordered table-hover" id="content_table">
                                    <thead>
                                        <tr>
                                            <th style="width:20px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead' />
                                            </th>
                                            <th style="width:60px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead1' />
                                            </th>
                                            <th style="width:60px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead2' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead3' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead4' />
                                            </th>
                                            <th style="width:60px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead5' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead6' />
                                            </th>
                                            <th style="width:250px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead7' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead8' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead9' />
                                            </th>
                                            <th style="width:80px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead10' />
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead11' />
                                            </th>
                                            <th style="width:100px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Total amount to be received" style="color:white"><fmt:message key='b.mybid.final.closed.auction.table.thead12' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:20px">
                                                <fmt:message key='b.mybid.final.closed.auction.table.thead13' />
                                            </th>
                                            <th style="width:100px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Net outstanding amount to be received" style="color:white"><fmt:message key='b.mybid.final.closed.auction.table.thead14' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
				                       ...
				                       <c:forEach var="item" items="${page.content}" varStatus="status">
                                        <tr>
                                            ...
                                            <td>
                                              <a href="#" style="color:#ffd800;" class="dialogbuyerfinal">
                                            ...
                                            <td>
                                              <a href="javascript:;" target="main-iframe">
			                          	        <button type="button" class="btn-small btn-info btn-circle" onclick="window.open('${base}/buyer/auction/finalclosed/biddhistory/${item.id}');"><i class="fa fa-list"></i></button>
			                              	  </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                               <a href="${base}/buyer/auction/finalclosed/detail/${item.invoice.id}">
                                            ...
                                            <td> &gt;${item.invoice.auctionStatus}</td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="#" class="dialogbuyersettlementtotal">&gt;${item.invoice.finInvAmount}</a>
                                            </td>
                                            <td>
                                                ${item.invoice.finInvAmount}
                                            </td>
