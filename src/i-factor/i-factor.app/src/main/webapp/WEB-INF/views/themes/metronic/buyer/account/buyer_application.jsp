    ...
    <div class="page-content">
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li>
            <a href="#"><fmt:message key='buyer.apply.page.title' /></a>
          </li>
        </ul>
      </div>
      <h5 class="page-title">
        <b><fmt:message key='buyer.apply.panel.applyhead' /></b>
      </h5>
      ...
      <div class="tab-pane active" id="tab1">
	      <form class="form-horizontal" id="form-personal-info" method="post" enctype="multipart/form-data">
	        ...
	        <div class="form-group if-form-group-sm">
	          ...
	          <div class="col-md-3">
	            <select id="gender" name="gender" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.gender.required'/>" class="form-control if-input-sm if-div-input-md" />
	              <option value=""></option>
	        ...
	        <div class="form-group if-form-group-sm">
	          ...
	          <div class="col-md-3">
	            <select id="nationality" name="nationality" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.nationality.required'/>" class="form-control if-input-sm if-div-input-md">
	         	  <option value=""></option>
	        ...
	        <div class="form-group if-form-group-sm">
	          ...
	          <div class="col-md-3">
	          <select id="residenceCountry" name="residenceCountry" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.residenceCountry.required'/>" class="form-control if-input-sm if-div-input-md">
	            <option value=""></option>
				<c:forEach var="item" items="${countryList}" varStatus="status">
					<option value="${item.code}">${item[self.i18n.catalog_name]}</option>
				</c:forEach>
	          ...
	          <div class="col-md-3">
	            <select id="idType" name="idType" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.idType.required'/>" class="form-control if-input-sm if-div-input-md">
	              <option value=""></option>
	        ...
	        <div class="form-group if-form-group-sm">
	          ...
	          <div class="col-md-3">
	            <input type="text" class="form-control if-input-sm if-div-input-md" id="idNumber" name="idNumber" placeholder="" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.idNumber.required'/>" data-rule-pattern="^[0-9a-zA-Z]{7,12}$" data-msg-pattern="<fmt:message key='buyer.apply.form.field.idNumber.pattern'/>">
	          </div>
	          <div class="control-label col-md-2">
	            <fmt:message key='buyer.apply.form.field.workPhone' />
	          </div>
	          <div class="col-md-3">
	            <input type="text" class="form-control if-input-sm if-div-input-md" style="display: inline-block; max-width: 20%;float: left" id="workCountryCode" name="workCountryCode" value="${user.workCountryCode}"   data-rule-pattern="^\+?[0-9]{2,4}$"   data-msg-pattern="<fmt:message key='buyer.apply.form.field.workCountryCode.pattern'/>"  
				<c:if test="${not empty user.workPhone}">readonly</c:if> /> 
	            <input type="text" class="form-control if-input-sm if-div-input-md" style="display: inline-block; max-width: 79%;float: right" id="phone" name="phone" value="${user.workPhone}" data-rule-required="false" data-rule-number="true" data-rule-pattern="^[0-9]{5,15}$" data-msg-pattern="<fmt:message key='buyer.apply.form.field.workPhone.pattern'/>" <c:if test="${not empty user.workPhone}"> readonly</c:if> />
	          </div>
	          <div class="col-md-offset-1"></div>
	        </div>
	        <div class="form-group if-form-group-sm">
	          ...
	          <div class="col-md-3">
	            <input type="text" class="form-control if-input-sm if-div-input-md"  style="display: inline-block; max-width: 20%;float: left" id="mobileCountryCode" name="mobileCountryCode" value="${user.mobileCountryCode}" readonly>
      ...
      <div class="tab-pane" id="tab2">
	      <form class="form-horizontal" id="form-further-details" method="post" enctype="multipart/form-data">
	        ...
	        <div class="form-group if-form-group-sm">
	          ...
	          <div class="col-md-3">
	            <input type="text" class="form-control if-input-sm if-div-input-md" id="residenceAddress" maxlength="255" name="residenceAddress" placeholder="" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.residenceAddress.required'/>">
	          </div>
	          <div class="control-label col-md-3">
	            <fmt:message key='buyer.apply.form.field.district' /><span class="required">*</span>
	          </div>
	          <div class="col-md-3">
	            <input type="text" class="form-control if-input-sm if-div-input-md" id="district" name="district" maxlength="255" placeholder="" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.district.required'/>">
	          </div>
	        </div>
	        <!-- row 2 -->
	        <div class="form-group if-form-group-sm">
	          ...
	          <div class="col-md-3">
	            <input type="text" class="form-control if-input-sm if-div-input-md" id="city" name="city" maxlength="255" placeholder="" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.city.required'/>">
	          </div>
	          <div class="control-label col-md-3">
	            <fmt:message key='buyer.apply.form.field.region' /> <span class="required"></span>
	          </div>
	          <div class="col-md-3">
	            <input type="text" class="form-control if-input-sm if-div-input-md" id="region" name="region" maxlength="255" placeholder="">
	          </div>
	        </div>
	        <!-- row 3 -->
	        <div class="form-group if-form-group-sm">
	          ...
	          <div class="col-md-3">
	            <input type="text" class="form-control if-input-sm if-div-input-md" id="employer" name="employer" maxlength="255" placeholder="" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.employer.required'/>">
	          </div>
	        </div>
	        <!-- row 4 -->
	        <div class="form-group if-form-group-sm">
	          ...
	          <div class="col-md-3">
	            <input type="text" class="form-control if-input-sm if-div-input-md" id="employerName"	maxlength="255" name="employerName" placeholder="">
	          </div>
	          ...
	          <div class="col-md-3">
	          	<select class="form-control if-input-sm if-div-input-md"  style="margin-top: 8px;" id="priIndustry" name="priIndustry" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.comIndustry.required'/>">
					<option value=""></option>
	        ...
	        <div class="form-group if-form-group-sm">
	          ...
	          <div class="col-md-3">
	          	<select class="form-control if-input-sm if-div-input-md"  style="margin-top: 6px;" id="haveEverTradingOther" name="haveEverTradingOther" data-rule-required="true" data-msg-required="<fmt:message key='buyer.apply.form.field.haveEverTradingOther.required'/>">
	            <option value=""></option>
          ...
          <div class="col-md-3 filediv">
			<span class="file-extend">
				<span class="fileinput-button" style="display:block;width:72px;height:20px;">
	                ...
	                <input type="file" class="if-input-sm if-div-input-md" id="applicatntFile" name="file" multiple> 
	                <input type="hidden" id="file-type-applicatntFile" name="fileType"
						value="${self.docBiztypePrefix}idcard_applicant" />
				</span>
			</span>
			<div id="file-link-applicatntFile" class="filename"><fmt:message key='buyer.apply.form.button.uploadFileTip'/></div>
        ...
        <div class="row">
          <div id="btnHandle" class="col-md-12 text-center">
            <a href="javascript:;" class="btn default button-previous" style=" margin-right: 3px">
              <fmt:message key='buyer.apply.form.button.back' /> </a>
...
<script src="${base}/static/libs/metronic/3.3.0/assets/global/plugins/select2/select2.min.js"></script>
