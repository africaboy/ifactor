    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content if-detail-auction-content">
                ...
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.history.delisted.both.page.auctionStatus' />:  </b><span style="color: #d64635"><b><fmt:message key='seller.history.delisted.both.page.closed' /></b>&nbsp;<i class="icon-lock"></i> &nbsp;</span><b><fmt:message key='seller.history.delisted.undisbursed.page.reason' /></b></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
