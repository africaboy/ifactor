...
<body class="page-header-fixed page-quick-sidebar-over-content">
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
          <form class="form-inline" action="${base}/buyer/bid/disbursed"  id="formQuery" name="formQuery"  method="post" role="form">
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"><fmt:message key='buyer.mybid.disbursed.page.header.disbursedAuction' /></a>
                        </li>
                    </ul>
                </div>
                <h5 class="page-title">
                    <b><fmt:message key='buyer.mybid.disbursed.page.title.myBids' />&nbsp;&nbsp;&nbsp;<span id="invoiceNum"></span></b>
                </h5>
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.market.list.page.auctionStatus' />:&nbsp;</b><span style="color: #d64635"><b><fmt:message key='buyer.mybid.disbursed.page.Status' /></b>&nbsp;<i class="icon-lock"></i>&nbsp;&nbsp;<fmt:message key='buyer.mybid.disbursed.page.statusExplain' />.</span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                <div class="clearfix">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-offset-5 col-sm-1 col-xs-12 text-right" id="ifFilterButton">
                                    <button class="btn if-btn" type="submit"><fmt:message key='seller.market.list.page.panel.button.apply' /></button>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:80px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title="Total paid advance amount" style="color:white"><fmt:message key='buyer.mybid.disbursed.page.table.th.tpam' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:100px">
                                                <fmt:message key='invoice.submit.form.field.finExpPmtDate' />
                                            </th>
                                            <th style="width:100px" class="if-tooltip">                                                
                                                <a data-toggle="tooltip white" data-original-title="Expected total receivable amount after settlement" style="color:white"><fmt:message key='buyer.mybid.disbursed.page.table.th.etraas' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                            <th style="width:100px" class="if-tooltip">
                                                <a data-toggle="tooltip white" data-original-title=" Expected net return after settlement" style="color:white"><fmt:message key='buyer.mybid.disbursed.page.table.th.ernas' />&nbsp;<i class="icon-question"></i></a>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
				                        ...
				                        <tr>
				                          ...
				                          <td>
				                            <a href="javascript:;" target="main-iframe">
				                          	  <button type="button" class="btn-small btn-info btn-circle" onclick="window.open('${base}/buyer/auction/disbursed/biddhistory/${item.id}');">
										        <i class="fa fa-list"></i>
										      </button>
				                            </a>
				                          </td>
				                          <td><fmt:formatDate value='${item.invoice.finInvIssDate}' pattern='MM/dd/yyyy'/></td>
				                          <td>
				                          	<a href="${base}/buyer/auction/disbursed/detail/${item.invoice.id}">
				                          	  ${item.invoice.finStickerId}
			                           	    </a>  
			                           	  </td>
				                          <td><fmt:formatNumber value="${item.invoice.finInvAmount}" type="number" />&nbsp;VND</td>
				                          <td>
				                          ...
				                          <td>${item.invoice.bestBuyerAdv}%</td>
				                          <td>${item.invoice.bestBuyerInt }%</td>
				                          <td>  </td>
				                          <td><fmt:formatDate value='${item.invoice.finExpPmtDate }' pattern='MM/dd/yyyy'/></td>
				                          <td>  </td>
				                          <td>  </td>
				                        </tr>
				                      </c:forEach>
