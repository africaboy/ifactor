    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content if-detail-auction-content">
                ...
                <h5 class="page-title">
                    <small><b>Auction status:  </b><span style="color: #d64635"><b>CLOSED - Delisted</b> <i class="icon-lock"></i>&nbsp;&nbsp;Reason: Expired</span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                    ...
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;">Interest (%)</a></div>
                                <div class="col-sm-2 col-xs-12 ">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtInterest" value="10%">
                                </div>
                                <!-- Row 2 -->
                            </div>
                        </div>
                ...
                <!-- End Your offer -->
                <!-- Begin  Market best offer -->
                <div class="clearfix">
                    <div class="if-panel-head if-panel-green">
                        Market best offer
                    </div>
                    <span class="if-panel-next_to"> <a href="b_history_delisted_expried.html">&gt;&gt;&gt; View bidding history&nbsp;&nbsp;<i class="icon-arrow-right"></i></a></span>
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
