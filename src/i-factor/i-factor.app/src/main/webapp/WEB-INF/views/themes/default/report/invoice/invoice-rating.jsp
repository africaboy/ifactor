...
<c:set target="${self}" property="title"><fmt:message key='report.aggregateInvoiceReportByInvoiceRating'/></c:set>
                      ...
                      <table class="table table-bordered">
                        <thead>
                          <tr style="background:#bdd6ee;">
                            <th><fmt:message key='report.invoice.thead.invoiceRating'/></th>
