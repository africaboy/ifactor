            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended last">
                        <a href="${base}/buyer/bid/finalclosed" class="dropdown-toggle if-logout">
            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#"> <fmt:message key='buyer.mybid.detail.final.closed.page.header.finalClosed' /></a>
                            <i class="fa fa-angle-right"></i>
                        </li>
                        <li>
                ...
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.history.delisted.both.page.auctionStatus' />:  </b><span style="color: #d64635"><b><fmt:message key='buyer.mybid.detail.final.closed.page.explaination' /></b> <i class="fa fa-power-off"></i></span></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                    ...
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txt overduedays" value="&gt;<fmt:formatDate value='${invoice.finExpPmtDate}' pattern='MM/dd/yyyy'/>">
                                </div>
                              
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.mybid.final.closed.auction.table.thead11' /></a></div>
                                <div class="col-sm-2 col-xs-12">
