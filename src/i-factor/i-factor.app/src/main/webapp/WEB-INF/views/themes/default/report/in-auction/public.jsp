...
<c:set target="${self}" property="title"><fmt:message key='report.linkTextInAuctionForPublic'/></c:set>
                      ...
                      <table class="table table-bordered">
                        <thead>
                          <tr style="background:#bdd6ee;">
                            ...
                            <th><fmt:message key='report.inAuction.thead.releasedDateForPublic'/></th>
