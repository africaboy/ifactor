            ...
            <div class="top-menu">
		      <ul class="nav navbar-nav pull-right">
		        ...
		        <li class="dropdown dropdown-extended last">
		          <a href="${base}/buyer/bid/dealed" class="dropdown-toggle if-logout">
            ...
            <div class="page-content if-detail-auction-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
				        <li>
				          <a href="#"><fmt:message key='buyer.history.mybid.dealed.auction.page.header.myBids' /></a>
				          <i class="fa fa-angle-right"></i>
				        </li>
				        <li>
				          <a href="#"><fmt:message key='buyer.history.mybid.dealed.auction.page.header.dealedAuction' /></a>
				          <i class="fa fa-angle-right"></i>
				        </li>
				        <li>
				          <a href="#"><fmt:message key='s.myinvoice.insettlement.table.thead2' /></a>
				        </li>
				      </ul>
                </div>
                <h5 class="page-title">
                ...
                <h5 class="page-title">
                    <small><b><fmt:message key='seller.history.delisted.both.page.auctionStatus' />:  <span style="color: #d64635"> <fmt:message key='buyer.history.mybid.dealed.auction.page.closed' /> <i class="icon-lock"></i></span>&nbsp;<fmt:message key='buyer.mybid.dealed.page.statusExplain' />.</b></small>
                </h5>
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                    ...
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <!-- Row 2 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='seller.market.list.page.panel.body.invoiceSellerID' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                ...
                <div class="clearfix">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-body">
                            <div class="row">
                                <!-- Row 1 -->
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.history.mybid.dealed.auction.page.advance' /></a></div>
                                <div class="col-sm-2 col-xs-12">
                                    <input type="text" class="form-control if-input-sm if-div-input-sm" readonly id="txtAdvance" value="${invoice.readyToSellAdv}">
                                </div>
                                <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.history.mybid.dealed.auction.page.interest' /></a></div>
                                <div class="col-sm-2 col-xs-12 ">
                ...
                <!-- Your offer (Accepted) -->
                <h5 class="page-title">
                  <small><b><fmt:message key='buyer.history.delisted.both.page.table.title' /></b></small>
                </h5>
                <div class="row">
                  <div class="col-md-12">
                      ...
                      <div class="">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="content_table">
                          ...
                          <tr>
                            ...
                            <th>
                              <fmt:message key='buyer.history.delisted.both.page.panel.th.expectedTotalAdvance' />
                            </th>
                            <th>
                              <fmt:message key='buyer.history.delisted.both.page.panel.th.expectedToatalReceivable' />
                            </th>
                            <th>
                              <fmt:message key='buyer.history.delisted.both.page.panel.th.expectedNetReturn' />
                            </th>
                          </tr>
                          </thead>
                          <tbody>
