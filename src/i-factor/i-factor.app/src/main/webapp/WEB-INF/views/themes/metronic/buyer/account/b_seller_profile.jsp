...
<!-- BEGIN PAGE HEADER-->
  <div class="page-bar">
    <ul class="page-breadcrumb">
      <li>
        <a href="javascript:;"><fmt:message key='buyer.seller.profile.page.header.invoice' /></a>
      </li>
    </ul>
  </div>
<h5 class="page-title">
  <b><fmt:message key='buyer.seller.profile.page.header.invoice' /></b>
</h5>
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
...
<div class="clearfix">
  ...
  <div class="panel panel-success">
    <div class="panel-body">
      <div class="row">
        <!-- Row 1 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.debtor.profile.page.table.th.invoiceSellerId' /></a></div>
        ...
        <div class="col-sm-6 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtCompanyIndustry" value="12345"></div>
        <!-- Row 2 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.seller.profile.page.panel.numberOfYears' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtExistenceYears" value="12">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-control-label-multiple-line"><a href="javascript:;"><fmt:message key='buyer.seller.profile.page.panel.averageInvoiceAmount' /></a></div>
        <div class="col-sm-2 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtCompanyName" value="Entrofine">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.seller.profile.page.panel.lastFiscal' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtLastFiscal" value="23">
        </div>
        <div class="clearfix"></div>
        <!-- Row 3 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.seller.profile.page.panel.lastTwo' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtLast2Fiscal" value="3333">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.seller.profile.page.panel.totalAsset' /></a></div>
        <div class="col-sm-2 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtTotalAsset" value="233">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.seller.profile.page.panel.totalEquity' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtCompanyAddress" value="22">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtRegistrationCountry" value="223">
        </div>
        <!-- Row 4 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.seller.profile.page.panel.profile/loss' /></a></div>
        <div class="col-sm-2 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtProfitLoss" value="1">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.seller.profile.page.panel.roa' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtROA" value="2">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.seller.profile.page.panel.roe' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtROE" value="99">
        </div>
        <div class="clearfix"></div>
      </div>
    </div>
...
<div class="clearfix">
  <div class="if-panel-head if-panel-blue">
    <fmt:message key='buyer.seller.profile.page.panel.title2' />
  </div>
  <div class="panel panel-success">
    <div class="panel-body">
      <div class="row">
        <!-- Row 1 -->
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.seller.profile.page.panel.lengthOfTrading' /></a></div>
        <div class="col-sm-2 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtLengthOftrading" value="2">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtUploadedInvTotal" value="12">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtSoldInvTotal" value="444">
        </div>
        <div class="clearfix"></div>
        <!-- Row 2 -->
        <div class="col-sm-2 col-xs-12 text-left if-control-label-multiple-line"><a href="javascript:;"><fmt:message key='buyer.debtor.profile.page.panel.question3' />?</a></div>
        <div class="col-sm-2 col-xs-12">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtSettledInvTotal" value="23">
        </div>
        ...
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtOutstandingInvTotal" value="56">
        </div>
        <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='buyer.seller.profile.page.panel.averageNumberOf' /></a></div>
        <div class="col-sm-2 col-xs-12 ">
          <input type="text" class="form-control if-input-sm if-div-input-sm if-control-label-multiple-line" readonly  id="txtAvgOverdueDays" value="2222">
        </div>
        <div class="clearfix"></div>
      </div>
    </div>
...
<!-- End general information -->
<h5 class="page-title">
  <b><fmt:message key='buyer.seller.profile.page.center.title' /></b>
</h5>
<div class="row">
  <div class="col-md-12">
