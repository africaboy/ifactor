    ...
    <div class="top-menu">
      <ul class="nav navbar-nav pull-right">
        ...
        <li class="dropdown dropdown-extended last">
          <a href="${base}/buyer/bid/disbursed" class="dropdown-toggle if-logout">
...
<div class="page-content-wrapper">
  <div class="page-content if-detail-auction-content">
    ...
    <h5 class="page-title">
      <small><b><fmt:message key='seller.history.delisted.both.page.auctionStatus' />:  <span style="color: #d64635"> <fmt:message key='buyer.mybid.disbursed.page.Status' /> <i class="icon-lock"></i></span>&nbsp;&nbsp;<fmt:message key='buyer.mybid.disbursed.page.statusExplain' />.</b></small>
    </h5>
    <!-- END PAGE HEADER-->
    <!-- BEGIN PAGE CONTENT-->
