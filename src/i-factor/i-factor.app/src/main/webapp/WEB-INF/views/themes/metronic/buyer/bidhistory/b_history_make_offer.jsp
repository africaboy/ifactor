  ...
  <div class="page-content if-detail-auction-content">
    ...
    <div class="page-bar">
      <ul class="page-breadcrumb">
        <li>
          <a href="#"><fmt:message key='b.history.make.offer.page.breadcrumb0' /></a>
          <i class="fa fa-angle-right"></i>
        </li>
        <li>
          <a href="#"><fmt:message key='b.history.make.offer.page.breadcrumb1' /></a>
          <i class="fa fa-angle-right"></i>
        </li>
        <li>
          <a href="#"><fmt:message key='b.history.make.offer.page.breadcrumb2' /></a>
        </li>
      </ul>
    </div>
    <h5 class="page-title">
    ...
    <h5 class="page-title">
      <small><b><fmt:message key='b.history.make.offer.page.breadcrumb4' />  <span style="color: green"><fmt:message key='b.history.make.offer.page.breadcrumb5' /> <i class="icon-lock-open"></i></span></b></small>
    </h5>
    <!-- END PAGE HEADER-->
    <!-- BEGIN PAGE CONTENT-->
    ...
    <div class="clearfix">
      <div class="if-panel-head if-panel-light-grey">
          <fmt:message key='b.history.make.offer.invoice.summary' />
      </div>
      <div class="panel panel-success">
        <div class="panel-body">
          <div class="row">
            <!-- Row 1 -->
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.make.offer.invoice.summary1' /></a></div>
            <div class="col-sm-2 col-xs-12">
                <div class="input-group if-tooltip">
                    ...
                    <span class="if-icon-addon" ><a href="/buyer/openauction/openDetail/makeOffer/${invoice.id}" data-toggle="tooltip" data-original-title="Make an offer" data-container="body"> <i class="fa fa-hand-o-right" style="color: green;"></i></a></span>
                </div>
            </div>
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.make.offer.invoice.summary2' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
            ...
            <!-- Row 2 -->
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.make.offer.invoice.summary3' /></a></div>
            <div class="col-sm-2 col-xs-12">
              <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtSellerID" value="${invoice.sellerId}">
            </div>
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.make.offer.invoice.summary4' /></a></div>
            <div class="col-sm-6 col-xs-12 ">
              <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtDetorID" value="${invoice.debtorName}">
            </div>
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.make.offer.invoice.summary5' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
              <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtObject" value="${invoice.finObjOfInv}">
            </div>
            <!-- Row 3 -->
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.make.offer.invoice.summary6' /></a></div>
            <div class="col-sm-2 col-xs-12">
            ...
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.make.offer.invoice.summary7' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
              <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtDelistDate" value="<fmt:formatDate value='${invoice.delistingDate}' pattern='MM/dd/yyyy'/>">
            </div>
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.make.offer.invoice.summary8' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
    ...
    <div class="clearfix">
      <div class="if-panel-head if-panel-blue">
        <fmt:message key='b.history.make.offer.ready.tosell.information' />
      </div>
      <div class="panel panel-success">
        <div class="panel-body">
          <div class="row">
            <!-- Row 1 -->
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.make.offer.ready.tosell.information1' /></a></div>
            <div class="col-sm-2 col-xs-12">
              <input type="text" class="form-control if-input-sm if-div-input-sm" readonly  id="txtAdvance" value="${invoice.readyToSellAdv}%">
            </div>
            <div class="col-sm-2 col-xs-12 text-left if-div-input-sm"><a href="javascript:;"><fmt:message key='b.history.make.offer.ready.tosell.information2' /></a></div>
            <div class="col-sm-2 col-xs-12 ">
    ...
    <h5 class="page-title">
      <small><b><fmt:message key='b.history.make.offer.bidding.history' /></b></small>
    </h5>
    <div class="row">
      <div class="col-md-12">
      ...
      <tr>
        <th style="width:20px">
          <fmt:message key='b.history.make.offer.bidding.history1' />
        </th>
        <th>
          <fmt:message key='b.history.make.offer.bidding.history2' />
        </th>
        <th style="width:120px">
          <fmt:message key='b.history.make.offer.bidding.history3' />
        </th>
        <th style="width:120px">
          <fmt:message key='b.history.make.offer.bidding.history4' />
        </th>
        <th>
          <fmt:message key='b.history.make.offer.bidding.history5' />
        </th>
        <th>
          <fmt:message key='b.history.make.offer.bidding.history6' />
        </th>
        <th>
          <fmt:message key='b.history.make.offer.bidding.history7' />
        </th>
      </tr>
      </thead>
      <tbody>
      ...
      <tfoot>
          ...
          <span><fmt:message key='b.history.make.offer.bidding.history8' /></span>
      </div>
      </div>
      </div>
    </div>
...
<div class="page-footer">
  <div class="page-footer-inner text-center">
    <fmt:message key='b.history.make.offer.bidding.history9' />
  </div>
