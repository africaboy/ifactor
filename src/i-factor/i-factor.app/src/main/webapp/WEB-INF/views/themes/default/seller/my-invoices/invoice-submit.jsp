...
<spring:eval var="finObjOfInvList"
	expression="@catalogService.findFinObjOfInv().children" />
<spring:eval var="countryList"
	expression="@catalogService.findCountry().children" />
<spring:eval var="readyToAdvList"
	expression="@catalogService.findReadyToAdv().children" />
<spring:eval var="readyToIntList"
	expression="@catalogService.findReadyToInt().children" />

<c:set target="${self}" property="docBiztypePrefix"><%=com.entrofine.ifactor.app.service.InvoiceDocService.BIZTYPE_PREFIX%></c:set>
<c:set target="${self}" property="title">
	<fmt:message key='invoice.submit.submitPage.title' />
</c:set>
...
<c:set target="${self.js}" property="main">
	...
	<script type="text/javascript"
		src="${base}/static/libs/jquery-validation/${version['jquery.validation']}/dist/jquery.validate.min.js"></script>
	<script type="text/javascript"
	...
	<script type="text/javascript"
		src="${base}/static/themes/default/js/Date.prototype.js"></script>
	<script type="text/javascript"
	...
	<script type="text/javascript"
		src="${base}/static/themes/default/js/seller/my-invoices/invoice-submit.js"></script>
</c:set>
	...
	<div class="form-content">
		<div class="tab-header clearfix">
			<div class="tab-header-title">
				<i></i> <span><fmt:message
						key='invoice.submit.submitPage.tabsTitle' /></span>
			</div>
			<ul class="nav nav-tabs pull-right" id="form-tab-header">
				<li class="active"><a href="#tab-seller-info" data-toggle="tab"><fmt:message
							key='invoice.submit.submitPage.tabSellerInfo.title' /></a></li>
				<li><a href="#tab-debtor-info" data-toggle="tab"><fmt:message
							key='invoice.submit.submitPage.tabDebtorInfo.title' /></a></li>
				<li><a href="#tab-financing-info" data-toggle="tab"><fmt:message
							key='invoice.submit.submitPage.tabFinanceInfo.title' /></a></li>
				<li><a href="#tab-readytosell-info" data-toggle="tab"><fmt:message
							key='invoice.submit.submitPage.tabReadyToSeller.title' /></a></li>
				<li><a href="#tab-documents" data-toggle="tab"><fmt:message
							key='invoice.submit.submitPage.tabDocuments.title' /></a></li>
				<li><a href="#tab-conditions" data-toggle="tab"><fmt:message
							key='invoice.submit.submitPage.tabTerms.title' /></a></li>
			</ul>
		</div>

		<div class="tab-content">
			<div class="tab-pane active" id="tab-seller-info">
				<form class="form-horizontal" id="form-seller-info" method="POST"
					enctype="multipart/form-data">
					<div class="form-group">
						<div class="col-sm-4 control-label">
							<h4>
								<fmt:message
									key='invoice.submit.submitPage.tabSellerInfo.header' />
							</h4>
						</div>
						<div class="col-sm-6">
							<input type="hidden" class="form-control" id="limitMin"
								name="limitMin" value="${limitMin}" readonly /> <input
								type="hidden" class="form-control" id="limitMax" name="limitMax"
								value="${limitMax}" readonly /> <input type="hidden"
								class="form-control" id="limitBalance" name="limitBalance"
								value="${limitBalance}" readonly />
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-4 control-label" for="sellerCompanyName"><fmt:message
								key='invoice.submit.form.field.sellerCompanyName' />: *</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="sellerCompanyName"
								name="sellerCompanyName" value="${sellerCompanyName}"
								readonly="readonly" />
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-4 control-label"><fmt:message
								key='invoice.submit.form.field.sellerRepresentedBy' />: *</label>
						<div class="col-sm-3">
							<input type="text" class="form-control"
								id="sellerRepresentedByTitle" name="sellerRepresentedByTitle"
								value="${user.title}" readonly />
						</div>
						<div class="col-sm-3">
							<input type="text" class="form-control"
								id="sellerRepresentedByName" name="sellerRepresentedByName"
			...
			<div class="tab-pane" id="tab-debtor-info">
				<form class="form-horizontal" id="form-debtor-info" method="POST"  enctype="multipart/form-data">
					<div class="form-group">
						<div class="col-sm-4 control-label">
							<h4>
								<fmt:message 		key='invoice.submit.submitPage.tabDebtorInfo.header' />
							</h4>
						</div>
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="debtorName"><fmt:message
								key='invoice.submit.form.field.debtorName' />: *</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="debtorName"
								name="debtorName" data-rule-required="true"
								data-msg-required="<fmt:message key='invoice.submit.form.field.debtorName.required'/>" />
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-4 control-label" for="debtorAddress"><fmt:message
								key='invoice.submit.form.field.debtorAddress' />: *</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="debtorAddress"
								name="debtorAddress" maxlength="255" data-rule-required="true"
								data-msg-required="<fmt:message key='invoice.submit.form.field.debtorAddress.required'/>" />
						</div>
					</div>

					<div class="form-group">
						<label for="district" class="col-sm-4 control-label"><fmt:message
								key='invoice.submit.form.field.district' />: *</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="district"
								name="district" maxlength="255" data-rule-required="true"
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="city" name="city"
								maxlength="255" data-rule-required="true"
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="postCode"
								name="postCode" data-rule-required="false"
								data-msg-required="<fmt:message key='seller.apply.form.field.comPostcode.required'/>"
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="debtorBizRegNo"><fmt:message
								key='invoice.submit.form.field.debtorBizRegNo' />: *</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="debtorBizRegNo"
								name="debtorBizRegNo" data-rule-required="true"
								data-msg-required="<fmt:message key='invoice.submit.form.field.debtorBizRegNo.required'/>"
								data-rule-pattern="^[0-9a-zA-Z]{8,12}$"
								data-msg-pattern="<fmt:message key='invoice.submit.form.field.debtorBizRegNo.pattern'/>">
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-4 control-label" for="debtorTaxCode"><fmt:message
								key='invoice.submit.form.field.debtorTaxCode' />: *</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="debtorTaxCode"
								name="debtorTaxCode" data-rule-required="true"
								data-msg-required="<fmt:message key='invoice.submit.form.field.debtorTaxCode.required'/>"
								data-rule-pattern="^[0-9a-zA-Z]{8,12}$"
			...
			<div class="tab-pane" id="tab-financing-info">
				<form class="form-horizontal" id="form-financing-info" method="POST"
					enctype="multipart/form-data">
					<div class="form-group">
						<div class="col-sm-4 control-label">
							<h4>
								<fmt:message
									key='invoice.submit.submitPage.tabFinanceInfo.header' />
							</h4>
						</div>
						<div class="col-sm-6"></div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="finStickerId"><fmt:message
								key='invoice.submit.form.field.finStickerId' />: *</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="finStickerId"
								name="finStickerId" data-rule-required="true" maxlength="6"
								data-msg-required="<fmt:message key='invoice.submit.form.field.finStickerId.required'/>"
								data-rule-pattern="^[0-9a-zA-Z]{6}$"
								data-msg-pattern="<fmt:message key='invoice.submit.form.field.finStickerId.pattern'/>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="serialNumInvoice"
								name="serialNumInvoice" data-rule-required="true" minlength="3"
								maxlength="12" data-msg-required="<fmt:message key='invoice.submit.form.field.serialNumInvoice.required'/>" />
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-4 control-label" for="finVatInvNo"><fmt:message
								key='invoice.submit.form.field.finVatInvNo' />: *</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="finVatInvNo"
								name="finVatInvNo" data-rule-required="true"
								data-msg-required="<fmt:message key='invoice.submit.form.field.finVatInvNo.required'/>"
								data-rule-pattern="^[0-9]{5,12}$"
								data-msg-pattern="<fmt:message key='invoice.submit.form.field.finVatInvNo.pattern'/>">
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-4 control-label" for="finInvIssDate"><fmt:message
								key='invoice.submit.form.field.finInvIssDate' />: *</label>
						<div class="col-sm-6">
							<div class="input-group">
								<input type="text" class="form-control" id="finInvIssDate"
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="finInvAmount"
								name="finInvAmount" data-rule-required="true"
								data-msg-required="<fmt:message key='invoice.submit.form.field.finInvAmount.required'/>"
								data-rule-pattern="^[0-9]{0,10}$"  maxlength="10"
								data-msg-pattern="<fmt:message key='invoice.submit.form.field.finInvAmount.pattern'/>">
					    </div>
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="finObjOfInv"><fmt:message
								key='invoice.submit.form.field.finObjOfInv' />: *</label>
						<div class="col-sm-6">
							<select id="finObjOfInv" name="finObjOfInv"
								data-rule-required="true"
								data-msg-required="<fmt:message key='invoice.submit.form.field.finObjOfInv.required'/>">
								<option value="">Please select...</option>
								<c:forEach var="item" items="${finObjOfInvList}"
									varStatus="status">
									<option value="${item.code}">${item[self.i18n.catalog_name]}</option>
								</c:forEach>
							</select>
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="finDueDateAccToCont"><fmt:message
								key='invoice.submit.form.field.finDueDateAccToCont' />: *</label>
						<div class="col-sm-6">
							<div class="input-group">
								<input type="text" class="form-control" id="finDueDateAccToCont"
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="finExpPmtDate"><fmt:message
								key='invoice.submit.form.field.finExpPmtDate' />: *</label>
						<div class="col-sm-6">
							<div class="input-group">
								<input type="text" class="form-control" id="finExpPmtDate"
					...
					<div class="form-group">
						<label class="col-sm-4 control-label" for="finRmngMatTerm"><fmt:message
								key='invoice.submit.form.field.finRmngMatTerm' />: *</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="finRmngMatTerm"
								name="finRmngMatTerm" data-rule-required="true"
			...
			<div class="tab-pane" id="tab-readytosell-info">
				<form class="form-horizontal" id="form-readytosell-info"
					method="POST" enctype="multipart/form-data">
					<div class="form-group">
						<div class="col-sm-4 control-label">
							<h4>
								<fmt:message
									key='invoice.submit.submitPage.tabReadyToSell.header' />
							</h4>
						</div>
						<div class="col-sm-6"></div>
					</div>
						...
						<div class="col-sm-3">
							<span class="btn btn-success fileinput-button"> <i
								class="icon-plus icon-white"></i> <span><fmt:message
										key='invoice.submit.form.button.addFile' /></span> <input type="file"
								id="docScanOfInv" name="file" multiple> <input
								type="hidden" id="file-type-docScanOfInv" name="fileType"
								value="${self.docBiztypePrefix}invoice_firstInvoice" />
							</span>
							<!-- 进度条 -->
							<div id="progress-docScanOfInv"
								class="progress progress-success progress-striped">
								<div class="bar"></div>
							</div>
							<!-- 已经上传的文件 -->
							<div id="file-link-docScanOfInv"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<span class="btn btn-success fileinput-button"> <i
								class="icon-plus icon-white"></i> <span><fmt:message
										key='invoice.submit.form.button.addFile' /></span> <input type="file"
								id="docScanOfCont" name="file" multiple> <input
								type="hidden" id="file-type-docScanOfCont" name="fileType"
								value="${self.docBiztypePrefix}invoice_secondInvoice" />
							</span>

							<!-- 进度条 -->
							<div id="progress-docScanOfCont"
								class="progress progress-success progress-striped">
								<div class="bar"></div>
							</div>
							<!-- 已经上传的文件 -->
							<div id="file-link-docScanOfCont"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<span class="btn btn-success fileinput-button"> <i
								class="icon-plus icon-white"></i> <span><fmt:message
										key='invoice.submit.form.button.addFile' /></span> <input type="file"
								id="docDlvryCnfm" name="file" multiple> <input
								type="hidden" id="file-type-docDlvryCnfm" name="fileType"
								value="${self.docBiztypePrefix}invoice_thirdInvoice" />
							</span>
							<!-- 进度条 -->
							<div id="progress-docDlvryCnfm"
								class="progress progress-success progress-striped">
								<div class="bar"></div>
							</div>
							<!-- 已经上传的文件 -->
							<div id="file-link-docDlvryCnfm"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<span class="btn btn-success fileinput-button"> <i
								class="icon-plus icon-white"></i> <span><fmt:message
										key='invoice.submit.form.button.addFile' /></span> <input type="file"
								id="docDebtorAckmt" name="file" multiple> <input
								type="hidden" id="file-type-docDebtorAckmt" name="fileType"
								value="${self.docBiztypePrefix}taxcode_deliveryConfirm" />
							</span>

							<!-- 进度条 -->
							<div id="progress-docDebtorAckmt"
								class="progress progress-success progress-striped">
								<div class="bar"></div>
							</div>
							<!-- 已经上传的文件 -->
							<div id="file-link-docDebtorAckmt"></div>
			...
			<div class="tab-pane" id="tab-conditions">
				<form class="form-horizontal" id="form-conditions" method="POST"
					enctype="multipart/form-data">
					...
					<div style="width: 99%; margin: 10px auto;">
						<div class="form-group">
							<div class="col-sm-10">
								...
								<label for="checkbox-agree1"> <fmt:message
										key='invoice.submit.form.terms.check.agree1' />
								</label>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-sm-10">
								...
								<label for="checkbox-agree2"> <fmt:message
										key='invoice.submit.form.terms.check.agree2' />
								</label>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-sm-10">
								...
								<label for="checkbox-agree3"> <fmt:message
										key='invoice.submit.form.terms.check.agree3' />
								</label>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-sm-10">
								...
								<label for="checkbox-agree4"> <fmt:message
										key='invoice.submit.form.terms.check.agree4' />
								</label>
							</div>
						</div>
					</div>
