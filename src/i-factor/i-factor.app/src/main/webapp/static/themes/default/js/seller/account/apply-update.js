$(function (){
    $('#saveApplication').click(function(e){
		...
		var url = app.base + '/seller/account/update?isCommit=false';
	...
	$('#submitApplication').click(function(e){
		...
		var formIds = ['form-personal-info','form-company-info','form-further-details','form-documents-hidden','form-terms-conditions']
		var formData = MergeFormData(formIds);
		var url = app.base + '/seller/account/update?isCommit=true';
	...
	/*$('#checkbox-accept,#checkbox-promise').click(function(e){
		if($('#checkbox-accept').is(':checked')&& $('#checkbox-promise').is(':checked')) {
	...
	$('#form-documents-hidden input[type=hidden]').bind('change input propertychange', function() {
	    alert($this.val());
	});
