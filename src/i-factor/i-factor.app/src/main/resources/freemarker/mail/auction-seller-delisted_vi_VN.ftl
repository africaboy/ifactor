<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Tiêu đề: Hóa đơn bị loại khỏi nền tảng</b>
  </div>
  <div>
    Gửi Quý khách,
  </div>
  <div style="background:#fff">
    ...
    Hóa đơn ID <000000> không được giao dịch thành công và sẽ bị loại khỏi nền tảng. Quý khách có thể tiếp tục tải lại hóa đơn này hoặc tải lên hóa đơn khác với điều kiện hạn mức còn lại lớn hơn giá trị hóa đơn 
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    <a href="${base}/seller/invoice/after-auction/detail/${auction.invoice.id}">Tới trạng thái hóa đơn </a>
  </div>
  <div>
