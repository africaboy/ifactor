<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff">
    ...
    The transaction of Invoice - ID <000000> has been settled successfully. You will receive remaining amount of invoice in 2 days. Please visit website EntroAuction for more detail
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    - Time of successful settlement: <br/>
    <a href="${base}/seller/invoice/after-auction/detail/${auction.invoice.id}">For more detail, click here </a> <br/>
  </div>
  <div>
