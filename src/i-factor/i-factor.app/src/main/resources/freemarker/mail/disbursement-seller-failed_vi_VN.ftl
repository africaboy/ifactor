<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff">
    ...
    Giao dịch của hóa đơn mã số <000000> không thành công. Xin vui lòng xem thông tin dưới đây để biết lí do. 
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    <a href="${base}/seller/invoice/after-auction/detail/${auction.invoice.id}">Thông tin chi tiết của hóa đơn tại </a> 
  </div>
  <div>
