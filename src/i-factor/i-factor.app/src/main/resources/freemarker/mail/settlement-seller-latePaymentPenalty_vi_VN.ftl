<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff">
    ...
    Hóa đơn mã số <000000> đã bị chậm thanh toán xx ngày, quý khách sẽ bị thu phí chậm trả và lãi suất tương ứng với số ngày chậm trả theo quy định trong hợp đồng. Vui lòng kiểm tra thông tin chi tiết tại website EntroAuction.
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    - Debtor: ${auction.invoice.debtorName} (Make sure we allow for debtor info input in the 1st place for auto generation) <br/>
    - Ngày tải lên:  <br/>
    - Ngày đáo hạn: <br/>
    - Hạn thanh toán: <br/>
    - Số ngày quá hạn: <br/>
