<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff">
    ...
    Quý khách đã đấu giá thành công hóa đơn ID <0000>. Xin vui lòng cung cấp chữ ký điện tử hoặc tới chi nhánh gần nhất để ký hợp đồng con. Giải ngân sẽ được hoàn tất trong vòng xx ngày kể từ ngày hợp đồng con được ký và hóa đơn gốc được xác thực. Hướng dẫn chi tiết sử dụng chữ ký điện tử và thủ tục ký hợp đồng con xin vui lòng tham khảo thông tin tại đường link bên dưới. 
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    <a href="${base}/buyer/closedauction/closedAuctionDetail/${auction.invoice.id}">Tới chi tiết thông tin hóa đơn </a><br/>
    <a href="${base}/buyer/closedauction/closedAuctionDetail/${auction.invoice.id}">Hướng dẫn chi tiết sử dụng chữ ký điện tử và thủ tục ký hợp đồng con </a><br/>
