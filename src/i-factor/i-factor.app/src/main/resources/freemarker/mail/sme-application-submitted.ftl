<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Title: Application successfully submitted</b>
  </div>
  <div>
    Dear Client,
  </div>
  <div style="background:#fff">
    ...
    Congratulation! Your account has been activated. We are checking the validity of the information you provided. We will send you our confirmation of your account via Email/SMS as soon as possible. 
  </div>
  <div>
