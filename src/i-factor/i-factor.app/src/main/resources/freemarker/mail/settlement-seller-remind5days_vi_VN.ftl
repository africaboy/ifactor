<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Tiêu đề: Nhắc nhở người mua hàng (1 ngày) </b>
  </div>
  <div>
    Gửi Quý khách,
  </div>
  <div style="background:#fff">
    ...
    Hóa đơn mã số <000000> của quý khách còn 1 ngày đến hạn thanh toán. Xin vui lòng thông báo cho người mua hàng để thanh toán hóa đơn trước ngày đáo hạn.
  </div>
  <div>
