<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Tiêu đề: Tải hóa đơn thành công</b>
  </div>
  <div>
    Gửi Quý khách,
  </div>
  <div style="background:#fff">
    ...
    Chúc mừng Quý khách. Hóa đơn đã được tải lên thành công.  Xin vui lòng gửi hóa đơn gốc về địa chị dưới đây muộn nhất trong vòng 2 ngày kể từ thời điểm này để quy trình giải ngân được thực hiện
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    •ID hóa đơn: ${invoice.id} <br />
    •Thời điểm tải lên: ${invoice.updateTime} <br />
    <a href="${base}/seller/invoice/under-approval/detail/${invoice.id}">Tới thông tin hóa đơn </a> <br />
    <a href="${base}">Cách thức hóa đơn được giao dịch </a> <br />
