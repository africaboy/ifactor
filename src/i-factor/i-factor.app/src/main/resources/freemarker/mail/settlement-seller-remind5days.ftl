<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Title: Reminding 5 days remaining</b>
  </div>
  <div>
    Dear Client,
  </div>
  <div style="background:#fff">
    ...
    Your Invoice - ID <000000>'s remaining day before due date is 5 working days. Please contact with your debtor to pay for the invoice before due date.   
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    <a href="${base}/seller/invoice/in-auction/detail/${auction.invoice.id}">Invoice status</a> 
  </div>
  <div>
