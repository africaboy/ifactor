<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Tiêu đề: Kích hoạt thành công chức năng đấu giá</b>
  </div>
  <div>
    Gửi Quý khách,
  </div>
  <div style="background:#fff">
    ...
    Chúc mừng Quý khách. Chức năng đấu giá của tài khoản của quý khách đã được kích hoạt. Quý khách có thể bắt đầu tải hóa đơn trực tuyến từ bây giờ.
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    <a href="${base}/seller/invoice/in-auction">Tới nền tảng </a>
  </div>
  <div>
