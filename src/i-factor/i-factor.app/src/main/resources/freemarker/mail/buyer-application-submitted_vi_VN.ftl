<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Tiêu đề: Hồ sơ được nộp thành công </b>
  </div>
  <div>
    Gửi Quý khách,
  </div>
  <div style="background:#fff">
    ...
    Tài khoản đăng kí của Quý khách đã được kích hoạt. Chúng tôi đang kiểm tra thông tin đăng ký của Quý khách. Chúng tôi sẽ thông báo về tính hợp lệ hoặc thông tin cần bổ sung tới Quý khách qua email & SMS trong thời gian sớm nhất.
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    <a href="${base}">Hướng dẫn sử dụng nền tảng EntroAuction</a>
  </div>
  <div>
