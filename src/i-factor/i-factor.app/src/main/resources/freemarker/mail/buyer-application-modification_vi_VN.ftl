<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff">
    ...
    Hồ sơ đăng ký nền tảng của Quý khách chưa hoàn thiện. Xin vui lòng click đường link dưới đây để bổ sung thông tin còn thiếu trong vòng 3 ngày.
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    <a href="${base}/buyer/account/update">Tới hồ sơ đăng ký </a> (To see specific reason)
  </div>
  <div>
