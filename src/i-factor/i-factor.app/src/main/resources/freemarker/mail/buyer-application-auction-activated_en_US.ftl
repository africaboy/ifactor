<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Title: Auction activation has been activated</b>
  </div>
  <div>
    Dear Client,
  </div>
  <div style="background:#fff">
    ...
    Congratulations! Your account's auction function has been activated. You can start trading invoices immediately! 
  </div>
  <div>
