<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Tiêu đề: Giao dịch của hóa đơn không thành công</b>
  </div>
  <div>
    Gửi Quý khách,
  </div>
  <div style="background:#fff">
    ...
    Giao dịch của hóa đơn mã số <000000> không thành công. Xin vui lòng xem thông tin phía dưới đây để biết lí do. 
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    Giá trị khớp: xxx <br/>
    Thời gian đấu giá thành công: xxx <br/>
    Lý do: <br/>
    •Hợp đồng con chưa được ký bởi ... <br/>
    Phí hủy giao dịch nhận được/phải trả: VND x00,000 <br/>
    <a href="${base}/buyer/closedauction/closedAuctionDetail/${auction.invoice.id}">Thông tin chi tiết của hóa đơn tại </a>  
  </div>
  <div>
