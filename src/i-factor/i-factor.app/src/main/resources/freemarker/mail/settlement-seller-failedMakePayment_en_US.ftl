<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff">
    ...
    Your Invoice - ID <000000> has reached due date but not paid by debtor. Please contact with your debtor to pay for the invoice or buy back the invoice within xx days. If the invoice is not paid or bought back, Bank/The Bank will consider to put you into watch list or not allow you to make any other transaction on EntroAuction
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    - Number of overdue days: <br/>
    - Please settle the invoice by: T+2 <br/>
