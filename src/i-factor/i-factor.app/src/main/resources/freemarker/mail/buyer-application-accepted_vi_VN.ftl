<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Tiêu đề: Chỉnh sửa thông tin hồ sơ</b>
  </div>
  <div>
    Gửi Quý khách,
  </div>
  <div style="background:#fff">
    ...
    Hồ sơ của Quý khách đã hợp lệ. <br />
    Quý khách vui lòng đến Trung tâm SME của Bank/The Bank để ký Thỏa thuận dịch vụ và nhận Gói cẩm nang hướng dẫn sử dụng nền tảng và thực hiện một số thủ tục cần thiết khác. Bộ phận CSKH của EntroAuction sẽ liên hệ với quý khách trong thời gian sớm nhất để thống nhất thời gian và địa điểm.
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    <a href="${base}/${role}/account/update">Tới hồ sơ đăng ký </a> (To see specific reason)
    ID khách hàng của quý khách: ${apply.buyerId} <br />
    <a href="${base}/branch/search">Đến chi nhánh Bank/The Bank  </a><br />
    <a href="${base}">Thỏa thuận dịch vụ sử dụng nền tảng EntroAuction </a>
  </div>
  <div>
