<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Tiêu đề: Hóa đơn được giải ngân thành công </b>
  </div>
  <div>
    Gửi Quý khách,
  </div>
  <div style="background:#fff">
    ...
    Hóa đơn số <000000> được giải ngân thành công. Xin vui lòng kiểm tra tài khoản hoặc liên hệ với bộ phận CSKH của EntroAuction nếu cần hỗ trợ.
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    Giá trị tài trợ: xxx <br/>
    Phí: xxx <br/>
    Giá trị giải ngân thực tế: xxx <br/>
