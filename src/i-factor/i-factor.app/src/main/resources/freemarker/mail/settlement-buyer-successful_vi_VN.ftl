<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff">
    ...
    Hóa đơn mã số  <000000> đã được thanh toán. Vui lòng kiểm tra thông tin chi tiết hóa đơn tại website EntroAuction.
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    Số tiền thanh toán: ${auction.invoice.finInvAmount} <br/>
    Ngày thanh toán: <br/>
    Số tài khoản: <br/>
