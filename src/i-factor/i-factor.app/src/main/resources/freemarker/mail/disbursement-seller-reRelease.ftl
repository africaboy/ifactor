<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Title: Re-release to auction</b>
  </div>
  <div>
    Dear Client,
  </div>
  <div style="background:#fff">
    ...
    Invoice <00000> has been released on the auction again. For more information, please check out the reason(s) stated below
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    Re-release reason(s): Transaction of your invoice has failed. <br/>
    <a href="${base}/seller/invoice/in-auction/detail/${auction.invoice.id}">To the Invoice detailed information </a>
  </div>
  <div>
