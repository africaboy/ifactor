<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Title: Successful disbursement </b>
  </div>
  <div>
    Dear Client,
  </div>
  <div style="background:#fff">
    ...
    Invoice ID <000000> is succesfully disbursed. Please check your account balance or contact EntroAuction CS team 
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    Gross financing amount: xxx <br/>
    Applicable fee: xxx <br/>
    Actual disbursement amount: xxx <br/>
    <a href="${base}/buyer/closedauction/closedAuctionDetail/${auction.invoice.id}">To the invoice status </a>
  </div>
  <div>
