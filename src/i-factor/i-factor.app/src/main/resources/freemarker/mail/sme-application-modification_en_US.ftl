<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Title:  Application modification</b>
  </div>
  <div>
    Dear Client,
  </div>
  <div style="background:#fff">
    ...
    CYour application is incomplete. Please click on the link below to fill out the missing information in 3 days.<br/><br/> 
    Suggestion: 2 days  -> Agreed to be 3 days by SME
  </div>
  <div>
