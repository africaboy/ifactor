<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    ...
    Reason:  <br/>
    •The sub-contract is not signed by ... <br/>
    Cancellation fees payable/receiveable: VND x00,000 <br/>
    <a href="${base}/buyer/closedauction/closedAuctionDetail/${auction.invoice.id}">To the Invoice detailed information </a>
  </div>
  <div>
