<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Tiêu đề: Hồ sơ đăng ký bị đóng </b>
  </div>
  <div>
    Gửi Quý khách,
  </div>
  <div style="background:#fff">
    ...
    Chúng tôi rất tiếc, hồ sơ của quý khách đã bị hủy bỏ. Hãy báo cho chúng tôi nếu lí do này không áp dụng cho Quý khách.  
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    <a href="${base}">Tới nền tảng </a>
    Lý do hồ sơ bị hủy bỏ:<br/>
    - Hồ sơ không được hoàn thiện trong thời gian cho phép<br />
    <a href="${base}/seller/account/view">Tới hồ sơ đăng ký</a>
  </div>
  <div>
