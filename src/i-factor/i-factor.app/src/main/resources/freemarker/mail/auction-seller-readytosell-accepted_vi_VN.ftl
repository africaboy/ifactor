<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff">
    ...
    Hóa đơn ID <000000> có lệnh khớp giá tương ứng với giá bán ngay. Xin vui lòng cung cấp chữ ký điện tử hoặc tới chi nhánh gần nhất để ký hợp đồng con. Trong trường hợp chưa cung cấp hóa đơn gốc, xin vui lòng cung cấp trong thời gian sớm nhất. Giải ngân sẽ được hoàn tất trong vòng 2 ngày kể từ ngày hợp đồng con được ký và hóa đơn gốc được xác thực. Hướng dẫn chi tiết sử dụng chữ ký điện tử và thủ tục ký hợp đồng con xin vui lòng tham khảo thông tin tại đường link bên dưới.
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    Thời điểm đấu giá thành công: ${auction.dealTime}x <br/>
    <a href="${base}/seller/invoice/after-auction/detail/${auction.invoice.id}">Tới chi tiết thông tin hóa đơn </a><br/>
    <a href="${base}/seller/invoice/after-auction/detail/${auction.invoice.id}">Hướng dẫn chi tiết sử dụng chữ ký điện tử và thủ tục ký hợp đồng con </a><br/>
