<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff">
    ...
    Your Invoice - ID <000000> - ready-to-sell price has been accepted. Please kindly provide e-signature or go to the nearest Bank/The Bank branch to sign the sub-contract. In case you have not provided the original invoice, please do provide as soon as possible. Disbursement will be performed within 2 days  from that date that the sub-contract is signed by all the parties and the original invoice is verified. For the detailed guidelines of using e-signature and sub-contract signing procedure, please kindly refer to the link below.
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    <a href="${base}/seller/invoice/after-auction/detail/${auction.invoice.id}">To the Invoice detailed information </a> <br/>
    <a href="${base}/seller/invoice/after-auction/detail/${auction.invoice.id}">Detailed guidelines of using e-signature and sub-contract signing procedures </a> <br/>
