<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff;">
    <!--Title -->
    <b>Title: Invoice submission closed</b>
  </div>
  <div>
    Dear Client,
  </div>
  <div style="background:#fff">
    ...
    We are sorry, your invoice submission has been closed due to the reason(s) below. Please contact us if the reason is not applicable to you.
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    Reason(s) for application closed: <br />
    - Your invoice submission is not modified within the time limit <br />
    <a href="${base}/seller/invoice/under-approval/detail/${apply.id}">Go to invoice information </a>
  </div>
  <div>
