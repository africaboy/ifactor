<div style="background:#ccc;padding:10px;">
  ...
  <div style="background:#fff">
    ...
    Giao dịch của hóa đơn số <000000> không thành công. Xin vui lòng xem thông tin dưới đây để biết lí do.
  </div>
  <div>
  ...
  <div style="background:#fff;">
    ...
    Lý do:  <br/>
    •Hợp đồng con chưa được ký <br/>
    Phí hủy giao dịch: VND x00,000 <br/>
