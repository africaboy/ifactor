...
<c:set target="${self}" property="title">我的日程</c:set>
<c:set target="${self.css}" property="plugins">
    <link type="text/css" rel="stylesheet" href="${base}/static/libs/AdminLTE/${version.AdminLTE}/css/fullcalendar/fullcalendar.css" />
    <link type="text/css" rel="stylesheet" href="${base}/static/libs/AdminLTE/${version.AdminLTE}/css/fullcalendar/fullcalendar.print.css" media='print' />
</c:set>
...
<c:set target="${self.js}" property="plugins">
    <script type="text/javascript" src="${base}/static/libs/jquery-ui/${version['jquery-ui']}/js/jquery-ui-${version['jquery-ui']}.min.js"></script>
    <script type="text/javascript" src="${base}/static/libs/AdminLTE/${version.AdminLTE}/js/plugins/fullcalendar/fullcalendar.min.js"></script>
</c:set>
...
<c:set target="${self.content}" property="header">
