...
<%
	...
	if (ISystemContext.isAdmin(user) == false) {
		out.println("<script language='javascript'>");
		out.println("top.location = '" + (context.equals("") ? "/" : context) + "system/console/error.jsp?e=matcherror';");
		out.println("</script>");
	}
...
<head>
	...
	<script type="text/javascript" src="<%=context %>/GAP/index.js"></script>
...
<div id="loading">
  <div class="loading-indicator" id="loading-indicator"><img src="<%=context %>/GAP/welcome/img/loading.gif" width="120" height="120" style="margin-right:8px;" align="absmiddle"/>
  </div>
</div>
