...
(function() {
	...
	APP.edit = function(id, table, gridId, pk, suffix) {
		var params = {};
		params[pk || 'PK_ID'] = id;
		var tv = new initTableView4QueryList(gridId, {params: params});
	...
	APP.view = function(id, table, gridId, pk, suffix) {
		var params = {};
		params[pk || 'PK_ID'] = id;
		var tv = new initTableView4QueryList(gridId, {tabid: 'tab_' + id, params: params});
	...
	APP.$link = function(param, action, text) {
		...
		return '<a href="javascript:void(0);" onclick="APP[\'' + action + '\'](' + params + ');">' + text + '</a>';
	};
})();
