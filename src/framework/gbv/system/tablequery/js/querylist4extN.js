 ...
 *            _pageSize 列表信息数
 */
function initTQExtRegionList(region, key, func, _pageSize, tabparam) {
	var querykey = key;
	...
	var url = context
			+ '/system/tablearg.do?method=modelcmp&comptype=TQExtRegionList&'
			+ param;
 ...
 * @return {}
 */
function renderTQExtRegionListHeader(value, cellmeta, record, rowIndex,
		columnIndex, store) {
	return value;
}
