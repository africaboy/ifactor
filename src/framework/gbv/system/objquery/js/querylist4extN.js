 ...
 */
function initOQExtRegionList(_N, key, func, _pageSize) {
	var N = 'north';
	...
	var url = context
			+ '/system/objectarg.do?method=modelcmp&comptype=OQExtRegionList&'
			+ param;
 ...
 * @return {}
 */
function renderOQExtRegionListHeader(value, cellmeta, record, rowIndex,
		columnIndex, store) {
	return value;
}
