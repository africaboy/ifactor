...
<script language="javascript">
  ...
  function handleQuery(){
     document.form1.action = context + "/system/flowlist.do?method=query&key=<%=key%>";
...
<div style="margin-top:15px;"><h1>&nbsp;&nbsp;公文综合查询</h1></div>
<br/>
...
<table class="tab4list" align="center" width="98%">    
   <tr>  
      <td width="10%" class="td1" align="center"><div align="center">文种</div></td>
      <td width="15%" class="td1"><div align="center">文号</div></td>
      <td width="30%" class="td1" align="center"><div align="center">标题</div></td>
      <td width="10%" class="td1" align="center"><div align="center">起草时间</div></td>
      <td width="10%"  class="td1" align="center"><div align="center">起草人</div></td>
      <td width="15%" class="td1" align="center"><div align="center">主办单位</div></td>
      <td width="10%" class="td1" align="center"><div align="center">&nbsp;</div></td>
    </tr>
  <% 
  ...
  %> 
  <tr> 
    <td align="center">&nbsp;<%=ins.iflow().iname()%></td>
    <td align="center">
    &nbsp;<%=number%>
    </td>
    <td><div class="divn" style="width:250px;"><a href="javascript:void(0);" onclick="javascript:handleLookOver('<%=id%>','<%=name%>');" title="查看"><%=name%></a></div></td>
    <td align="center">&nbsp;<%=time%></td>
    <td align="center">&nbsp;<%=ins.icreatorname()%></td>
    <td align="center">&nbsp;<%=ins.iunitname()%></td>
    <td align="center">
     <a href="javascript:void(0);" onclick="javascript:handleTrace('<%=ins.iflow().id()%>', '<%=ins.id()%>');">流程跟踪</a>
    </td>
  </tr>
  <%
        }
...
<table width="98%" class="tab-noborder" align="center" border="0" cellspacing="0" cellpadding="0">
  <tr>
   <td>
    &nbsp;<%=label.displayLabel()%>
   </td>
