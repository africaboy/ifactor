...
function HS_calender(){
	...
	CalenderTitle += "<span class='selectThisYear'><a href='javascript:void(0)' onclick='CalenderselectYear(this)' title='单击选择年' >"+now.getFullYear()+"</a></span>年<span class='selectThisMonth'><a href='javascript:void(0)' onclick='CalenderselectMonth(this)' title='单击选择月'>"+(parseInt(now.getMonth())+1).toString()+"</a></span>月"; 
	...
	if (arguments.length>1){
		...
		var CalenderBox = style+"<div class='calender'><div class='calenderTitle'>"+CalenderTitle+"</div><div class='calenderBody'><ul class='day'><li>日</li><li>一</li><li>二</li><li>三</li><li>四</li><li>五</li><li>六</li></ul><ul class='date' id='thisMonthDate'>"+lis+"</ul></div><div class='calenderBottom'><a href='javascript:void(0)' class='closeCalender' onclick='closeCalender(this)'>&times;</a><span><span><a href=javascript:void(0) onclick='_selectThisDay(this)' title='"+todayString+"'>今天</a></span><span><a href=javascript:void(0) onclick='_resetThisDay(this)' title='清空已选日期'>清空</a></span></span></div></div>";
		return CalenderBox;
	}
}
function _selectThisDay(d){
	var boxObj = d.parentNode.parentNode.parentNode.parentNode.parentNode;
		boxObj.targetObj.value = _parseDate(d.title);
		try{
	   releaseHS(boxObj.targetObj.name);
	}catch(error){
	}
		boxObj.parentNode.removeChild(boxObj);
		
}
function _resetThisDay(d){
    var boxObj = d.parentNode.parentNode.parentNode.parentNode.parentNode;
...
function HS_setDate(inputObj){
    var iid = "mydateselect";
    var calenderObj;
    if(document.getElementById(iid)){
      calenderObj = document.getElementById(iid);
    }else{
