...
<script language="javascript">
  ...
  function handleQuery(){
     document.form1.action = context + "/system/flowlist.do?method=pigeonholelist";
...
<div style="margin-top:15px;"><h1>&nbsp;&nbsp;归档文件列表</h1></div>
<br/>
...
<table class="tab4list" align="center" width="98%"> 
	<tr>
		...
		<td class="td1" width="15%" align="center">&nbsp;创建时间</td>
		<td class="td1" width="10%" align="center">&nbsp;拟稿人</td>
		<td class="td1" width="15%" align="center">&nbsp;办结时间</td>
		<td class="td1" width="15%" align="center">&nbsp;</td>
	</tr>
	<%
			...
			for (int i = 0; i < resultList.size(); i++) {
				...
				String id = act.id();
				String str = ins.icreatorname() + "&nbsp;"
				+ ins.iunitname();
				String name = act.ititle();
	%>
	<tr>
		<td align="center">&nbsp;<%=number%></td>
		<td><div class="divn" style="width:300px;"><a
			href="javascript:void(0)" onclick="javascript:handleView('<%=id%>','<%=name%>');" title="<%=name%>"><%=name%></a></div></td>
		...
		<td align="center">&nbsp;<%=DateTrimmer.toYMD(DateTrimmer.getYMD_LBL(act
									.iendtime()))%></td>
		<td align="center"><a
			href="javascript:void(0)" onclick="javascript:handleTrace('<%=ins.iflow().id()%>', '<%=ins.id()%>');">流程跟踪</a></td>
	</tr>
	<%
		}
		}
