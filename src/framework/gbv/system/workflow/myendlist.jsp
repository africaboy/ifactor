...
<script language="javascript">
	...
	function handleQuery(){
	   document.form1.action = context + "/system/flowlist.do?method=myendlist";
...
<table class="tab-noborder" align="center" width="98%">
    <tr>
       <td>
		<table class="tab-noborder" align="left" width="50%">
		    <tr>
		       <td>主办单位</td>
		       <td colspan="2">
...
<table class="tab4list" align="center" width="98%">
	<tr>
		...
		<td class="td1" width="15%" align="center">&nbsp;主办部门</td>
	...
	<tr>
		...
		<td><div class="divn" style="width:400px;"><a
			href="javascript:void(0)" onclick="javascript:handleLookOver('<%=id%>','<%=name%>');" title="<%=name%>"><%=name%></a></div></td>
